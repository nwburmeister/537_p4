...
80100046:	e8 35 3e 00 00       	call   80103e80 <acquire>
...
8010007c:	e8 64 3e 00 00       	call   80103ee5 <release>
      acquiresleep(&b->lock);
80100081:	8d 43 0c             	lea    0xc(%ebx),%eax
80100084:	89 04 24             	mov    %eax,(%esp)
80100087:	e8 e0 3b 00 00       	call   80103c6c <acquiresleep>
      return b;
...
801000ca:	e8 16 3e 00 00       	call   80103ee5 <release>
      acquiresleep(&b->lock);
801000cf:	8d 43 0c             	lea    0xc(%ebx),%eax
801000d2:	89 04 24             	mov    %eax,(%esp)
801000d5:	e8 92 3b 00 00       	call   80103c6c <acquiresleep>
      return b;
...
80100105:	e8 3a 3c 00 00       	call   80103d44 <initlock>
...
80100143:	e8 f1 3a 00 00       	call   80103c39 <initsleeplock>
...
801001a8:	e8 49 3b 00 00       	call   80103cf6 <holdingsleep>
...
801001e4:	e8 0d 3b 00 00       	call   80103cf6 <holdingsleep>
...
801001f4:	e8 c2 3a 00 00       	call   80103cbb <releasesleep>

  acquire(&bcache.lock);
801001f9:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100200:	e8 7b 3c 00 00       	call   80103e80 <acquire>
  b->refcnt--;
...
8010024c:	e8 94 3c 00 00       	call   80103ee5 <release>
}
...
8010028a:	e8 f1 3b 00 00       	call   80103e80 <acquire>
  while(n > 0){
...
801002d1:	e8 0f 3c 00 00       	call   80103ee5 <release>
        ilock(ip);
...
80100331:	e8 af 3b 00 00       	call   80103ee5 <release>
  ilock(ip);
...
80100373:	e8 93 02 00 00       	call   8010060b <cprintf>
  cprintf("\n");
80100378:	c7 04 24 47 71 10 80 	movl   $0x80107147,(%esp)
...
8010038f:	e8 cb 39 00 00       	call   80103d5f <getcallerpcs>
  for(i=0; i<10; i++)
...
801004ba:	e8 e8 3a 00 00       	call   80103fa7 <memmove>
    pos -= 80;
...
801004d9:	e8 4e 3a 00 00       	call   80103f2c <memset>
...
80100506:	e8 a0 4e 00 00       	call   801053ab <uartputc>
...
8010051f:	e8 87 4e 00 00       	call   801053ab <uartputc>
80100524:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010052b:	e8 7b 4e 00 00       	call   801053ab <uartputc>
80100530:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100537:	e8 6f 4e 00 00       	call   801053ab <uartputc>
...
801005ca:	e8 b1 38 00 00       	call   80103e80 <acquire>
  for(i = 0; i < n; i++)
...
801005f1:	e8 ef 38 00 00       	call   80103ee5 <release>
  ilock(ip);
...
80100638:	e8 43 38 00 00       	call   80103e80 <acquire>
...
80100734:	e8 ac 37 00 00       	call   80103ee5 <release>
...
8010074f:	e8 2c 37 00 00       	call   80103e80 <acquire>
  while((c = getc()) >= 0){
...
801007de:	e8 23 30 00 00       	call   80103806 <wakeup>
...
80100873:	e8 6d 36 00 00       	call   80103ee5 <release>
  if(doprocdump) {
...
80100887:	e8 17 30 00 00       	call   801038a3 <procdump>
}
...
8010089e:	e8 a1 34 00 00       	call   80103d44 <initlock>
...
80100970:	75 b2                	jne    80100924 <exec+0x52>
  if((pgdir = setupkvm()) == 0)
80100972:	e8 f4 5b 00 00       	call   8010656b <setupkvm>
...
80100a06:	e8 06 5a 00 00       	call   80106411 <allocuvm>
...
80100a38:	e8 a2 58 00 00       	call   801062df <loaduvm>
...
80100a74:	e8 98 59 00 00       	call   80106411 <allocuvm>
...
80100a9d:	e8 59 5a 00 00       	call   801064fb <freevm>
...
80100abc:	e8 2f 5b 00 00       	call   801065f0 <clearpteu>
...
80100ae2:	e8 e7 35 00 00       	call   801040ce <strlen>
...
80100af4:	e8 d5 35 00 00       	call   801040ce <strlen>
...
80100ba3:	e8 eb 34 00 00       	call   80104093 <safestrcpy>
...
80100bd1:	e8 88 55 00 00       	call   8010615e <switchuvm>
  freevm(oldpgdir);
80100bd6:	89 1c 24             	mov    %ebx,(%esp)
80100bd9:	e8 1d 59 00 00       	call   801064fb <freevm>
  return 0;
...
80100c23:	e8 1c 31 00 00       	call   80103d44 <initlock>
}
...
80100c39:	e8 42 32 00 00       	call   80103e80 <acquire>
...
80100c68:	e8 78 32 00 00       	call   80103ee5 <release>
      return f;
...
80100c7f:	e8 61 32 00 00       	call   80103ee5 <release>
  return 0;
...
80100c9d:	e8 de 31 00 00       	call   80103e80 <acquire>
  if(f->ref < 1)
...
80100cba:	e8 26 32 00 00       	call   80103ee5 <release>
  return f;
}
...
80100ce2:	e8 99 31 00 00       	call   80103e80 <acquire>
  if(f->ref < 1)
...
80100d03:	e8 dd 31 00 00       	call   80103ee5 <release>
    return;
...
80100d49:	e8 97 31 00 00       	call   80103ee5 <release>
  if(ff.type == FD_PIPE)
...
80100f8a:	e8 18 30 00 00       	call   80103fa7 <memmove>
...
80100f9a:	e8 08 30 00 00       	call   80103fa7 <memmove>
    name[len] = 0;
...
80100fdf:	e8 48 2f 00 00       	call   80103f2c <memset>
  log_write(bp);
...
8010119a:	e8 e1 2c 00 00       	call   80103e80 <acquire>
...
801011e1:	e8 ff 2c 00 00       	call   80103ee5 <release>
      return ip;
...
80101217:	e8 c9 2c 00 00       	call   80103ee5 <release>
  return ip;
...
80101255:	e8 4d 2d 00 00       	call   80103fa7 <memmove>
  brelse(bp);
...
801012fd:	e8 42 2a 00 00       	call   80103d44 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101322:	e8 12 29 00 00       	call   80103c39 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801013f1:	e8 36 2b 00 00       	call   80103f2c <memset>
      dip->type = type;
...
80101480:	e8 22 2b 00 00       	call   80103fa7 <memmove>
  log_write(bp);
...
80101560:	e8 1b 29 00 00       	call   80103e80 <acquire>
  ip->ref++;
...
80101575:	e8 6b 29 00 00       	call   80103ee5 <release>
}
...
8010159a:	e8 cd 26 00 00       	call   80103c6c <acquiresleep>
  if(ip->valid == 0){
...
80101614:	e8 8e 29 00 00       	call   80103fa7 <memmove>
    brelse(bp);
...
80101656:	e8 9b 26 00 00       	call   80103cf6 <holdingsleep>
...
8010166c:	e8 4a 26 00 00       	call   80103cbb <releasesleep>
}
...
80101698:	e8 cf 25 00 00       	call   80103c6c <acquiresleep>
...
801016b1:	e8 05 26 00 00       	call   80103cbb <releasesleep>
  acquire(&icache.lock);
801016b6:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016bd:	e8 be 27 00 00       	call   80103e80 <acquire>
  ip->ref--;
...
801016d2:	e8 0e 28 00 00       	call   80103ee5 <release>
}
...
801016ea:	e8 91 27 00 00       	call   80103e80 <acquire>
    int r = ip->ref;
801016ef:	8b 7b 08             	mov    0x8(%ebx),%edi
    release(&icache.lock);
801016f2:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016f9:	e8 e7 27 00 00       	call   80103ee5 <release>
    if(r == 1){
...
8010182a:	e8 78 27 00 00       	call   80103fa7 <memmove>
    brelse(bp);
...
80101926:	e8 7c 26 00 00       	call   80103fa7 <memmove>
    log_write(bp);
...
801019a9:	e8 60 26 00 00       	call   8010400e <strncmp>
}
801019ae:	c9                   	leave  
801019af:	c3                   	ret    
...
80101ba9:	e8 9d 24 00 00       	call   8010404b <strncpy>
  de.inum = inum;
...
80101bd7:	68 40 6f 10 80       	push   $0x80106f40
...
80101d10:	e8 2f 20 00 00       	call   80103d44 <initlock>
...
80101d80:	e8 fb 20 00 00       	call   80103e80 <acquire>
...
80101dad:	e8 54 1a 00 00       	call   80103806 <wakeup>
...
80101dcb:	e8 15 21 00 00       	call   80103ee5 <release>
...
80101de2:	e8 fe 20 00 00       	call   80103ee5 <release>
    return;
...
80101e1a:	e8 d7 1e 00 00       	call   80103cf6 <holdingsleep>
...
80101e47:	e8 34 20 00 00       	call   80103e80 <acquire>
...
80101ea9:	e8 f3 17 00 00       	call   801036a1 <sleep>
...
80101ec3:	e8 1d 20 00 00       	call   80103ee5 <release>
}
...
80101fb6:	81 fb a8 65 11 80    	cmp    $0x801165a8,%ebx
...
80101fd6:	e8 51 1f 00 00       	call   80103f2c <memset>
...
80102017:	e8 64 1e 00 00       	call   80103e80 <acquire>
8010201c:	83 c4 10             	add    $0x10,%esp
8010201f:	eb c6                	jmp    80101fe7 <kfree+0x43>
    release(&kmem.lock);
80102021:	83 ec 0c             	sub    $0xc,%esp
80102024:	68 40 26 11 80       	push   $0x80112640
80102029:	e8 b7 1e 00 00       	call   80103ee5 <release>
...
80102079:	e8 c6 1c 00 00       	call   80103d44 <initlock>
  kmem.use_lock = 0;
...
80102150:	0f b6 8a 60 6b 10 80 	movzbl -0x7fef94a0(%edx),%ecx
80102157:	0b 0d b4 a5 10 80    	or     0x8010a5b4,%ecx
  shift ^= togglecode[data];
8010215d:	0f b6 82 60 6a 10 80 	movzbl -0x7fef95a0(%edx),%eax
...
80102171:	8b 04 85 40 6a 10 80 	mov    -0x7fef95c0(,%eax,4),%eax
...
801021a9:	83 e2 7f             	and    $0x7f,%edx
    shift &= ~(shiftcode[data] | E0ESC);
801021ac:	0f b6 82 60 6b 10 80 	movzbl -0x7fef94a0(%edx),%eax
...
80102497:	e8 d6 1a 00 00       	call   80103f72 <memcmp>
...
80102602:	e8 a0 19 00 00       	call   80103fa7 <memmove>
...
80102701:	e8 a1 18 00 00       	call   80103fa7 <memmove>
...
8010276f:	68 60 6c 10 80       	push   $0x80106c60
80102774:	68 80 26 11 80       	push   $0x80112680
80102779:	e8 c6 15 00 00       	call   80103d44 <initlock>
  readsb(dev, &sb);
...
801027b9:	e8 c2 16 00 00       	call   80103e80 <acquire>
...
801027d0:	e8 cc 0e 00 00       	call   801036a1 <sleep>
...
80102807:	e8 95 0e 00 00       	call   801036a1 <sleep>
...
8010281e:	e8 c2 16 00 00       	call   80103ee5 <release>
}
...
80102834:	e8 47 16 00 00       	call   80103e80 <acquire>
  log.outstanding -= 1;
...
8010286e:	e8 72 16 00 00       	call   80103ee5 <release>
  if(do_commit){
...
80102909:	e8 72 15 00 00       	call   80103e80 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102934:	68 73 6c 10 80       	push   $0x80106c73
80102939:	e8 0a da ff ff       	call   80100348 <panic>
    panic("log_write outside of trans");
8010293e:	83 ec 0c             	sub    $0xc,%esp
80102941:	68 89 6c 10 80       	push   $0x80106c89
...
80102964:	e8 7c 15 00 00       	call   80103ee5 <release>
}
...
80102992:	e8 10 16 00 00       	call   80103fa7 <memmove>
...
80102a23:	68 a4 6c 10 80       	push   $0x80106ca4
80102a28:	e8 de db ff ff       	call   8010060b <cprintf>
  idtinit();       // load idt register
80102a2d:	e8 11 27 00 00       	call   80105143 <idtinit>
...
80102a45:	e8 32 0a 00 00       	call   8010347c <scheduler>
...
80102a4d:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102a50:	e8 f7 36 00 00       	call   8010614c <switchkvm>
  seginit();
80102a55:	e8 a6 35 00 00       	call   80106000 <seginit>
  lapicinit();
...
80102aa7:	e8 45 29 00 00       	call   801053f1 <uartinit>
  pinit();         // process table
80102aac:	e8 b4 06 00 00       	call   80103165 <pinit>
  tvinit();        // trap vectors
80102ab1:	e8 dc 25 00 00       	call   80105092 <tvinit>
  binit();         // buffer cache
...
80102b27:	68 b8 6c 10 80       	push   $0x80106cb8
80102b2c:	53                   	push   %ebx
80102b2d:	e8 40 14 00 00       	call   80103f72 <memcmp>
...
80102bec:	68 bd 6c 10 80       	push   $0x80106cbd
80102bf1:	56                   	push   %esi
80102bf2:	e8 7b 13 00 00       	call   80103f72 <memcmp>
...
80102c88:	68 c2 6c 10 80       	push   $0x80106cc2
...
80102cc7:	ff 24 85 fc 6c 10 80 	jmp    *-0x7fef9304(,%eax,4)
      continue;
    case MPIOAPIC:
...
80102d15:	68 dc 6c 10 80       	push   $0x80106cdc
...
80102dd1:	68 10 6d 10 80       	push   $0x80106d10
80102dd6:	50                   	push   %eax
80102dd7:	e8 68 0f 00 00       	call   80103d44 <initlock>
  (*f0)->type = FD_PIPE;
...
80102e2d:	e8 4e 10 00 00       	call   80103e80 <acquire>
  if(writable){
...
80102e4f:	e8 b2 09 00 00       	call   80103806 <wakeup>
...
80102e6d:	e8 73 10 00 00       	call   80103ee5 <release>
...
80102e8e:	e8 73 09 00 00       	call   80103806 <wakeup>
...
80102e9c:	e8 44 10 00 00       	call   80103ee5 <release>
    kfree((char*)p);
...
80102ebd:	e8 be 0f 00 00       	call   80103e80 <acquire>
  for(i = 0; i < n; i++){
...
80102f06:	e8 fb 08 00 00       	call   80103806 <wakeup>
...
80102f65:	e8 9c 08 00 00       	call   80103806 <wakeup>
  release(&p->lock);
80102f6a:	89 1c 24             	mov    %ebx,(%esp)
80102f6d:	e8 73 0f 00 00       	call   80103ee5 <release>
  return n;
...
80102f89:	e8 f2 0e 00 00       	call   80103e80 <acquire>
...
8010301c:	e8 e5 07 00 00       	call   80103806 <wakeup>
  release(&p->lock);
80103021:	89 1c 24             	mov    %ebx,(%esp)
80103024:	e8 bc 0e 00 00       	call   80103ee5 <release>
  return i;
...
80103040:	83 ea 80             	sub    $0xffffff80,%edx
80103043:	81 fa 54 4d 11 80    	cmp    $0x80114d54,%edx
...
801030c4:	e8 1c 0e 00 00       	call   80103ee5 <release>
...
801030e1:	c7 80 b0 0f 00 00 87 	movl   $0x80105087,0xfb0(%eax)
801030e8:	50 10 80 
  sp -= sizeof *p->context;
...
801030fb:	e8 2c 0e 00 00       	call   80103f2c <memset>
...
8010312d:	e8 b3 0d 00 00       	call   80103ee5 <release>
  if (first) {
...
8010316b:	68 15 6d 10 80       	push   $0x80106d15
80103170:	68 20 2d 11 80       	push   $0x80112d20
80103175:	e8 ca 0b 00 00       	call   80103d44 <initlock>
}
...
80103196:	39 15 00 2d 11 80    	cmp    %edx,0x80112d00
8010319c:	7e 23                	jle    801031c1 <mycpu+0x42>
    if (cpus[i].apicid == apicid)
8010319e:	69 ca b0 00 00 00    	imul   $0xb0,%edx,%ecx
801031a4:	0f b6 89 80 27 11 80 	movzbl -0x7feed880(%ecx),%ecx
...
801031e6:	2d 80 27 11 80       	sub    $0x80112780,%eax
...
801031fa:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801031fd:	e8 a1 0b 00 00       	call   80103da3 <pushcli>
  c = mycpu();
80103202:	e8 78 ff ff ff       	call   8010317f <mycpu>
  p = c->proc;
80103207:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010320d:	e8 ce 0b 00 00       	call   80103de0 <popcli>
}
...
80103226:	89 c3                	mov    %eax,%ebx
  initproc = p;
80103228:	a3 b8 a5 10 80       	mov    %eax,0x8010a5b8
  if((p->pgdir = setupkvm()) == 0)
8010322d:	e8 39 33 00 00       	call   8010656b <setupkvm>
80103232:	89 43 04             	mov    %eax,0x4(%ebx)
80103235:	85 c0                	test   %eax,%eax
80103237:	0f 84 be 00 00 00    	je     801032fb <userinit+0xe1>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
8010323d:	83 ec 04             	sub    $0x4,%esp
80103240:	68 2c 00 00 00       	push   $0x2c
80103245:	68 60 a4 10 80       	push   $0x8010a460
8010324a:	50                   	push   %eax
8010324b:	e8 26 30 00 00       	call   80106276 <inituvm>
  p->sz = PGSIZE;
...
80103260:	e8 c7 0c 00 00       	call   80103f2c <memset>
...
801032b3:	68 45 6d 10 80       	push   $0x80106d45
801032b8:	50                   	push   %eax
801032b9:	e8 d5 0d 00 00       	call   80104093 <safestrcpy>
  p->cwd = namei("/");
801032be:	c7 04 24 4e 6d 10 80 	movl   $0x80106d4e,(%esp)
801032c5:	e8 17 e9 ff ff       	call   80101be1 <namei>
801032ca:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
801032cd:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801032d4:	e8 a7 0b 00 00       	call   80103e80 <acquire>
  p->state = RUNNABLE;
801032d9:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  p->priority = 3;
801032e0:	c7 43 7c 03 00 00 00 	movl   $0x3,0x7c(%ebx)
  release(&ptable.lock);
801032e7:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801032ee:	e8 f2 0b 00 00       	call   80103ee5 <release>
}
801032f3:	83 c4 10             	add    $0x10,%esp
801032f6:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801032f9:	c9                   	leave  
801032fa:	c3                   	ret    
    panic("userinit: out of memory?");
801032fb:	83 ec 0c             	sub    $0xc,%esp
801032fe:	68 2c 6d 10 80       	push   $0x80106d2c
...
8010330d:	8b 75 08             	mov    0x8(%ebp),%esi
  struct proc *curproc = myproc();
80103310:	e8 e1 fe ff ff       	call   801031f6 <myproc>
80103315:	89 c3                	mov    %eax,%ebx
  sz = curproc->sz;
80103317:	8b 00                	mov    (%eax),%eax
  if(n > 0){
80103319:	85 f6                	test   %esi,%esi
8010331b:	7f 21                	jg     8010333e <growproc+0x36>
  } else if(n < 0){
8010331d:	85 f6                	test   %esi,%esi
8010331f:	79 33                	jns    80103354 <growproc+0x4c>
    if((sz = deallocuvm(curproc->pgdir, sz, sz + n)) == 0)
80103321:	83 ec 04             	sub    $0x4,%esp
80103324:	01 c6                	add    %eax,%esi
80103326:	56                   	push   %esi
80103327:	50                   	push   %eax
80103328:	ff 73 04             	pushl  0x4(%ebx)
8010332b:	e8 4f 30 00 00       	call   8010637f <deallocuvm>
80103330:	83 c4 10             	add    $0x10,%esp
80103333:	85 c0                	test   %eax,%eax
80103335:	75 1d                	jne    80103354 <growproc+0x4c>
      return -1;
80103337:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010333c:	eb 29                	jmp    80103367 <growproc+0x5f>
    if((sz = allocuvm(curproc->pgdir, sz, sz + n)) == 0)
8010333e:	83 ec 04             	sub    $0x4,%esp
80103341:	01 c6                	add    %eax,%esi
80103343:	56                   	push   %esi
80103344:	50                   	push   %eax
80103345:	ff 73 04             	pushl  0x4(%ebx)
80103348:	e8 c4 30 00 00       	call   80106411 <allocuvm>
8010334d:	83 c4 10             	add    $0x10,%esp
80103350:	85 c0                	test   %eax,%eax
80103352:	74 1a                	je     8010336e <growproc+0x66>
  curproc->sz = sz;
80103354:	89 03                	mov    %eax,(%ebx)
  switchuvm(curproc);
80103356:	83 ec 0c             	sub    $0xc,%esp
80103359:	53                   	push   %ebx
8010335a:	e8 ff 2d 00 00       	call   8010615e <switchuvm>
  return 0;
8010335f:	83 c4 10             	add    $0x10,%esp
80103362:	b8 00 00 00 00       	mov    $0x0,%eax
}
80103367:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010336a:	5b                   	pop    %ebx
8010336b:	5e                   	pop    %esi
8010336c:	5d                   	pop    %ebp
8010336d:	c3                   	ret    
...
80103373:	eb f2                	jmp    80103367 <growproc+0x5f>
...
8010337b:	83 ec 1c             	sub    $0x1c,%esp
  struct proc *curproc = myproc();
8010337e:	e8 73 fe ff ff       	call   801031f6 <myproc>
80103383:	89 c3                	mov    %eax,%ebx
  if((np = allocproc()) == 0){
80103385:	e8 d7 fc ff ff       	call   80103061 <allocproc>
...
8010339a:	ff 33                	pushl  (%ebx)
8010339c:	ff 73 04             	pushl  0x4(%ebx)
8010339f:	e8 78 32 00 00       	call   8010661c <copyuvm>
...
801033de:	ff 73 08             	pushl  0x8(%ebx)
801033e1:	e8 be eb ff ff       	call   80101fa4 <kfree>
    np->kstack = 0;
...
80103412:	e8 77 d8 ff ff       	call   80100c8e <filedup>
...
80103426:	ff 73 68             	pushl  0x68(%ebx)
80103429:	e8 23 e1 ff ff       	call   80101551 <idup>
...
80103441:	e8 4d 0c 00 00       	call   80104093 <safestrcpy>
  pid = np->pid;
80103446:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103449:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103450:	e8 2b 0a 00 00       	call   80103e80 <acquire>
  np->state = RUNNABLE;
80103455:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
8010345c:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103463:	e8 7d 0a 00 00       	call   80103ee5 <release>
  return pid;
...
80103480:	53                   	push   %ebx
  struct cpu *c = mycpu();
80103481:	e8 f9 fc ff ff       	call   8010317f <mycpu>
...
80103492:	eb 5a                	jmp    801034ee <scheduler+0x72>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103494:	83 eb 80             	sub    $0xffffff80,%ebx
80103497:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
...
801034af:	e8 aa 2c 00 00       	call   8010615e <switchuvm>
      p->state = RUNNING;
801034b4:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
801034bb:	83 c4 08             	add    $0x8,%esp
801034be:	ff 73 1c             	pushl  0x1c(%ebx)
801034c1:	8d 46 04             	lea    0x4(%esi),%eax
801034c4:	50                   	push   %eax
801034c5:	e8 1c 0c 00 00       	call   801040e6 <swtch>
      switchkvm();
801034ca:	e8 7d 2c 00 00       	call   8010614c <switchkvm>
      c->proc = 0;
...
801034e1:	68 20 2d 11 80       	push   $0x80112d20
801034e6:	e8 fa 09 00 00       	call   80103ee5 <release>
    sti();
...
801034f2:	68 20 2d 11 80       	push   $0x80112d20
801034f7:	e8 84 09 00 00       	call   80103e80 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801034fc:	83 c4 10             	add    $0x10,%esp
801034ff:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
...
8010350b:	e8 e6 fc ff ff       	call   801031f6 <myproc>
80103510:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103512:	83 ec 0c             	sub    $0xc,%esp
80103515:	68 20 2d 11 80       	push   $0x80112d20
8010351a:	e8 21 09 00 00       	call   80103e40 <holding>
8010351f:	83 c4 10             	add    $0x10,%esp
80103522:	85 c0                	test   %eax,%eax
80103524:	74 4f                	je     80103575 <sched+0x6f>
  if(mycpu()->ncli != 1)
80103526:	e8 54 fc ff ff       	call   8010317f <mycpu>
...
8010353f:	75 5b                	jne    8010359c <sched+0x96>
  intena = mycpu()->intena;
80103541:	e8 39 fc ff ff       	call   8010317f <mycpu>
80103546:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
8010354c:	e8 2e fc ff ff       	call   8010317f <mycpu>
80103551:	83 ec 08             	sub    $0x8,%esp
80103554:	ff 70 04             	pushl  0x4(%eax)
80103557:	83 c3 1c             	add    $0x1c,%ebx
8010355a:	53                   	push   %ebx
8010355b:	e8 86 0b 00 00       	call   801040e6 <swtch>
  mycpu()->intena = intena;
80103560:	e8 1a fc ff ff       	call   8010317f <mycpu>
...
801035ad:	53                   	push   %ebx
  struct proc *curproc = myproc();
801035ae:	e8 43 fc ff ff       	call   801031f6 <myproc>
  if(curproc == initproc)
801035b3:	39 05 b8 a5 10 80    	cmp    %eax,0x8010a5b8
801035b9:	74 09                	je     801035c4 <exit+0x1b>
801035bb:	89 c6                	mov    %eax,%esi
  for(fd = 0; fd < NOFILE; fd++){
801035bd:	bb 00 00 00 00       	mov    $0x0,%ebx
801035c2:	eb 10                	jmp    801035d4 <exit+0x2b>
    panic("init exiting");
801035c4:	83 ec 0c             	sub    $0xc,%esp
801035c7:	68 90 6d 10 80       	push   $0x80106d90
801035cc:	e8 77 cd ff ff       	call   80100348 <panic>
  for(fd = 0; fd < NOFILE; fd++){
801035d1:	83 c3 01             	add    $0x1,%ebx
801035d4:	83 fb 0f             	cmp    $0xf,%ebx
801035d7:	7f 1e                	jg     801035f7 <exit+0x4e>
    if(curproc->ofile[fd]){
801035d9:	8b 44 9e 28          	mov    0x28(%esi,%ebx,4),%eax
801035dd:	85 c0                	test   %eax,%eax
801035df:	74 f0                	je     801035d1 <exit+0x28>
      fileclose(curproc->ofile[fd]);
801035e1:	83 ec 0c             	sub    $0xc,%esp
801035e4:	50                   	push   %eax
801035e5:	e8 e9 d6 ff ff       	call   80100cd3 <fileclose>
      curproc->ofile[fd] = 0;
801035ea:	c7 44 9e 28 00 00 00 	movl   $0x0,0x28(%esi,%ebx,4)
801035f1:	00 
801035f2:	83 c4 10             	add    $0x10,%esp
801035f5:	eb da                	jmp    801035d1 <exit+0x28>
  begin_op();
801035f7:	e8 b2 f1 ff ff       	call   801027ae <begin_op>
  iput(curproc->cwd);
801035fc:	83 ec 0c             	sub    $0xc,%esp
801035ff:	ff 76 68             	pushl  0x68(%esi)
80103602:	e8 81 e0 ff ff       	call   80101688 <iput>
  end_op();
80103607:	e8 1c f2 ff ff       	call   80102828 <end_op>
  curproc->cwd = 0;
8010360c:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103613:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010361a:	e8 61 08 00 00       	call   80103e80 <acquire>
  wakeup1(curproc->parent);
8010361f:	8b 46 14             	mov    0x14(%esi),%eax
80103622:	e8 0f fa ff ff       	call   80103036 <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103627:	83 c4 10             	add    $0x10,%esp
8010362a:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
8010362f:	eb 03                	jmp    80103634 <exit+0x8b>
80103631:	83 eb 80             	sub    $0xffffff80,%ebx
80103634:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
8010363a:	73 1a                	jae    80103656 <exit+0xad>
    if(p->parent == curproc){
8010363c:	39 73 14             	cmp    %esi,0x14(%ebx)
8010363f:	75 f0                	jne    80103631 <exit+0x88>
      p->parent = initproc;
80103641:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
80103646:	89 43 14             	mov    %eax,0x14(%ebx)
      if(p->state == ZOMBIE)
80103649:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
8010364d:	75 e2                	jne    80103631 <exit+0x88>
        wakeup1(initproc);
8010364f:	e8 e2 f9 ff ff       	call   80103036 <wakeup1>
...
80103665:	68 9d 6d 10 80       	push   $0x80106d9d
...
80103675:	68 20 2d 11 80       	push   $0x80112d20
8010367a:	e8 01 08 00 00       	call   80103e80 <acquire>
  myproc()->state = RUNNABLE;
8010367f:	e8 72 fb ff ff       	call   801031f6 <myproc>
80103684:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
8010368b:	e8 76 fe ff ff       	call   80103506 <sched>
  release(&ptable.lock);
80103690:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103697:	e8 49 08 00 00       	call   80103ee5 <release>
}
...
801036a6:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  struct proc *p = myproc();
801036a9:	e8 48 fb ff ff       	call   801031f6 <myproc>
  if(p == 0)
801036ae:	85 c0                	test   %eax,%eax
801036b0:	74 66                	je     80103718 <sleep+0x77>
801036b2:	89 c6                	mov    %eax,%esi
  if(lk == 0)
801036b4:	85 db                	test   %ebx,%ebx
801036b6:	74 6d                	je     80103725 <sleep+0x84>
  if(lk != &ptable.lock){  //DOC: sleeplock0
801036b8:	81 fb 20 2d 11 80    	cmp    $0x80112d20,%ebx
801036be:	74 18                	je     801036d8 <sleep+0x37>
    acquire(&ptable.lock);  //DOC: sleeplock1
801036c0:	83 ec 0c             	sub    $0xc,%esp
801036c3:	68 20 2d 11 80       	push   $0x80112d20
801036c8:	e8 b3 07 00 00       	call   80103e80 <acquire>
    release(lk);
801036cd:	89 1c 24             	mov    %ebx,(%esp)
801036d0:	e8 10 08 00 00       	call   80103ee5 <release>
801036d5:	83 c4 10             	add    $0x10,%esp
  p->chan = chan;
801036d8:	8b 45 08             	mov    0x8(%ebp),%eax
801036db:	89 46 20             	mov    %eax,0x20(%esi)
  p->state = SLEEPING;
801036de:	c7 46 0c 02 00 00 00 	movl   $0x2,0xc(%esi)
  sched();
801036e5:	e8 1c fe ff ff       	call   80103506 <sched>
  p->chan = 0;
801036ea:	c7 46 20 00 00 00 00 	movl   $0x0,0x20(%esi)
  if(lk != &ptable.lock){  //DOC: sleeplock2
801036f1:	81 fb 20 2d 11 80    	cmp    $0x80112d20,%ebx
801036f7:	74 18                	je     80103711 <sleep+0x70>
    release(&ptable.lock);
801036f9:	83 ec 0c             	sub    $0xc,%esp
801036fc:	68 20 2d 11 80       	push   $0x80112d20
80103701:	e8 df 07 00 00       	call   80103ee5 <release>
    acquire(lk);
80103706:	89 1c 24             	mov    %ebx,(%esp)
80103709:	e8 72 07 00 00       	call   80103e80 <acquire>
...
8010371b:	68 a9 6d 10 80       	push   $0x80106da9
80103720:	e8 23 cc ff ff       	call   80100348 <panic>
    panic("sleep without lk");
80103725:	83 ec 0c             	sub    $0xc,%esp
80103728:	68 af 6d 10 80       	push   $0x80106daf
...
80103760:	ff 73 08             	pushl  0x8(%ebx)
80103763:	e8 3c e8 ff ff       	call   80101fa4 <kfree>
        p->kstack = 0;
80103768:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
8010376f:	83 c4 04             	add    $0x4,%esp
80103772:	ff 73 04             	pushl  0x4(%ebx)
80103775:	e8 81 2d 00 00       	call   801064fb <freevm>
        p->pid = 0;
...
80103793:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010379a:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801037a1:	e8 3f 07 00 00       	call   80103ee5 <release>
        return pid;
...
801037b1:	c3                   	ret    
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801037b2:	83 eb 80             	sub    $0xffffff80,%ebx
801037b5:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
...
801037e1:	e8 ff 06 00 00       	call   80103ee5 <release>
      return -1;
...
80103811:	e8 6a 06 00 00       	call   80103e80 <acquire>
  wakeup1(chan);
80103816:	8b 45 08             	mov    0x8(%ebp),%eax
80103819:	e8 18 f8 ff ff       	call   80103036 <wakeup1>
  release(&ptable.lock);
8010381e:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103825:	e8 bb 06 00 00       	call   80103ee5 <release>
}
...
80103836:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
80103839:	68 20 2d 11 80       	push   $0x80112d20
8010383e:	e8 3d 06 00 00       	call   80103e80 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103843:	83 c4 10             	add    $0x10,%esp
80103846:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
8010384b:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80103850:	73 3a                	jae    8010388c <kill+0x5d>
    if(p->pid == pid){
80103852:	39 58 10             	cmp    %ebx,0x10(%eax)
80103855:	74 05                	je     8010385c <kill+0x2d>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103857:	83 e8 80             	sub    $0xffffff80,%eax
8010385a:	eb ef                	jmp    8010384b <kill+0x1c>
      p->killed = 1;
8010385c:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80103863:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103867:	74 1a                	je     80103883 <kill+0x54>
        p->state = RUNNABLE;
      release(&ptable.lock);
80103869:	83 ec 0c             	sub    $0xc,%esp
8010386c:	68 20 2d 11 80       	push   $0x80112d20
80103871:	e8 6f 06 00 00       	call   80103ee5 <release>
      return 0;
80103876:	83 c4 10             	add    $0x10,%esp
80103879:	b8 00 00 00 00       	mov    $0x0,%eax
    }
  }
  release(&ptable.lock);
  return -1;
...
80103882:	c3                   	ret    
        p->state = RUNNABLE;
80103883:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
8010388a:	eb dd                	jmp    80103869 <kill+0x3a>
  release(&ptable.lock);
8010388c:	83 ec 0c             	sub    $0xc,%esp
8010388f:	68 20 2d 11 80       	push   $0x80112d20
80103894:	e8 4c 06 00 00       	call   80103ee5 <release>
  return -1;
80103899:	83 c4 10             	add    $0x10,%esp
8010389c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801038a1:	eb db                	jmp    8010387e <kill+0x4f>
...
801038b0:	eb 33                	jmp    801038e5 <procdump+0x42>
    ...
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
      ...
      state = "???";
801038b2:	b8 c0 6d 10 80       	mov    $0x80106dc0,%eax
    cprintf("%d %s %s", p->pid, state, p->name);
801038b7:	8d 53 6c             	lea    0x6c(%ebx),%edx
801038ba:	52                   	push   %edx
801038bb:	50                   	push   %eax
801038bc:	ff 73 10             	pushl  0x10(%ebx)
801038bf:	68 c4 6d 10 80       	push   $0x80106dc4
801038c4:	e8 42 cd ff ff       	call   8010060b <cprintf>
    if(p->state == SLEEPING){
...
801038d5:	68 47 71 10 80       	push   $0x80107147
801038da:	e8 2c cd ff ff       	call   8010060b <cprintf>
801038df:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801038e2:	83 eb 80             	sub    $0xffffff80,%ebx
801038e5:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
...
801038f9:	8b 04 85 20 6e 10 80 	mov    -0x7fef91e0(,%eax,4),%eax
80103900:	85 c0                	test   %eax,%eax
80103902:	75 b3                	jne    801038b7 <procdump+0x14>
      state = "???";
80103904:	b8 c0 6d 10 80       	mov    $0x80106dc0,%eax
...
8010391c:	e8 3e 04 00 00       	call   80103d5f <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
8010392f:	68 01 68 10 80       	push   $0x80106801
...
80103958:	57                   	push   %edi
80103959:	56                   	push   %esi
8010395a:	53                   	push   %ebx
8010395b:	83 ec 0c             	sub    $0xc,%esp
8010395e:	8b 5d 08             	mov    0x8(%ebp),%ebx

    if (pri < 0 || pri > 3) {
80103961:	83 7d 0c 03          	cmpl   $0x3,0xc(%ebp)
80103965:	0f 87 ce 00 00 00    	ja     80103a39 <setpri+0xe4>
        return -1;
    }
...
80103973:	e8 08 05 00 00       	call   80103e80 <acquire>
    struct proc *p;
    int position = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103978:	83 c4 10             	add    $0x10,%esp
    int position = 0;
8010397b:	bf 00 00 00 00       	mov    $0x0,%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103980:	b9 54 2d 11 80       	mov    $0x80112d54,%ecx
80103985:	eb 4d                	jmp    801039d4 <setpri+0x7f>
            if(pri == 0) {
...
80103987:	be 54 4f 11 80       	mov    $0x80114f54,%esi
8010398c:	eb 05                	jmp    80103993 <setpri+0x3e>
                ptr = ptable.priority0;
8010398e:	be 54 4d 11 80       	mov    $0x80114d54,%esi
...
80103993:	89 f0                	mov    %esi,%eax
80103995:	8d 96 00 01 00 00    	lea    0x100(%esi),%edx
8010399b:	39 c2                	cmp    %eax,%edx
8010399d:	76 2f                	jbe    801039ce <setpri+0x79>
                if (ptr2 == UNUSED){
8010399f:	85 c0                	test   %eax,%eax
801039a1:	74 0c                	je     801039af <setpri+0x5a>
            for(ptr2 = ptr; ptr2 < &ptr[NPROC]; ptr2++){
801039a3:	83 c0 04             	add    $0x4,%eax
801039a6:	eb ed                	jmp    80103995 <setpri+0x40>
                ptr = ptable.priority1;
801039a8:	be 54 4e 11 80       	mov    $0x80114e54,%esi
801039ad:	eb e4                	jmp    80103993 <setpri+0x3e>
                    *ptr2 = p;
801039af:	89 08                	mov    %ecx,(%eax)
                    release(&ptable.lock);
801039b1:	83 ec 0c             	sub    $0xc,%esp
801039b4:	68 20 2d 11 80       	push   $0x80112d20
801039b9:	e8 27 05 00 00       	call   80103ee5 <release>
                    return 0;
801039be:	83 c4 10             	add    $0x10,%esp
801039c1:	b8 00 00 00 00       	mov    $0x0,%eax
        position++;
    }
...
801039cd:	c3                   	ret    
        position++;
801039ce:	83 c7 01             	add    $0x1,%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039d1:	83 e9 80             	sub    $0xffffff80,%ecx
801039d4:	81 f9 54 4d 11 80    	cmp    $0x80114d54,%ecx
801039da:	73 46                	jae    80103a22 <setpri+0xcd>
        if( p->pid == PID ){
801039dc:	39 59 10             	cmp    %ebx,0x10(%ecx)
801039df:	75 ed                	jne    801039ce <setpri+0x79>
            p->priority = pri;
801039e1:	8b 45 0c             	mov    0xc(%ebp),%eax
801039e4:	89 41 7c             	mov    %eax,0x7c(%ecx)
            ptable.inuse[position] = 1;
801039e7:	c7 04 bd 54 51 11 80 	movl   $0x1,-0x7feeaeac(,%edi,4)
801039ee:	01 00 00 00 
            ptable.pid[position] = p->pid;
801039f2:	8b 41 10             	mov    0x10(%ecx),%eax
801039f5:	89 04 bd 54 52 11 80 	mov    %eax,-0x7feeadac(,%edi,4)
            ptable.priority[position] = pri;
801039fc:	8b 45 0c             	mov    0xc(%ebp),%eax
801039ff:	89 04 bd 54 53 11 80 	mov    %eax,-0x7feeacac(,%edi,4)
            if(pri == 0) {
80103a06:	85 c0                	test   %eax,%eax
80103a08:	74 84                	je     8010398e <setpri+0x39>
            } else if (pri == 1) {
80103a0a:	83 f8 01             	cmp    $0x1,%eax
80103a0d:	74 99                	je     801039a8 <setpri+0x53>
            } else if (pri == 2) {
80103a0f:	83 f8 02             	cmp    $0x2,%eax
80103a12:	0f 84 6f ff ff ff    	je     80103987 <setpri+0x32>
                ptr = ptable.priority3;
80103a18:	be 54 50 11 80       	mov    $0x80115054,%esi
80103a1d:	e9 71 ff ff ff       	jmp    80103993 <setpri+0x3e>
    release(&ptable.lock);
80103a22:	83 ec 0c             	sub    $0xc,%esp
80103a25:	68 20 2d 11 80       	push   $0x80112d20
80103a2a:	e8 b6 04 00 00       	call   80103ee5 <release>
    return -1;
80103a2f:	83 c4 10             	add    $0x10,%esp
80103a32:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103a37:	eb 8d                	jmp    801039c6 <setpri+0x71>
        return -1;
80103a39:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103a3e:	eb 86                	jmp    801039c6 <setpri+0x71>
...
80103a4b:	68 20 2d 11 80       	push   $0x80112d20
80103a50:	e8 2b 04 00 00       	call   80103e80 <acquire>

    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103a55:	83 c4 10             	add    $0x10,%esp
80103a58:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103a5d:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103a63:	73 24                	jae    80103a89 <getpri+0x49>
        if (p->pid == PID) {
80103a65:	39 73 10             	cmp    %esi,0x10(%ebx)
80103a68:	74 05                	je     80103a6f <getpri+0x2f>
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103a6a:	83 eb 80             	sub    $0xffffff80,%ebx
80103a6d:	eb ee                	jmp    80103a5d <getpri+0x1d>
            release(&ptable.lock);
80103a6f:	83 ec 0c             	sub    $0xc,%esp
80103a72:	68 20 2d 11 80       	push   $0x80112d20
80103a77:	e8 69 04 00 00       	call   80103ee5 <release>
            return p->priority;
80103a7c:	8b 43 7c             	mov    0x7c(%ebx),%eax
...
80103a8c:	68 20 2d 11 80       	push   $0x80112d20
80103a91:	e8 4f 04 00 00       	call   80103ee5 <release>
    return -1;
80103a96:	83 c4 10             	add    $0x10,%esp
80103a99:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103a9e:	eb e2                	jmp    80103a82 <getpri+0x42>
...
80103aa6:	83 ec 1c             	sub    $0x1c,%esp
    ...
    if (pri < 0 || pri > 3) {
80103aa9:	83 7d 08 03          	cmpl   $0x3,0x8(%ebp)
80103aad:	77 5c                	ja     80103b0b <fork2+0x6b>
        exit();
    }
    ...
    struct proc *np;
    struct proc *curproc = myproc();
80103aaf:	e8 42 f7 ff ff       	call   801031f6 <myproc>
80103ab4:	89 c3                	mov    %eax,%ebx

    // Allocate process.
    if((np = allocproc()) == 0){
80103ab6:	e8 a6 f5 ff ff       	call   80103061 <allocproc>
80103abb:	89 c7                	mov    %eax,%edi
80103abd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103ac0:	85 c0                	test   %eax,%eax
80103ac2:	0f 84 ee 00 00 00    	je     80103bb6 <fork2+0x116>
        return -1;
    }
...
80103acb:	ff 33                	pushl  (%ebx)
80103acd:	ff 73 04             	pushl  0x4(%ebx)
80103ad0:	e8 47 2b 00 00       	call   8010661c <copyuvm>
80103ad5:	89 47 04             	mov    %eax,0x4(%edi)
80103ad8:	83 c4 10             	add    $0x10,%esp
80103adb:	85 c0                	test   %eax,%eax
80103add:	74 31                	je     80103b10 <fork2+0x70>
        kfree(np->kstack);
        np->kstack = 0;
        np->state = UNUSED;
        return -1;
    ...
    np->sz = curproc->sz;
80103adf:	8b 03                	mov    (%ebx),%eax
80103ae1:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80103ae4:	89 07                	mov    %eax,(%edi)
    np->parent = curproc;
80103ae6:	89 f8                	mov    %edi,%eax
80103ae8:	89 5f 14             	mov    %ebx,0x14(%edi)
    *np->tf = *curproc->tf;
80103aeb:	8b 73 18             	mov    0x18(%ebx),%esi
80103aee:	8b 7f 18             	mov    0x18(%edi),%edi
80103af1:	b9 13 00 00 00       	mov    $0x13,%ecx
80103af6:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

    // Clear %eax so that fork returns 0 in the child.
    np->tf->eax = 0;
80103af8:	89 c7                	mov    %eax,%edi
80103afa:	8b 40 18             	mov    0x18(%eax),%eax
80103afd:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

    for(i = 0; i < NOFILE; i++)
80103b04:	be 00 00 00 00       	mov    $0x0,%esi
80103b09:	eb 2e                	jmp    80103b39 <fork2+0x99>
        exit();
80103b0b:	e8 99 fa ff ff       	call   801035a9 <exit>
        kfree(np->kstack);
80103b10:	83 ec 0c             	sub    $0xc,%esp
80103b13:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103b16:	ff 73 08             	pushl  0x8(%ebx)
80103b19:	e8 86 e4 ff ff       	call   80101fa4 <kfree>
        np->kstack = 0;
80103b1e:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        np->state = UNUSED;
80103b25:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        return -1;
80103b2c:	83 c4 10             	add    $0x10,%esp
80103b2f:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103b34:	eb 76                	jmp    80103bac <fork2+0x10c>
    for(i = 0; i < NOFILE; i++)
80103b36:	83 c6 01             	add    $0x1,%esi
80103b39:	83 fe 0f             	cmp    $0xf,%esi
80103b3c:	7f 1a                	jg     80103b58 <fork2+0xb8>
        if(curproc->ofile[i])
80103b3e:	8b 44 b3 28          	mov    0x28(%ebx,%esi,4),%eax
80103b42:	85 c0                	test   %eax,%eax
80103b44:	74 f0                	je     80103b36 <fork2+0x96>
            np->ofile[i] = filedup(curproc->ofile[i]);
80103b46:	83 ec 0c             	sub    $0xc,%esp
80103b49:	50                   	push   %eax
80103b4a:	e8 3f d1 ff ff       	call   80100c8e <filedup>
80103b4f:	89 44 b7 28          	mov    %eax,0x28(%edi,%esi,4)
80103b53:	83 c4 10             	add    $0x10,%esp
80103b56:	eb de                	jmp    80103b36 <fork2+0x96>
    np->cwd = idup(curproc->cwd);
80103b58:	83 ec 0c             	sub    $0xc,%esp
80103b5b:	ff 73 68             	pushl  0x68(%ebx)
80103b5e:	e8 ee d9 ff ff       	call   80101551 <idup>
80103b63:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80103b66:	89 47 68             	mov    %eax,0x68(%edi)

    safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103b69:	83 c3 6c             	add    $0x6c,%ebx
80103b6c:	8d 47 6c             	lea    0x6c(%edi),%eax
80103b6f:	83 c4 0c             	add    $0xc,%esp
80103b72:	6a 10                	push   $0x10
80103b74:	53                   	push   %ebx
80103b75:	50                   	push   %eax
80103b76:	e8 18 05 00 00       	call   80104093 <safestrcpy>

    pid = np->pid;
80103b7b:	8b 5f 10             	mov    0x10(%edi),%ebx
    setpri(pid, pri);
80103b7e:	83 c4 08             	add    $0x8,%esp
80103b81:	ff 75 08             	pushl  0x8(%ebp)
80103b84:	53                   	push   %ebx
80103b85:	e8 cb fd ff ff       	call   80103955 <setpri>

    acquire(&ptable.lock);
80103b8a:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103b91:	e8 ea 02 00 00       	call   80103e80 <acquire>
    np->state = RUNNABLE;
80103b96:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
    release(&ptable.lock);
80103b9d:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ba4:	e8 3c 03 00 00       	call   80103ee5 <release>
...
80103bbb:	eb ef                	jmp    80103bac <fork2+0x10c>
...
80103bc1:	83 ec 10             	sub    $0x10,%esp
80103bc4:	8b 5d 08             	mov    0x8(%ebp),%ebx

    acquire(&ptable.lock);
80103bc7:	68 20 2d 11 80       	push   $0x80112d20
80103bcc:	e8 af 02 00 00       	call   80103e80 <acquire>

    for (int i = 0; i < NPROC; i++){
        pstat->inuse[i] = ptable.inuse[i];
80103bd1:	a1 54 51 11 80       	mov    0x80115154,%eax
80103bd6:	89 03                	mov    %eax,(%ebx)
        pstat->pid[i] = ptable.pid[i];
80103bd8:	a1 54 52 11 80       	mov    0x80115254,%eax
80103bdd:	89 83 00 01 00 00    	mov    %eax,0x100(%ebx)
        pstat->priority[i] = ptable.priority[i];
80103be3:	a1 54 53 11 80       	mov    0x80115354,%eax
80103be8:	89 83 00 02 00 00    	mov    %eax,0x200(%ebx)
        pstat->state[i] = ptable.state[i];
80103bee:	a1 54 54 11 80       	mov    0x80115454,%eax
80103bf3:	89 83 00 03 00 00    	mov    %eax,0x300(%ebx)
        for (int j = 0; j < 4; i++) {
80103bf9:	83 c4 10             	add    $0x10,%esp
80103bfc:	b8 00 00 00 00       	mov    $0x0,%eax
            pstat->ticks[i][j] = ptable.ticks[i][j];
80103c01:	8d 90 83 02 00 00    	lea    0x283(%eax),%edx
80103c07:	c1 e2 04             	shl    $0x4,%edx
80103c0a:	8b 8a 24 2d 11 80    	mov    -0x7feed2dc(%edx),%ecx
80103c10:	8d 50 40             	lea    0x40(%eax),%edx
80103c13:	c1 e2 04             	shl    $0x4,%edx
80103c16:	89 0c 13             	mov    %ecx,(%ebx,%edx,1)
            pstat->qtail[i][j] = ptable.qtail[i][j];
80103c19:	8d 90 c3 02 00 00    	lea    0x2c3(%eax),%edx
80103c1f:	c1 e2 04             	shl    $0x4,%edx
80103c22:	8b 8a 24 2d 11 80    	mov    -0x7feed2dc(%edx),%ecx
80103c28:	8d 90 80 00 00 00    	lea    0x80(%eax),%edx
80103c2e:	c1 e2 04             	shl    $0x4,%edx
80103c31:	89 0c 13             	mov    %ecx,(%ebx,%edx,1)
        for (int j = 0; j < 4; i++) {
80103c34:	83 c0 01             	add    $0x1,%eax
80103c37:	eb c8                	jmp    80103c01 <getpinfo+0x44>

80103c39 <initsleeplock>:
#include "spinlock.h"
#include "sleeplock.h"
...
80103c43:	68 38 6e 10 80       	push   $0x80106e38
80103c48:	8d 43 04             	lea    0x4(%ebx),%eax
80103c4b:	50                   	push   %eax
80103c4c:	e8 f3 00 00 00       	call   80103d44 <initlock>
  lk->name = name;
80103c51:	8b 45 0c             	mov    0xc(%ebp),%eax
80103c54:	89 43 38             	mov    %eax,0x38(%ebx)
  lk->locked = 0;
...
80103c71:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80103c74:	8d 73 04             	lea    0x4(%ebx),%esi
80103c77:	83 ec 0c             	sub    $0xc,%esp
80103c7a:	56                   	push   %esi
80103c7b:	e8 00 02 00 00       	call   80103e80 <acquire>
  while (lk->locked) {
80103c80:	83 c4 10             	add    $0x10,%esp
80103c83:	eb 0d                	jmp    80103c92 <acquiresleep+0x26>
    sleep(lk, &lk->lk);
80103c85:	83 ec 08             	sub    $0x8,%esp
80103c88:	56                   	push   %esi
80103c89:	53                   	push   %ebx
80103c8a:	e8 12 fa ff ff       	call   801036a1 <sleep>
80103c8f:	83 c4 10             	add    $0x10,%esp
  while (lk->locked) {
80103c92:	83 3b 00             	cmpl   $0x0,(%ebx)
80103c95:	75 ee                	jne    80103c85 <acquiresleep+0x19>
  }
  lk->locked = 1;
80103c97:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80103c9d:	e8 54 f5 ff ff       	call   801031f6 <myproc>
80103ca2:	8b 40 10             	mov    0x10(%eax),%eax
80103ca5:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
80103ca8:	83 ec 0c             	sub    $0xc,%esp
80103cab:	56                   	push   %esi
80103cac:	e8 34 02 00 00       	call   80103ee5 <release>
}
...
80103cc0:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80103cc3:	8d 73 04             	lea    0x4(%ebx),%esi
80103cc6:	83 ec 0c             	sub    $0xc,%esp
80103cc9:	56                   	push   %esi
80103cca:	e8 b1 01 00 00       	call   80103e80 <acquire>
  lk->locked = 0;
80103ccf:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80103cd5:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80103cdc:	89 1c 24             	mov    %ebx,(%esp)
80103cdf:	e8 22 fb ff ff       	call   80103806 <wakeup>
  release(&lk->lk);
80103ce4:	89 34 24             	mov    %esi,(%esp)
80103ce7:	e8 f9 01 00 00       	call   80103ee5 <release>
}
...
80103d05:	e8 76 01 00 00       	call   80103e80 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80103d0a:	83 c4 10             	add    $0x10,%esp
80103d0d:	83 3b 00             	cmpl   $0x0,(%ebx)
80103d10:	75 17                	jne    80103d29 <holdingsleep+0x33>
80103d12:	bb 00 00 00 00       	mov    $0x0,%ebx
  release(&lk->lk);
80103d17:	83 ec 0c             	sub    $0xc,%esp
80103d1a:	56                   	push   %esi
80103d1b:	e8 c5 01 00 00       	call   80103ee5 <release>
  return r;
}
80103d20:	89 d8                	mov    %ebx,%eax
...
80103d28:	c3                   	ret    
  r = lk->locked && (lk->pid == myproc()->pid);
80103d29:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80103d2c:	e8 c5 f4 ff ff       	call   801031f6 <myproc>
80103d31:	3b 58 10             	cmp    0x10(%eax),%ebx
80103d34:	74 07                	je     80103d3d <holdingsleep+0x47>
80103d36:	bb 00 00 00 00       	mov    $0x0,%ebx
80103d3b:	eb da                	jmp    80103d17 <holdingsleep+0x21>
80103d3d:	bb 01 00 00 00       	mov    $0x1,%ebx
80103d42:	eb d3                	jmp    80103d17 <holdingsleep+0x21>
...
80103d4d:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80103d50:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80103d56:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80103d5d:	5d                   	pop    %ebp
80103d5e:	c3                   	ret    

80103d5f <getcallerpcs>:
}
...
80103d63:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  uint *ebp;
  int i;

  ebp = (uint*)v - 2;
80103d66:	8b 45 08             	mov    0x8(%ebp),%eax
80103d69:	8d 50 f8             	lea    -0x8(%eax),%edx
  for(i = 0; i < 10; i++){
80103d6c:	b8 00 00 00 00       	mov    $0x0,%eax
80103d71:	83 f8 09             	cmp    $0x9,%eax
80103d74:	7f 25                	jg     80103d9b <getcallerpcs+0x3c>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80103d76:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
80103d7c:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80103d82:	77 17                	ja     80103d9b <getcallerpcs+0x3c>
      break;
    pcs[i] = ebp[1];     // saved %eip
80103d84:	8b 5a 04             	mov    0x4(%edx),%ebx
80103d87:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
    ebp = (uint*)ebp[0]; // saved %ebp
80103d8a:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
80103d8c:	83 c0 01             	add    $0x1,%eax
80103d8f:	eb e0                	jmp    80103d71 <getcallerpcs+0x12>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
80103d91:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
  for(; i < 10; i++)
80103d98:	83 c0 01             	add    $0x1,%eax
80103d9b:	83 f8 09             	cmp    $0x9,%eax
80103d9e:	7e f1                	jle    80103d91 <getcallerpcs+0x32>
}
80103da0:	5b                   	pop    %ebx
80103da1:	5d                   	pop    %ebp
80103da2:	c3                   	ret    
...
80103dac:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
80103dad:	e8 cd f3 ff ff       	call   8010317f <mycpu>
80103db2:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103db9:	74 12                	je     80103dcd <pushcli+0x2a>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80103dbb:	e8 bf f3 ff ff       	call   8010317f <mycpu>
80103dc0:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
80103dc7:	83 c4 04             	add    $0x4,%esp
80103dca:	5b                   	pop    %ebx
80103dcb:	5d                   	pop    %ebp
80103dcc:	c3                   	ret    
    mycpu()->intena = eflags & FL_IF;
80103dcd:	e8 ad f3 ff ff       	call   8010317f <mycpu>
80103dd2:	81 e3 00 02 00 00    	and    $0x200,%ebx
80103dd8:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80103dde:	eb db                	jmp    80103dbb <pushcli+0x18>
...
80103deb:	75 28                	jne    80103e15 <popcli+0x35>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80103ded:	e8 8d f3 ff ff       	call   8010317f <mycpu>
80103df2:	8b 88 a4 00 00 00    	mov    0xa4(%eax),%ecx
80103df8:	8d 51 ff             	lea    -0x1(%ecx),%edx
80103dfb:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
80103e01:	85 d2                	test   %edx,%edx
80103e03:	78 1d                	js     80103e22 <popcli+0x42>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103e05:	e8 75 f3 ff ff       	call   8010317f <mycpu>
80103e0a:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103e11:	74 1c                	je     80103e2f <popcli+0x4f>
    sti();
}
80103e13:	c9                   	leave  
80103e14:	c3                   	ret    
...
80103e18:	68 43 6e 10 80       	push   $0x80106e43
80103e1d:	e8 26 c5 ff ff       	call   80100348 <panic>
    panic("popcli");
80103e22:	83 ec 0c             	sub    $0xc,%esp
80103e25:	68 5a 6e 10 80       	push   $0x80106e5a
80103e2a:	e8 19 c5 ff ff       	call   80100348 <panic>
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103e2f:	e8 4b f3 ff ff       	call   8010317f <mycpu>
80103e34:	83 b8 a8 00 00 00 00 	cmpl   $0x0,0xa8(%eax)
80103e3b:	74 d6                	je     80103e13 <popcli+0x33>
  asm volatile("sti");
80103e3d:	fb                   	sti    
}
80103e3e:	eb d3                	jmp    80103e13 <popcli+0x33>
...
80103e47:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80103e4a:	e8 54 ff ff ff       	call   80103da3 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80103e4f:	83 3b 00             	cmpl   $0x0,(%ebx)
80103e52:	75 12                	jne    80103e66 <holding+0x26>
80103e54:	bb 00 00 00 00       	mov    $0x0,%ebx
  popcli();
80103e59:	e8 82 ff ff ff       	call   80103de0 <popcli>
}
...
80103e65:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
80103e66:	8b 5b 08             	mov    0x8(%ebx),%ebx
80103e69:	e8 11 f3 ff ff       	call   8010317f <mycpu>
80103e6e:	39 c3                	cmp    %eax,%ebx
80103e70:	74 07                	je     80103e79 <holding+0x39>
80103e72:	bb 00 00 00 00       	mov    $0x0,%ebx
80103e77:	eb e0                	jmp    80103e59 <holding+0x19>
80103e79:	bb 01 00 00 00       	mov    $0x1,%ebx
80103e7e:	eb d9                	jmp    80103e59 <holding+0x19>
...
80103e87:	e8 17 ff ff ff       	call   80103da3 <pushcli>
  if(holding(lk))
80103e8c:	83 ec 0c             	sub    $0xc,%esp
80103e8f:	ff 75 08             	pushl  0x8(%ebp)
80103e92:	e8 a9 ff ff ff       	call   80103e40 <holding>
80103e97:	83 c4 10             	add    $0x10,%esp
80103e9a:	85 c0                	test   %eax,%eax
80103e9c:	75 3a                	jne    80103ed8 <acquire+0x58>
  while(xchg(&lk->locked, 1) != 0)
80103e9e:	8b 55 08             	mov    0x8(%ebp),%edx
  asm volatile("lock; xchgl %0, %1" :
80103ea1:	b8 01 00 00 00       	mov    $0x1,%eax
80103ea6:	f0 87 02             	lock xchg %eax,(%edx)
80103ea9:	85 c0                	test   %eax,%eax
80103eab:	75 f1                	jne    80103e9e <acquire+0x1e>
  __sync_synchronize();
80103ead:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80103eb2:	8b 5d 08             	mov    0x8(%ebp),%ebx
80103eb5:	e8 c5 f2 ff ff       	call   8010317f <mycpu>
80103eba:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
80103ebd:	8b 45 08             	mov    0x8(%ebp),%eax
80103ec0:	83 c0 0c             	add    $0xc,%eax
80103ec3:	83 ec 08             	sub    $0x8,%esp
80103ec6:	50                   	push   %eax
80103ec7:	8d 45 08             	lea    0x8(%ebp),%eax
80103eca:	50                   	push   %eax
80103ecb:	e8 8f fe ff ff       	call   80103d5f <getcallerpcs>
}
...
80103edb:	68 61 6e 10 80       	push   $0x80106e61
80103ee0:	e8 63 c4 ff ff       	call   80100348 <panic>
...
80103ee9:	83 ec 10             	sub    $0x10,%esp
80103eec:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(!holding(lk))
80103eef:	53                   	push   %ebx
80103ef0:	e8 4b ff ff ff       	call   80103e40 <holding>
80103ef5:	83 c4 10             	add    $0x10,%esp
80103ef8:	85 c0                	test   %eax,%eax
80103efa:	74 23                	je     80103f1f <release+0x3a>
  lk->pcs[0] = 0;
80103efc:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80103f03:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80103f0a:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80103f0f:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  popcli();
80103f15:	e8 c6 fe ff ff       	call   80103de0 <popcli>
}
...
80103f22:	68 69 6e 10 80       	push   $0x80106e69
80103f27:	e8 1c c4 ff ff       	call   80100348 <panic>
...
80103f31:	8b 55 08             	mov    0x8(%ebp),%edx
80103f34:	8b 4d 10             	mov    0x10(%ebp),%ecx
  if ((int)dst%4 == 0 && n%4 == 0){
80103f37:	f6 c2 03             	test   $0x3,%dl
80103f3a:	75 05                	jne    80103f41 <memset+0x15>
80103f3c:	f6 c1 03             	test   $0x3,%cl
80103f3f:	74 0e                	je     80103f4f <memset+0x23>
  asm volatile("cld; rep stosb" :
80103f41:	89 d7                	mov    %edx,%edi
80103f43:	8b 45 0c             	mov    0xc(%ebp),%eax
80103f46:	fc                   	cld    
80103f47:	f3 aa                	rep stos %al,%es:(%edi)
    c &= 0xFF;
...
80103f49:	89 d0                	mov    %edx,%eax
80103f4b:	5b                   	pop    %ebx
80103f4c:	5f                   	pop    %edi
80103f4d:	5d                   	pop    %ebp
80103f4e:	c3                   	ret    
    c &= 0xFF;
80103f4f:	0f b6 7d 0c          	movzbl 0xc(%ebp),%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80103f53:	c1 e9 02             	shr    $0x2,%ecx
80103f56:	89 f8                	mov    %edi,%eax
80103f58:	c1 e0 18             	shl    $0x18,%eax
80103f5b:	89 fb                	mov    %edi,%ebx
80103f5d:	c1 e3 10             	shl    $0x10,%ebx
80103f60:	09 d8                	or     %ebx,%eax
80103f62:	89 fb                	mov    %edi,%ebx
80103f64:	c1 e3 08             	shl    $0x8,%ebx
80103f67:	09 d8                	or     %ebx,%eax
80103f69:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
80103f6b:	89 d7                	mov    %edx,%edi
80103f6d:	fc                   	cld    
80103f6e:	f3 ab                	rep stos %eax,%es:(%edi)
80103f70:	eb d7                	jmp    80103f49 <memset+0x1d>
...
80103f7d:	8b 45 10             	mov    0x10(%ebp),%eax
  const uchar *s1, *s2;

  s1 = v1;
  s2 = v2;
  while(n-- > 0){
80103f80:	8d 70 ff             	lea    -0x1(%eax),%esi
80103f83:	85 c0                	test   %eax,%eax
80103f85:	74 1c                	je     80103fa3 <memcmp+0x31>
    if(*s1 != *s2)
80103f87:	0f b6 01             	movzbl (%ecx),%eax
80103f8a:	0f b6 1a             	movzbl (%edx),%ebx
80103f8d:	38 d8                	cmp    %bl,%al
80103f8f:	75 0a                	jne    80103f9b <memcmp+0x29>
      return *s1 - *s2;
    s1++, s2++;
80103f91:	83 c1 01             	add    $0x1,%ecx
80103f94:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80103f97:	89 f0                	mov    %esi,%eax
80103f99:	eb e5                	jmp    80103f80 <memcmp+0xe>
      return *s1 - *s2;
80103f9b:	0f b6 c0             	movzbl %al,%eax
80103f9e:	0f b6 db             	movzbl %bl,%ebx
80103fa1:	29 d8                	sub    %ebx,%eax
  }
...
80103fb2:	8b 55 10             	mov    0x10(%ebp),%edx
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80103fb5:	39 c1                	cmp    %eax,%ecx
80103fb7:	73 3a                	jae    80103ff3 <memmove+0x4c>
80103fb9:	8d 1c 11             	lea    (%ecx,%edx,1),%ebx
80103fbc:	39 c3                	cmp    %eax,%ebx
80103fbe:	76 37                	jbe    80103ff7 <memmove+0x50>
    s += n;
    d += n;
80103fc0:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
    while(n-- > 0)
80103fc3:	eb 0d                	jmp    80103fd2 <memmove+0x2b>
      *--d = *--s;
80103fc5:	83 eb 01             	sub    $0x1,%ebx
80103fc8:	83 e9 01             	sub    $0x1,%ecx
80103fcb:	0f b6 13             	movzbl (%ebx),%edx
80103fce:	88 11                	mov    %dl,(%ecx)
    while(n-- > 0)
80103fd0:	89 f2                	mov    %esi,%edx
80103fd2:	8d 72 ff             	lea    -0x1(%edx),%esi
80103fd5:	85 d2                	test   %edx,%edx
80103fd7:	75 ec                	jne    80103fc5 <memmove+0x1e>
80103fd9:	eb 14                	jmp    80103fef <memmove+0x48>
  } else
    while(n-- > 0)
      *d++ = *s++;
80103fdb:	0f b6 11             	movzbl (%ecx),%edx
80103fde:	88 13                	mov    %dl,(%ebx)
80103fe0:	8d 5b 01             	lea    0x1(%ebx),%ebx
80103fe3:	8d 49 01             	lea    0x1(%ecx),%ecx
    while(n-- > 0)
80103fe6:	89 f2                	mov    %esi,%edx
80103fe8:	8d 72 ff             	lea    -0x1(%edx),%esi
80103feb:	85 d2                	test   %edx,%edx
80103fed:	75 ec                	jne    80103fdb <memmove+0x34>
...
80103ff1:	5d                   	pop    %ebp
80103ff2:	c3                   	ret    
80103ff3:	89 c3                	mov    %eax,%ebx
80103ff5:	eb f1                	jmp    80103fe8 <memmove+0x41>
80103ff7:	89 c3                	mov    %eax,%ebx
80103ff9:	eb ed                	jmp    80103fe8 <memmove+0x41>
...
80103ffe:	ff 75 10             	pushl  0x10(%ebp)
80104001:	ff 75 0c             	pushl  0xc(%ebp)
80104004:	ff 75 08             	pushl  0x8(%ebp)
80104007:	e8 9b ff ff ff       	call   80103fa7 <memmove>
}
8010400c:	c9                   	leave  
8010400d:	c3                   	ret    
...
80104012:	8b 55 08             	mov    0x8(%ebp),%edx
80104015:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104018:	8b 45 10             	mov    0x10(%ebp),%eax
  while(n > 0 && *p && *p == *q)
8010401b:	eb 09                	jmp    80104026 <strncmp+0x18>
    n--, p++, q++;
8010401d:	83 e8 01             	sub    $0x1,%eax
80104020:	83 c2 01             	add    $0x1,%edx
80104023:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80104026:	85 c0                	test   %eax,%eax
80104028:	74 0b                	je     80104035 <strncmp+0x27>
8010402a:	0f b6 1a             	movzbl (%edx),%ebx
8010402d:	84 db                	test   %bl,%bl
8010402f:	74 04                	je     80104035 <strncmp+0x27>
80104031:	3a 19                	cmp    (%ecx),%bl
80104033:	74 e8                	je     8010401d <strncmp+0xf>
  if(n == 0)
80104035:	85 c0                	test   %eax,%eax
80104037:	74 0b                	je     80104044 <strncmp+0x36>
    return 0;
  return (uchar)*p - (uchar)*q;
80104039:	0f b6 02             	movzbl (%edx),%eax
8010403c:	0f b6 11             	movzbl (%ecx),%edx
8010403f:	29 d0                	sub    %edx,%eax
}
80104041:	5b                   	pop    %ebx
80104042:	5d                   	pop    %ebp
80104043:	c3                   	ret    
    return 0;
80104044:	b8 00 00 00 00       	mov    $0x0,%eax
80104049:	eb f6                	jmp    80104041 <strncmp+0x33>
...
8010404e:	57                   	push   %edi
8010404f:	56                   	push   %esi
80104050:	53                   	push   %ebx
80104051:	8b 5d 0c             	mov    0xc(%ebp),%ebx
80104054:	8b 4d 10             	mov    0x10(%ebp),%ecx
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80104057:	8b 45 08             	mov    0x8(%ebp),%eax
8010405a:	eb 04                	jmp    80104060 <strncpy+0x15>
8010405c:	89 fb                	mov    %edi,%ebx
8010405e:	89 f0                	mov    %esi,%eax
80104060:	8d 51 ff             	lea    -0x1(%ecx),%edx
80104063:	85 c9                	test   %ecx,%ecx
80104065:	7e 1d                	jle    80104084 <strncpy+0x39>
80104067:	8d 7b 01             	lea    0x1(%ebx),%edi
8010406a:	8d 70 01             	lea    0x1(%eax),%esi
8010406d:	0f b6 1b             	movzbl (%ebx),%ebx
80104070:	88 18                	mov    %bl,(%eax)
80104072:	89 d1                	mov    %edx,%ecx
80104074:	84 db                	test   %bl,%bl
80104076:	75 e4                	jne    8010405c <strncpy+0x11>
80104078:	89 f0                	mov    %esi,%eax
8010407a:	eb 08                	jmp    80104084 <strncpy+0x39>
    ;
  while(n-- > 0)
    *s++ = 0;
8010407c:	c6 00 00             	movb   $0x0,(%eax)
  while(n-- > 0)
8010407f:	89 ca                	mov    %ecx,%edx
    *s++ = 0;
80104081:	8d 40 01             	lea    0x1(%eax),%eax
  while(n-- > 0)
80104084:	8d 4a ff             	lea    -0x1(%edx),%ecx
80104087:	85 d2                	test   %edx,%edx
80104089:	7f f1                	jg     8010407c <strncpy+0x31>
  return os;
}
...
80104096:	57                   	push   %edi
80104097:	56                   	push   %esi
80104098:	53                   	push   %ebx
80104099:	8b 45 08             	mov    0x8(%ebp),%eax
8010409c:	8b 5d 0c             	mov    0xc(%ebp),%ebx
8010409f:	8b 55 10             	mov    0x10(%ebp),%edx
  char *os;

  os = s;
  if(n <= 0)
801040a2:	85 d2                	test   %edx,%edx
801040a4:	7e 23                	jle    801040c9 <safestrcpy+0x36>
801040a6:	89 c1                	mov    %eax,%ecx
801040a8:	eb 04                	jmp    801040ae <safestrcpy+0x1b>
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
801040aa:	89 fb                	mov    %edi,%ebx
801040ac:	89 f1                	mov    %esi,%ecx
801040ae:	83 ea 01             	sub    $0x1,%edx
801040b1:	85 d2                	test   %edx,%edx
801040b3:	7e 11                	jle    801040c6 <safestrcpy+0x33>
801040b5:	8d 7b 01             	lea    0x1(%ebx),%edi
801040b8:	8d 71 01             	lea    0x1(%ecx),%esi
801040bb:	0f b6 1b             	movzbl (%ebx),%ebx
801040be:	88 19                	mov    %bl,(%ecx)
801040c0:	84 db                	test   %bl,%bl
801040c2:	75 e6                	jne    801040aa <safestrcpy+0x17>
801040c4:	89 f1                	mov    %esi,%ecx
    ;
  *s = 0;
801040c6:	c6 01 00             	movb   $0x0,(%ecx)
  return os;
}
801040c9:	5b                   	pop    %ebx
801040ca:	5e                   	pop    %esi
...
801040d9:	eb 03                	jmp    801040de <strlen+0x10>
801040db:	83 c0 01             	add    $0x1,%eax
801040de:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
801040e2:	75 f7                	jne    801040db <strlen+0xd>
    ;
  return n;
}
801040e4:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
801040e6:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801040ea:	8b 54 24 08          	mov    0x8(%esp),%edx
...
801040f1:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
801040f2:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
801040f4:	89 d4                	mov    %edx,%esp
...
801040ff:	83 ec 04             	sub    $0x4,%esp
80104102:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104105:	e8 ec f0 ff ff       	call   801031f6 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
8010410a:	8b 00                	mov    (%eax),%eax
8010410c:	39 d8                	cmp    %ebx,%eax
8010410e:	76 19                	jbe    80104129 <fetchint+0x2e>
80104110:	8d 53 04             	lea    0x4(%ebx),%edx
80104113:	39 d0                	cmp    %edx,%eax
80104115:	72 19                	jb     80104130 <fetchint+0x35>
    return -1;
  *ip = *(int*)(addr);
80104117:	8b 13                	mov    (%ebx),%edx
80104119:	8b 45 0c             	mov    0xc(%ebp),%eax
...
8010412e:	eb f3                	jmp    80104123 <fetchint+0x28>
80104130:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104135:	eb ec                	jmp    80104123 <fetchint+0x28>
...
8010413e:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104141:	e8 b0 f0 ff ff       	call   801031f6 <myproc>

  if(addr >= curproc->sz)
80104146:	39 18                	cmp    %ebx,(%eax)
80104148:	76 26                	jbe    80104170 <fetchstr+0x39>
    return -1;
  *pp = (char*)addr;
8010414a:	8b 55 0c             	mov    0xc(%ebp),%edx
8010414d:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
8010414f:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
80104151:	89 d8                	mov    %ebx,%eax
80104153:	39 d0                	cmp    %edx,%eax
80104155:	73 0e                	jae    80104165 <fetchstr+0x2e>
    if(*s == 0)
80104157:	80 38 00             	cmpb   $0x0,(%eax)
8010415a:	74 05                	je     80104161 <fetchstr+0x2a>
  for(s = *pp; s < ep; s++){
8010415c:	83 c0 01             	add    $0x1,%eax
8010415f:	eb f2                	jmp    80104153 <fetchstr+0x1c>
      return s - *pp;
80104161:	29 d8                	sub    %ebx,%eax
80104163:	eb 05                	jmp    8010416a <fetchstr+0x33>
  }
  return -1;
80104165:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
8010416a:	83 c4 04             	add    $0x4,%esp
8010416d:	5b                   	pop    %ebx
8010416e:	5d                   	pop    %ebp
8010416f:	c3                   	ret    
    return -1;
80104170:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104175:	eb f3                	jmp    8010416a <fetchstr+0x33>
...
8010417d:	e8 74 f0 ff ff       	call   801031f6 <myproc>
80104182:	8b 50 18             	mov    0x18(%eax),%edx
80104185:	8b 45 08             	mov    0x8(%ebp),%eax
80104188:	c1 e0 02             	shl    $0x2,%eax
8010418b:	03 42 44             	add    0x44(%edx),%eax
8010418e:	83 ec 08             	sub    $0x8,%esp
80104191:	ff 75 0c             	pushl  0xc(%ebp)
80104194:	83 c0 04             	add    $0x4,%eax
80104197:	50                   	push   %eax
80104198:	e8 5e ff ff ff       	call   801040fb <fetchint>
}
8010419d:	c9                   	leave  
8010419e:	c3                   	ret    
...
801041a7:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801041aa:	e8 47 f0 ff ff       	call   801031f6 <myproc>
801041af:	89 c6                	mov    %eax,%esi
 
  if(argint(n, &i) < 0)
801041b1:	83 ec 08             	sub    $0x8,%esp
801041b4:	8d 45 f4             	lea    -0xc(%ebp),%eax
801041b7:	50                   	push   %eax
801041b8:	ff 75 08             	pushl  0x8(%ebp)
801041bb:	e8 b7 ff ff ff       	call   80104177 <argint>
801041c0:	83 c4 10             	add    $0x10,%esp
801041c3:	85 c0                	test   %eax,%eax
801041c5:	78 24                	js     801041eb <argptr+0x4c>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
801041c7:	85 db                	test   %ebx,%ebx
801041c9:	78 27                	js     801041f2 <argptr+0x53>
801041cb:	8b 16                	mov    (%esi),%edx
801041cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041d0:	39 c2                	cmp    %eax,%edx
801041d2:	76 25                	jbe    801041f9 <argptr+0x5a>
801041d4:	01 c3                	add    %eax,%ebx
801041d6:	39 da                	cmp    %ebx,%edx
801041d8:	72 26                	jb     80104200 <argptr+0x61>
    return -1;
  *pp = (char*)i;
801041da:	8b 55 0c             	mov    0xc(%ebp),%edx
801041dd:	89 02                	mov    %eax,(%edx)
  return 0;
801041df:	b8 00 00 00 00       	mov    $0x0,%eax
}
801041e4:	8d 65 f8             	lea    -0x8(%ebp),%esp
801041e7:	5b                   	pop    %ebx
801041e8:	5e                   	pop    %esi
801041e9:	5d                   	pop    %ebp
801041ea:	c3                   	ret    
...
801041f0:	eb f2                	jmp    801041e4 <argptr+0x45>
    return -1;
801041f2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801041f7:	eb eb                	jmp    801041e4 <argptr+0x45>
801041f9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801041fe:	eb e4                	jmp    801041e4 <argptr+0x45>
80104200:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104205:	eb dd                	jmp    801041e4 <argptr+0x45>
...
8010420a:	83 ec 20             	sub    $0x20,%esp
  int addr;
  if(argint(n, &addr) < 0)
8010420d:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104210:	50                   	push   %eax
80104211:	ff 75 08             	pushl  0x8(%ebp)
80104214:	e8 5e ff ff ff       	call   80104177 <argint>
80104219:	83 c4 10             	add    $0x10,%esp
8010421c:	85 c0                	test   %eax,%eax
8010421e:	78 13                	js     80104233 <argstr+0x2c>
    return -1;
  return fetchstr(addr, pp);
80104220:	83 ec 08             	sub    $0x8,%esp
80104223:	ff 75 0c             	pushl  0xc(%ebp)
80104226:	ff 75 f4             	pushl  -0xc(%ebp)
80104229:	e8 09 ff ff ff       	call   80104137 <fetchstr>
...
80104238:	eb f7                	jmp    80104231 <argstr+0x2a>
...
8010423e:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104241:	e8 b0 ef ff ff       	call   801031f6 <myproc>
80104246:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104248:	8b 40 18             	mov    0x18(%eax),%eax
8010424b:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
8010424e:	8d 50 ff             	lea    -0x1(%eax),%edx
80104251:	83 fa 18             	cmp    $0x18,%edx
80104254:	77 18                	ja     8010426e <syscall+0x34>
80104256:	8b 14 85 a0 6e 10 80 	mov    -0x7fef9160(,%eax,4),%edx
8010425d:	85 d2                	test   %edx,%edx
8010425f:	74 0d                	je     8010426e <syscall+0x34>
    curproc->tf->eax = syscalls[num]();
80104261:	ff d2                	call   *%edx
80104263:	8b 53 18             	mov    0x18(%ebx),%edx
80104266:	89 42 1c             	mov    %eax,0x1c(%edx)
  } else {
...
8010426d:	c3                   	ret    
            curproc->pid, curproc->name, num);
8010426e:	8d 53 6c             	lea    0x6c(%ebx),%edx
    cprintf("%d %s: unknown sys call %d\n",
80104271:	50                   	push   %eax
80104272:	52                   	push   %edx
80104273:	ff 73 10             	pushl  0x10(%ebx)
80104276:	68 71 6e 10 80       	push   $0x80106e71
8010427b:	e8 8b c3 ff ff       	call   8010060b <cprintf>
    curproc->tf->eax = -1;
80104280:	8b 43 18             	mov    0x18(%ebx),%eax
80104283:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
8010428a:	83 c4 10             	add    $0x10,%esp
}
8010428d:	eb da                	jmp    80104269 <syscall+0x2f>
...
80104294:	83 ec 18             	sub    $0x18,%esp
80104297:	89 d6                	mov    %edx,%esi
80104299:	89 cb                	mov    %ecx,%ebx
  int fd;
  struct file *f;

  if(argint(n, &fd) < 0)
8010429b:	8d 55 f4             	lea    -0xc(%ebp),%edx
8010429e:	52                   	push   %edx
8010429f:	50                   	push   %eax
801042a0:	e8 d2 fe ff ff       	call   80104177 <argint>
801042a5:	83 c4 10             	add    $0x10,%esp
801042a8:	85 c0                	test   %eax,%eax
801042aa:	78 2e                	js     801042da <argfd+0x4b>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
801042ac:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
801042b0:	77 2f                	ja     801042e1 <argfd+0x52>
801042b2:	e8 3f ef ff ff       	call   801031f6 <myproc>
801042b7:	8b 55 f4             	mov    -0xc(%ebp),%edx
801042ba:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
801042be:	85 c0                	test   %eax,%eax
801042c0:	74 26                	je     801042e8 <argfd+0x59>
    return -1;
  if(pfd)
801042c2:	85 f6                	test   %esi,%esi
801042c4:	74 02                	je     801042c8 <argfd+0x39>
    *pfd = fd;
801042c6:	89 16                	mov    %edx,(%esi)
  if(pf)
801042c8:	85 db                	test   %ebx,%ebx
801042ca:	74 23                	je     801042ef <argfd+0x60>
    *pf = f;
801042cc:	89 03                	mov    %eax,(%ebx)
  return 0;
801042ce:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
801042df:	eb f2                	jmp    801042d3 <argfd+0x44>
    return -1;
801042e1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801042e6:	eb eb                	jmp    801042d3 <argfd+0x44>
801042e8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801042ed:	eb e4                	jmp    801042d3 <argfd+0x44>
  return 0;
801042ef:	b8 00 00 00 00       	mov    $0x0,%eax
801042f4:	eb dd                	jmp    801042d3 <argfd+0x44>
...
801042fd:	89 c3                	mov    %eax,%ebx
  int fd;
  struct proc *curproc = myproc();
801042ff:	e8 f2 ee ff ff       	call   801031f6 <myproc>

  for(fd = 0; fd < NOFILE; fd++){
80104304:	ba 00 00 00 00       	mov    $0x0,%edx
80104309:	83 fa 0f             	cmp    $0xf,%edx
8010430c:	7f 18                	jg     80104326 <fdalloc+0x30>
    if(curproc->ofile[fd] == 0){
8010430e:	83 7c 90 28 00       	cmpl   $0x0,0x28(%eax,%edx,4)
80104313:	74 05                	je     8010431a <fdalloc+0x24>
  for(fd = 0; fd < NOFILE; fd++){
80104315:	83 c2 01             	add    $0x1,%edx
80104318:	eb ef                	jmp    80104309 <fdalloc+0x13>
      curproc->ofile[fd] = f;
8010431a:	89 5c 90 28          	mov    %ebx,0x28(%eax,%edx,4)
      return fd;
    }
  }
  return -1;
...
80104320:	83 c4 04             	add    $0x4,%esp
80104323:	5b                   	pop    %ebx
80104324:	5d                   	pop    %ebp
80104325:	c3                   	ret    
  return -1;
80104326:	ba ff ff ff ff       	mov    $0xffffffff,%edx
8010432b:	eb f1                	jmp    8010431e <fdalloc+0x28>
...
80104332:	83 ec 10             	sub    $0x10,%esp
80104335:	89 c3                	mov    %eax,%ebx
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80104337:	b8 20 00 00 00       	mov    $0x20,%eax
8010433c:	89 c6                	mov    %eax,%esi
8010433e:	39 43 58             	cmp    %eax,0x58(%ebx)
80104341:	76 2e                	jbe    80104371 <isdirempty+0x44>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104343:	6a 10                	push   $0x10
80104345:	50                   	push   %eax
80104346:	8d 45 e8             	lea    -0x18(%ebp),%eax
80104349:	50                   	push   %eax
8010434a:	53                   	push   %ebx
8010434b:	e8 23 d4 ff ff       	call   80101773 <readi>
80104350:	83 c4 10             	add    $0x10,%esp
80104353:	83 f8 10             	cmp    $0x10,%eax
80104356:	75 0c                	jne    80104364 <isdirempty+0x37>
      panic("isdirempty: readi");
    if(de.inum != 0)
80104358:	66 83 7d e8 00       	cmpw   $0x0,-0x18(%ebp)
8010435d:	75 1e                	jne    8010437d <isdirempty+0x50>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
8010435f:	8d 46 10             	lea    0x10(%esi),%eax
80104362:	eb d8                	jmp    8010433c <isdirempty+0xf>
      panic("isdirempty: readi");
80104364:	83 ec 0c             	sub    $0xc,%esp
80104367:	68 08 6f 10 80       	push   $0x80106f08
8010436c:	e8 d7 bf ff ff       	call   80100348 <panic>
      return 0;
  }
  return 1;
80104371:	b8 01 00 00 00       	mov    $0x1,%eax
}
...
80104382:	eb f2                	jmp    80104376 <isdirempty+0x49>
...
8010438a:	83 ec 44             	sub    $0x44,%esp
8010438d:	89 55 c4             	mov    %edx,-0x3c(%ebp)
80104390:	89 4d c0             	mov    %ecx,-0x40(%ebp)
80104393:	8b 7d 08             	mov    0x8(%ebp),%edi
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80104396:	8d 55 d6             	lea    -0x2a(%ebp),%edx
80104399:	52                   	push   %edx
8010439a:	50                   	push   %eax
8010439b:	e8 59 d8 ff ff       	call   80101bf9 <nameiparent>
801043a0:	89 c6                	mov    %eax,%esi
801043a2:	83 c4 10             	add    $0x10,%esp
801043a5:	85 c0                	test   %eax,%eax
801043a7:	0f 84 3a 01 00 00    	je     801044e7 <create+0x163>
    return 0;
  ilock(dp);
801043ad:	83 ec 0c             	sub    $0xc,%esp
801043b0:	50                   	push   %eax
801043b1:	e8 cb d1 ff ff       	call   80101581 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
801043b6:	83 c4 0c             	add    $0xc,%esp
801043b9:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801043bc:	50                   	push   %eax
801043bd:	8d 45 d6             	lea    -0x2a(%ebp),%eax
801043c0:	50                   	push   %eax
801043c1:	56                   	push   %esi
801043c2:	e8 e9 d5 ff ff       	call   801019b0 <dirlookup>
801043c7:	89 c3                	mov    %eax,%ebx
801043c9:	83 c4 10             	add    $0x10,%esp
801043cc:	85 c0                	test   %eax,%eax
801043ce:	74 3f                	je     8010440f <create+0x8b>
    iunlockput(dp);
801043d0:	83 ec 0c             	sub    $0xc,%esp
801043d3:	56                   	push   %esi
801043d4:	e8 4f d3 ff ff       	call   80101728 <iunlockput>
    ilock(ip);
801043d9:	89 1c 24             	mov    %ebx,(%esp)
801043dc:	e8 a0 d1 ff ff       	call   80101581 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801043e1:	83 c4 10             	add    $0x10,%esp
801043e4:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
801043e9:	75 11                	jne    801043fc <create+0x78>
801043eb:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
801043f0:	75 0a                	jne    801043fc <create+0x78>
...
801043f4:	8d 65 f4             	lea    -0xc(%ebp),%esp
801043f7:	5b                   	pop    %ebx
801043f8:	5e                   	pop    %esi
801043f9:	5f                   	pop    %edi
801043fa:	5d                   	pop    %ebp
...
80104400:	e8 23 d3 ff ff       	call   80101728 <iunlockput>
    return 0;
80104405:	83 c4 10             	add    $0x10,%esp
80104408:	bb 00 00 00 00       	mov    $0x0,%ebx
8010440d:	eb e3                	jmp    801043f2 <create+0x6e>
  if((ip = ialloc(dp->dev, type)) == 0)
8010440f:	0f bf 45 c4          	movswl -0x3c(%ebp),%eax
80104413:	83 ec 08             	sub    $0x8,%esp
80104416:	50                   	push   %eax
80104417:	ff 36                	pushl  (%esi)
80104419:	e8 60 cf ff ff       	call   8010137e <ialloc>
8010441e:	89 c3                	mov    %eax,%ebx
80104420:	83 c4 10             	add    $0x10,%esp
80104423:	85 c0                	test   %eax,%eax
80104425:	74 55                	je     8010447c <create+0xf8>
  ilock(ip);
80104427:	83 ec 0c             	sub    $0xc,%esp
8010442a:	50                   	push   %eax
8010442b:	e8 51 d1 ff ff       	call   80101581 <ilock>
  ip->major = major;
80104430:	0f b7 45 c0          	movzwl -0x40(%ebp),%eax
80104434:	66 89 43 52          	mov    %ax,0x52(%ebx)
  ip->minor = minor;
80104438:	66 89 7b 54          	mov    %di,0x54(%ebx)
  ip->nlink = 1;
8010443c:	66 c7 43 56 01 00    	movw   $0x1,0x56(%ebx)
  iupdate(ip);
80104442:	89 1c 24             	mov    %ebx,(%esp)
80104445:	e8 d6 cf ff ff       	call   80101420 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
8010444a:	83 c4 10             	add    $0x10,%esp
8010444d:	66 83 7d c4 01       	cmpw   $0x1,-0x3c(%ebp)
80104452:	74 35                	je     80104489 <create+0x105>
  if(dirlink(dp, name, ip->inum) < 0)
80104454:	83 ec 04             	sub    $0x4,%esp
80104457:	ff 73 04             	pushl  0x4(%ebx)
8010445a:	8d 45 d6             	lea    -0x2a(%ebp),%eax
8010445d:	50                   	push   %eax
8010445e:	56                   	push   %esi
8010445f:	e8 cc d6 ff ff       	call   80101b30 <dirlink>
80104464:	83 c4 10             	add    $0x10,%esp
80104467:	85 c0                	test   %eax,%eax
80104469:	78 6f                	js     801044da <create+0x156>
  iunlockput(dp);
8010446b:	83 ec 0c             	sub    $0xc,%esp
8010446e:	56                   	push   %esi
8010446f:	e8 b4 d2 ff ff       	call   80101728 <iunlockput>
  return ip;
80104474:	83 c4 10             	add    $0x10,%esp
80104477:	e9 76 ff ff ff       	jmp    801043f2 <create+0x6e>
    panic("create: ialloc");
8010447c:	83 ec 0c             	sub    $0xc,%esp
8010447f:	68 1a 6f 10 80       	push   $0x80106f1a
80104484:	e8 bf be ff ff       	call   80100348 <panic>
    dp->nlink++;  // for ".."
80104489:	0f b7 46 56          	movzwl 0x56(%esi),%eax
8010448d:	83 c0 01             	add    $0x1,%eax
80104490:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
80104494:	83 ec 0c             	sub    $0xc,%esp
80104497:	56                   	push   %esi
80104498:	e8 83 cf ff ff       	call   80101420 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010449d:	83 c4 0c             	add    $0xc,%esp
801044a0:	ff 73 04             	pushl  0x4(%ebx)
801044a3:	68 2a 6f 10 80       	push   $0x80106f2a
801044a8:	53                   	push   %ebx
801044a9:	e8 82 d6 ff ff       	call   80101b30 <dirlink>
801044ae:	83 c4 10             	add    $0x10,%esp
801044b1:	85 c0                	test   %eax,%eax
801044b3:	78 18                	js     801044cd <create+0x149>
801044b5:	83 ec 04             	sub    $0x4,%esp
801044b8:	ff 76 04             	pushl  0x4(%esi)
801044bb:	68 29 6f 10 80       	push   $0x80106f29
801044c0:	53                   	push   %ebx
801044c1:	e8 6a d6 ff ff       	call   80101b30 <dirlink>
801044c6:	83 c4 10             	add    $0x10,%esp
801044c9:	85 c0                	test   %eax,%eax
801044cb:	79 87                	jns    80104454 <create+0xd0>
      panic("create dots");
801044cd:	83 ec 0c             	sub    $0xc,%esp
801044d0:	68 2c 6f 10 80       	push   $0x80106f2c
801044d5:	e8 6e be ff ff       	call   80100348 <panic>
    panic("create: dirlink");
801044da:	83 ec 0c             	sub    $0xc,%esp
801044dd:	68 38 6f 10 80       	push   $0x80106f38
801044e2:	e8 61 be ff ff       	call   80100348 <panic>
    return 0;
801044e7:	89 c3                	mov    %eax,%ebx
801044e9:	e9 04 ff ff ff       	jmp    801043f2 <create+0x6e>
...
801044f2:	83 ec 14             	sub    $0x14,%esp
  if(argfd(0, 0, &f) < 0)
801044f5:	8d 4d f4             	lea    -0xc(%ebp),%ecx
801044f8:	ba 00 00 00 00       	mov    $0x0,%edx
801044fd:	b8 00 00 00 00       	mov    $0x0,%eax
80104502:	e8 88 fd ff ff       	call   8010428f <argfd>
80104507:	85 c0                	test   %eax,%eax
80104509:	78 23                	js     8010452e <sys_dup+0x40>
  if((fd=fdalloc(f)) < 0)
8010450b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010450e:	e8 e3 fd ff ff       	call   801042f6 <fdalloc>
80104513:	89 c3                	mov    %eax,%ebx
80104515:	85 c0                	test   %eax,%eax
80104517:	78 1c                	js     80104535 <sys_dup+0x47>
  filedup(f);
80104519:	83 ec 0c             	sub    $0xc,%esp
8010451c:	ff 75 f4             	pushl  -0xc(%ebp)
8010451f:	e8 6a c7 ff ff       	call   80100c8e <filedup>
  return fd;
80104524:	83 c4 10             	add    $0x10,%esp
}
80104527:	89 d8                	mov    %ebx,%eax
80104529:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010452c:	c9                   	leave  
8010452d:	c3                   	ret    
    return -1;
8010452e:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104533:	eb f2                	jmp    80104527 <sys_dup+0x39>
    return -1;
80104535:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
8010453a:	eb eb                	jmp    80104527 <sys_dup+0x39>
...
80104542:	8d 4d f4             	lea    -0xc(%ebp),%ecx
80104545:	ba 00 00 00 00       	mov    $0x0,%edx
8010454a:	b8 00 00 00 00       	mov    $0x0,%eax
8010454f:	e8 3b fd ff ff       	call   8010428f <argfd>
80104554:	85 c0                	test   %eax,%eax
80104556:	78 43                	js     8010459b <sys_read+0x5f>
80104558:	83 ec 08             	sub    $0x8,%esp
8010455b:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010455e:	50                   	push   %eax
8010455f:	6a 02                	push   $0x2
80104561:	e8 11 fc ff ff       	call   80104177 <argint>
80104566:	83 c4 10             	add    $0x10,%esp
80104569:	85 c0                	test   %eax,%eax
8010456b:	78 35                	js     801045a2 <sys_read+0x66>
8010456d:	83 ec 04             	sub    $0x4,%esp
80104570:	ff 75 f0             	pushl  -0x10(%ebp)
80104573:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104576:	50                   	push   %eax
80104577:	6a 01                	push   $0x1
80104579:	e8 21 fc ff ff       	call   8010419f <argptr>
8010457e:	83 c4 10             	add    $0x10,%esp
80104581:	85 c0                	test   %eax,%eax
80104583:	78 24                	js     801045a9 <sys_read+0x6d>
  return fileread(f, p, n);
80104585:	83 ec 04             	sub    $0x4,%esp
80104588:	ff 75 f0             	pushl  -0x10(%ebp)
8010458b:	ff 75 ec             	pushl  -0x14(%ebp)
8010458e:	ff 75 f4             	pushl  -0xc(%ebp)
80104591:	e8 41 c8 ff ff       	call   80100dd7 <fileread>
...
801045a0:	eb f7                	jmp    80104599 <sys_read+0x5d>
801045a2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045a7:	eb f0                	jmp    80104599 <sys_read+0x5d>
801045a9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045ae:	eb e9                	jmp    80104599 <sys_read+0x5d>
...
801045ed:	e8 ad fb ff ff       	call   8010419f <argptr>
801045f2:	83 c4 10             	add    $0x10,%esp
801045f5:	85 c0                	test   %eax,%eax
801045f7:	78 24                	js     8010461d <sys_write+0x6d>
...
80104605:	e8 52 c8 ff ff       	call   80100e5c <filewrite>
...
80104614:	eb f7                	jmp    8010460d <sys_write+0x5d>
80104616:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010461b:	eb f0                	jmp    8010460d <sys_write+0x5d>
8010461d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104622:	eb e9                	jmp    8010460d <sys_write+0x5d>

80104624 <sys_close>:
{
80104624:	55                   	push   %ebp
80104625:	89 e5                	mov    %esp,%ebp
80104627:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
8010462a:	8d 4d f0             	lea    -0x10(%ebp),%ecx
8010462d:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104630:	b8 00 00 00 00       	mov    $0x0,%eax
80104635:	e8 55 fc ff ff       	call   8010428f <argfd>
8010463a:	85 c0                	test   %eax,%eax
8010463c:	78 25                	js     80104663 <sys_close+0x3f>
  myproc()->ofile[fd] = 0;
8010463e:	e8 b3 eb ff ff       	call   801031f6 <myproc>
80104643:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104646:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
8010464d:	00 
  fileclose(f);
8010464e:	83 ec 0c             	sub    $0xc,%esp
80104651:	ff 75 f0             	pushl  -0x10(%ebp)
80104654:	e8 7a c6 ff ff       	call   80100cd3 <fileclose>
  return 0;
...
80104668:	eb f7                	jmp    80104661 <sys_close+0x3d>
...
80104670:	8d 4d f4             	lea    -0xc(%ebp),%ecx
80104673:	ba 00 00 00 00       	mov    $0x0,%edx
80104678:	b8 00 00 00 00       	mov    $0x0,%eax
8010467d:	e8 0d fc ff ff       	call   8010428f <argfd>
80104682:	85 c0                	test   %eax,%eax
80104684:	78 2a                	js     801046b0 <sys_fstat+0x46>
80104686:	83 ec 04             	sub    $0x4,%esp
80104689:	6a 14                	push   $0x14
8010468b:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010468e:	50                   	push   %eax
8010468f:	6a 01                	push   $0x1
80104691:	e8 09 fb ff ff       	call   8010419f <argptr>
80104696:	83 c4 10             	add    $0x10,%esp
80104699:	85 c0                	test   %eax,%eax
8010469b:	78 1a                	js     801046b7 <sys_fstat+0x4d>
  return filestat(f, st);
8010469d:	83 ec 08             	sub    $0x8,%esp
801046a0:	ff 75 f0             	pushl  -0x10(%ebp)
801046a3:	ff 75 f4             	pushl  -0xc(%ebp)
801046a6:	e8 e5 c6 ff ff       	call   80100d90 <filestat>
...
801046b5:	eb f7                	jmp    801046ae <sys_fstat+0x44>
801046b7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801046bc:	eb f0                	jmp    801046ae <sys_fstat+0x44>
...
801046c6:	8d 45 e0             	lea    -0x20(%ebp),%eax
801046c9:	50                   	push   %eax
801046ca:	6a 00                	push   $0x0
801046cc:	e8 36 fb ff ff       	call   80104207 <argstr>
801046d1:	83 c4 10             	add    $0x10,%esp
801046d4:	85 c0                	test   %eax,%eax
801046d6:	0f 88 32 01 00 00    	js     8010480e <sys_link+0x150>
801046dc:	83 ec 08             	sub    $0x8,%esp
801046df:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801046e2:	50                   	push   %eax
801046e3:	6a 01                	push   $0x1
801046e5:	e8 1d fb ff ff       	call   80104207 <argstr>
801046ea:	83 c4 10             	add    $0x10,%esp
801046ed:	85 c0                	test   %eax,%eax
801046ef:	0f 88 20 01 00 00    	js     80104815 <sys_link+0x157>
  begin_op();
801046f5:	e8 b4 e0 ff ff       	call   801027ae <begin_op>
  if((ip = namei(old)) == 0){
801046fa:	83 ec 0c             	sub    $0xc,%esp
801046fd:	ff 75 e0             	pushl  -0x20(%ebp)
80104700:	e8 dc d4 ff ff       	call   80101be1 <namei>
80104705:	89 c3                	mov    %eax,%ebx
80104707:	83 c4 10             	add    $0x10,%esp
8010470a:	85 c0                	test   %eax,%eax
8010470c:	0f 84 99 00 00 00    	je     801047ab <sys_link+0xed>
  ilock(ip);
80104712:	83 ec 0c             	sub    $0xc,%esp
80104715:	50                   	push   %eax
80104716:	e8 66 ce ff ff       	call   80101581 <ilock>
  if(ip->type == T_DIR){
8010471b:	83 c4 10             	add    $0x10,%esp
8010471e:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104723:	0f 84 8e 00 00 00    	je     801047b7 <sys_link+0xf9>
  ip->nlink++;
80104729:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
8010472d:	83 c0 01             	add    $0x1,%eax
80104730:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
80104734:	83 ec 0c             	sub    $0xc,%esp
80104737:	53                   	push   %ebx
80104738:	e8 e3 cc ff ff       	call   80101420 <iupdate>
  iunlock(ip);
8010473d:	89 1c 24             	mov    %ebx,(%esp)
80104740:	e8 fe ce ff ff       	call   80101643 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104745:	83 c4 08             	add    $0x8,%esp
80104748:	8d 45 ea             	lea    -0x16(%ebp),%eax
8010474b:	50                   	push   %eax
8010474c:	ff 75 e4             	pushl  -0x1c(%ebp)
8010474f:	e8 a5 d4 ff ff       	call   80101bf9 <nameiparent>
80104754:	89 c6                	mov    %eax,%esi
80104756:	83 c4 10             	add    $0x10,%esp
80104759:	85 c0                	test   %eax,%eax
8010475b:	74 7e                	je     801047db <sys_link+0x11d>
  ilock(dp);
8010475d:	83 ec 0c             	sub    $0xc,%esp
80104760:	50                   	push   %eax
80104761:	e8 1b ce ff ff       	call   80101581 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80104766:	83 c4 10             	add    $0x10,%esp
80104769:	8b 03                	mov    (%ebx),%eax
8010476b:	39 06                	cmp    %eax,(%esi)
8010476d:	75 60                	jne    801047cf <sys_link+0x111>
8010476f:	83 ec 04             	sub    $0x4,%esp
80104772:	ff 73 04             	pushl  0x4(%ebx)
80104775:	8d 45 ea             	lea    -0x16(%ebp),%eax
80104778:	50                   	push   %eax
80104779:	56                   	push   %esi
8010477a:	e8 b1 d3 ff ff       	call   80101b30 <dirlink>
8010477f:	83 c4 10             	add    $0x10,%esp
80104782:	85 c0                	test   %eax,%eax
80104784:	78 49                	js     801047cf <sys_link+0x111>
  iunlockput(dp);
80104786:	83 ec 0c             	sub    $0xc,%esp
80104789:	56                   	push   %esi
8010478a:	e8 99 cf ff ff       	call   80101728 <iunlockput>
  iput(ip);
8010478f:	89 1c 24             	mov    %ebx,(%esp)
80104792:	e8 f1 ce ff ff       	call   80101688 <iput>
  end_op();
80104797:	e8 8c e0 ff ff       	call   80102828 <end_op>
  return 0;
8010479c:	83 c4 10             	add    $0x10,%esp
8010479f:	b8 00 00 00 00       	mov    $0x0,%eax
}
801047a4:	8d 65 f8             	lea    -0x8(%ebp),%esp
801047a7:	5b                   	pop    %ebx
801047a8:	5e                   	pop    %esi
801047a9:	5d                   	pop    %ebp
801047aa:	c3                   	ret    
    end_op();
801047ab:	e8 78 e0 ff ff       	call   80102828 <end_op>
    return -1;
801047b0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801047b5:	eb ed                	jmp    801047a4 <sys_link+0xe6>
    iunlockput(ip);
801047b7:	83 ec 0c             	sub    $0xc,%esp
801047ba:	53                   	push   %ebx
801047bb:	e8 68 cf ff ff       	call   80101728 <iunlockput>
    end_op();
801047c0:	e8 63 e0 ff ff       	call   80102828 <end_op>
    return -1;
801047c5:	83 c4 10             	add    $0x10,%esp
801047c8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801047cd:	eb d5                	jmp    801047a4 <sys_link+0xe6>
    iunlockput(dp);
801047cf:	83 ec 0c             	sub    $0xc,%esp
801047d2:	56                   	push   %esi
801047d3:	e8 50 cf ff ff       	call   80101728 <iunlockput>
    goto bad;
...
801047df:	e8 9d cd ff ff       	call   80101581 <ilock>
  ip->nlink--;
801047e4:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
801047e8:	83 e8 01             	sub    $0x1,%eax
801047eb:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
801047ef:	89 1c 24             	mov    %ebx,(%esp)
801047f2:	e8 29 cc ff ff       	call   80101420 <iupdate>
  iunlockput(ip);
801047f7:	89 1c 24             	mov    %ebx,(%esp)
801047fa:	e8 29 cf ff ff       	call   80101728 <iunlockput>
  end_op();
801047ff:	e8 24 e0 ff ff       	call   80102828 <end_op>
  return -1;
80104804:	83 c4 10             	add    $0x10,%esp
80104807:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010480c:	eb 96                	jmp    801047a4 <sys_link+0xe6>
    return -1;
8010480e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104813:	eb 8f                	jmp    801047a4 <sys_link+0xe6>
80104815:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010481a:	eb 88                	jmp    801047a4 <sys_link+0xe6>
...
80104822:	83 ec 44             	sub    $0x44,%esp
  if(argstr(0, &path) < 0)
80104825:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80104828:	50                   	push   %eax
80104829:	6a 00                	push   $0x0
8010482b:	e8 d7 f9 ff ff       	call   80104207 <argstr>
80104830:	83 c4 10             	add    $0x10,%esp
80104833:	85 c0                	test   %eax,%eax
80104835:	0f 88 83 01 00 00    	js     801049be <sys_unlink+0x1a2>
  begin_op();
...
80104847:	ff 75 c4             	pushl  -0x3c(%ebp)
8010484a:	e8 aa d3 ff ff       	call   80101bf9 <nameiparent>
8010484f:	89 c6                	mov    %eax,%esi
80104851:	83 c4 10             	add    $0x10,%esp
80104854:	85 c0                	test   %eax,%eax
80104856:	0f 84 ed 00 00 00    	je     80104949 <sys_unlink+0x12d>
  ilock(dp);
8010485c:	83 ec 0c             	sub    $0xc,%esp
8010485f:	50                   	push   %eax
80104860:	e8 1c cd ff ff       	call   80101581 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104865:	83 c4 08             	add    $0x8,%esp
80104868:	68 2a 6f 10 80       	push   $0x80106f2a
8010486d:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104870:	50                   	push   %eax
80104871:	e8 25 d1 ff ff       	call   8010199b <namecmp>
80104876:	83 c4 10             	add    $0x10,%esp
80104879:	85 c0                	test   %eax,%eax
8010487b:	0f 84 fc 00 00 00    	je     8010497d <sys_unlink+0x161>
80104881:	83 ec 08             	sub    $0x8,%esp
80104884:	68 29 6f 10 80       	push   $0x80106f29
80104889:	8d 45 ca             	lea    -0x36(%ebp),%eax
8010488c:	50                   	push   %eax
8010488d:	e8 09 d1 ff ff       	call   8010199b <namecmp>
80104892:	83 c4 10             	add    $0x10,%esp
80104895:	85 c0                	test   %eax,%eax
80104897:	0f 84 e0 00 00 00    	je     8010497d <sys_unlink+0x161>
  if((ip = dirlookup(dp, name, &off)) == 0)
8010489d:	83 ec 04             	sub    $0x4,%esp
801048a0:	8d 45 c0             	lea    -0x40(%ebp),%eax
801048a3:	50                   	push   %eax
801048a4:	8d 45 ca             	lea    -0x36(%ebp),%eax
...
801048b5:	0f 84 c2 00 00 00    	je     8010497d <sys_unlink+0x161>
  ilock(ip);
801048bb:	83 ec 0c             	sub    $0xc,%esp
801048be:	50                   	push   %eax
801048bf:	e8 bd cc ff ff       	call   80101581 <ilock>
  if(ip->nlink < 1)
801048c4:	83 c4 10             	add    $0x10,%esp
801048c7:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
801048cc:	0f 8e 83 00 00 00    	jle    80104955 <sys_unlink+0x139>
  if(ip->type == T_DIR && !isdirempty(ip)){
801048d2:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801048d7:	0f 84 85 00 00 00    	je     80104962 <sys_unlink+0x146>
  memset(&de, 0, sizeof(de));
801048dd:	83 ec 04             	sub    $0x4,%esp
801048e0:	6a 10                	push   $0x10
801048e2:	6a 00                	push   $0x0
801048e4:	8d 7d d8             	lea    -0x28(%ebp),%edi
801048e7:	57                   	push   %edi
801048e8:	e8 3f f6 ff ff       	call   80103f2c <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801048ed:	6a 10                	push   $0x10
801048ef:	ff 75 c0             	pushl  -0x40(%ebp)
801048f2:	57                   	push   %edi
801048f3:	56                   	push   %esi
801048f4:	e8 77 cf ff ff       	call   80101870 <writei>
801048f9:	83 c4 20             	add    $0x20,%esp
801048fc:	83 f8 10             	cmp    $0x10,%eax
801048ff:	0f 85 90 00 00 00    	jne    80104995 <sys_unlink+0x179>
  if(ip->type == T_DIR){
80104905:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010490a:	0f 84 92 00 00 00    	je     801049a2 <sys_unlink+0x186>
  iunlockput(dp);
80104910:	83 ec 0c             	sub    $0xc,%esp
80104913:	56                   	push   %esi
80104914:	e8 0f ce ff ff       	call   80101728 <iunlockput>
  ip->nlink--;
80104919:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
8010491d:	83 e8 01             	sub    $0x1,%eax
80104920:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
80104924:	89 1c 24             	mov    %ebx,(%esp)
80104927:	e8 f4 ca ff ff       	call   80101420 <iupdate>
  iunlockput(ip);
8010492c:	89 1c 24             	mov    %ebx,(%esp)
8010492f:	e8 f4 cd ff ff       	call   80101728 <iunlockput>
  end_op();
80104934:	e8 ef de ff ff       	call   80102828 <end_op>
  return 0;
80104939:	83 c4 10             	add    $0x10,%esp
8010493c:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104941:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104944:	5b                   	pop    %ebx
80104945:	5e                   	pop    %esi
80104946:	5f                   	pop    %edi
80104947:	5d                   	pop    %ebp
80104948:	c3                   	ret    
    end_op();
80104949:	e8 da de ff ff       	call   80102828 <end_op>
    return -1;
8010494e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104953:	eb ec                	jmp    80104941 <sys_unlink+0x125>
    panic("unlink: nlink < 1");
80104955:	83 ec 0c             	sub    $0xc,%esp
80104958:	68 48 6f 10 80       	push   $0x80106f48
8010495d:	e8 e6 b9 ff ff       	call   80100348 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104962:	89 d8                	mov    %ebx,%eax
80104964:	e8 c4 f9 ff ff       	call   8010432d <isdirempty>
80104969:	85 c0                	test   %eax,%eax
8010496b:	0f 85 6c ff ff ff    	jne    801048dd <sys_unlink+0xc1>
    iunlockput(ip);
80104971:	83 ec 0c             	sub    $0xc,%esp
80104974:	53                   	push   %ebx
80104975:	e8 ae cd ff ff       	call   80101728 <iunlockput>
    goto bad;
...
80104993:	eb ac                	jmp    80104941 <sys_unlink+0x125>
    panic("unlink: writei");
80104995:	83 ec 0c             	sub    $0xc,%esp
80104998:	68 5a 6f 10 80       	push   $0x80106f5a
8010499d:	e8 a6 b9 ff ff       	call   80100348 <panic>
    dp->nlink--;
801049a2:	0f b7 46 56          	movzwl 0x56(%esi),%eax
801049a6:	83 e8 01             	sub    $0x1,%eax
801049a9:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
801049ad:	83 ec 0c             	sub    $0xc,%esp
801049b0:	56                   	push   %esi
801049b1:	e8 6a ca ff ff       	call   80101420 <iupdate>
801049b6:	83 c4 10             	add    $0x10,%esp
801049b9:	e9 52 ff ff ff       	jmp    80104910 <sys_unlink+0xf4>
    return -1;
801049be:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801049c3:	e9 79 ff ff ff       	jmp    80104941 <sys_unlink+0x125>
...
801049ce:	83 ec 24             	sub    $0x24,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
801049d1:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801049d4:	50                   	push   %eax
801049d5:	6a 00                	push   $0x0
801049d7:	e8 2b f8 ff ff       	call   80104207 <argstr>
801049dc:	83 c4 10             	add    $0x10,%esp
801049df:	85 c0                	test   %eax,%eax
801049e1:	0f 88 30 01 00 00    	js     80104b17 <sys_open+0x14f>
801049e7:	83 ec 08             	sub    $0x8,%esp
801049ea:	8d 45 e0             	lea    -0x20(%ebp),%eax
801049ed:	50                   	push   %eax
801049ee:	6a 01                	push   $0x1
801049f0:	e8 82 f7 ff ff       	call   80104177 <argint>
801049f5:	83 c4 10             	add    $0x10,%esp
801049f8:	85 c0                	test   %eax,%eax
801049fa:	0f 88 21 01 00 00    	js     80104b21 <sys_open+0x159>
    return -1;

  begin_op();
80104a00:	e8 a9 dd ff ff       	call   801027ae <begin_op>

  if(omode & O_CREATE){
80104a05:	f6 45 e1 02          	testb  $0x2,-0x1f(%ebp)
80104a09:	0f 84 84 00 00 00    	je     80104a93 <sys_open+0xcb>
    ip = create(path, T_FILE, 0, 0);
80104a0f:	83 ec 0c             	sub    $0xc,%esp
80104a12:	6a 00                	push   $0x0
80104a14:	b9 00 00 00 00       	mov    $0x0,%ecx
80104a19:	ba 02 00 00 00       	mov    $0x2,%edx
80104a1e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104a21:	e8 5e f9 ff ff       	call   80104384 <create>
80104a26:	89 c6                	mov    %eax,%esi
    if(ip == 0){
80104a28:	83 c4 10             	add    $0x10,%esp
80104a2b:	85 c0                	test   %eax,%eax
80104a2d:	74 58                	je     80104a87 <sys_open+0xbf>
      end_op();
      return -1;
    }
  }
...
80104a2f:	e8 f9 c1 ff ff       	call   80100c2d <filealloc>
80104a34:	89 c3                	mov    %eax,%ebx
80104a36:	85 c0                	test   %eax,%eax
80104a38:	0f 84 ae 00 00 00    	je     80104aec <sys_open+0x124>
80104a3e:	e8 b3 f8 ff ff       	call   801042f6 <fdalloc>
80104a43:	89 c7                	mov    %eax,%edi
80104a45:	85 c0                	test   %eax,%eax
80104a47:	0f 88 9f 00 00 00    	js     80104aec <sys_open+0x124>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
80104a51:	e8 ed cb ff ff       	call   80101643 <iunlock>
  end_op();
80104a56:	e8 cd dd ff ff       	call   80102828 <end_op>

  f->type = FD_INODE;
80104a5b:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
80104a61:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
80104a64:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
80104a6b:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104a6e:	83 c4 10             	add    $0x10,%esp
80104a71:	a8 01                	test   $0x1,%al
80104a73:	0f 94 43 08          	sete   0x8(%ebx)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80104a77:	a8 03                	test   $0x3,%al
80104a79:	0f 95 43 09          	setne  0x9(%ebx)
  return fd;
}
80104a7d:	89 f8                	mov    %edi,%eax
80104a7f:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104a82:	5b                   	pop    %ebx
80104a83:	5e                   	pop    %esi
80104a84:	5f                   	pop    %edi
80104a85:	5d                   	pop    %ebp
80104a86:	c3                   	ret    
      end_op();
80104a87:	e8 9c dd ff ff       	call   80102828 <end_op>
      return -1;
80104a8c:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104a91:	eb ea                	jmp    80104a7d <sys_open+0xb5>
    if((ip = namei(path)) == 0){
80104a93:	83 ec 0c             	sub    $0xc,%esp
80104a96:	ff 75 e4             	pushl  -0x1c(%ebp)
80104a99:	e8 43 d1 ff ff       	call   80101be1 <namei>
80104a9e:	89 c6                	mov    %eax,%esi
80104aa0:	83 c4 10             	add    $0x10,%esp
80104aa3:	85 c0                	test   %eax,%eax
80104aa5:	74 39                	je     80104ae0 <sys_open+0x118>
    ilock(ip);
80104aa7:	83 ec 0c             	sub    $0xc,%esp
80104aaa:	50                   	push   %eax
80104aab:	e8 d1 ca ff ff       	call   80101581 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80104ab0:	83 c4 10             	add    $0x10,%esp
80104ab3:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80104ab8:	0f 85 71 ff ff ff    	jne    80104a2f <sys_open+0x67>
80104abe:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104ac2:	0f 84 67 ff ff ff    	je     80104a2f <sys_open+0x67>
      iunlockput(ip);
80104ac8:	83 ec 0c             	sub    $0xc,%esp
80104acb:	56                   	push   %esi
80104acc:	e8 57 cc ff ff       	call   80101728 <iunlockput>
      end_op();
80104ad1:	e8 52 dd ff ff       	call   80102828 <end_op>
      return -1;
80104ad6:	83 c4 10             	add    $0x10,%esp
80104ad9:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104ade:	eb 9d                	jmp    80104a7d <sys_open+0xb5>
      end_op();
80104ae0:	e8 43 dd ff ff       	call   80102828 <end_op>
      return -1;
80104ae5:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104aea:	eb 91                	jmp    80104a7d <sys_open+0xb5>
    if(f)
80104aec:	85 db                	test   %ebx,%ebx
80104aee:	74 0c                	je     80104afc <sys_open+0x134>
      fileclose(f);
80104af0:	83 ec 0c             	sub    $0xc,%esp
80104af3:	53                   	push   %ebx
80104af4:	e8 da c1 ff ff       	call   80100cd3 <fileclose>
80104af9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
80104afc:	83 ec 0c             	sub    $0xc,%esp
80104aff:	56                   	push   %esi
80104b00:	e8 23 cc ff ff       	call   80101728 <iunlockput>
    end_op();
80104b05:	e8 1e dd ff ff       	call   80102828 <end_op>
    return -1;
80104b0a:	83 c4 10             	add    $0x10,%esp
80104b0d:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104b12:	e9 66 ff ff ff       	jmp    80104a7d <sys_open+0xb5>
    return -1;
80104b17:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104b1c:	e9 5c ff ff ff       	jmp    80104a7d <sys_open+0xb5>
80104b21:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104b26:	e9 52 ff ff ff       	jmp    80104a7d <sys_open+0xb5>
...
80104b2e:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80104b31:	e8 78 dc ff ff       	call   801027ae <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
80104b36:	83 ec 08             	sub    $0x8,%esp
80104b39:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104b3c:	50                   	push   %eax
80104b3d:	6a 00                	push   $0x0
80104b3f:	e8 c3 f6 ff ff       	call   80104207 <argstr>
80104b44:	83 c4 10             	add    $0x10,%esp
80104b47:	85 c0                	test   %eax,%eax
80104b49:	78 36                	js     80104b81 <sys_mkdir+0x56>
80104b4b:	83 ec 0c             	sub    $0xc,%esp
80104b4e:	6a 00                	push   $0x0
80104b50:	b9 00 00 00 00       	mov    $0x0,%ecx
80104b55:	ba 01 00 00 00       	mov    $0x1,%edx
80104b5a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b5d:	e8 22 f8 ff ff       	call   80104384 <create>
80104b62:	83 c4 10             	add    $0x10,%esp
80104b65:	85 c0                	test   %eax,%eax
80104b67:	74 18                	je     80104b81 <sys_mkdir+0x56>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80104b80:	c3                   	ret    
    end_op();
80104b81:	e8 a2 dc ff ff       	call   80102828 <end_op>
    return -1;
80104b86:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b8b:	eb f2                	jmp    80104b7f <sys_mkdir+0x54>
...
80104b90:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80104b93:	e8 16 dc ff ff       	call   801027ae <begin_op>
  if((argstr(0, &path)) < 0 ||
80104b98:	83 ec 08             	sub    $0x8,%esp
80104b9b:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104b9e:	50                   	push   %eax
80104b9f:	6a 00                	push   $0x0
80104ba1:	e8 61 f6 ff ff       	call   80104207 <argstr>
80104ba6:	83 c4 10             	add    $0x10,%esp
80104ba9:	85 c0                	test   %eax,%eax
80104bab:	78 62                	js     80104c0f <sys_mknod+0x82>
     argint(1, &major) < 0 ||
80104bad:	83 ec 08             	sub    $0x8,%esp
80104bb0:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104bb3:	50                   	push   %eax
80104bb4:	6a 01                	push   $0x1
80104bb6:	e8 bc f5 ff ff       	call   80104177 <argint>
  if((argstr(0, &path)) < 0 ||
80104bbb:	83 c4 10             	add    $0x10,%esp
80104bbe:	85 c0                	test   %eax,%eax
80104bc0:	78 4d                	js     80104c0f <sys_mknod+0x82>
     argint(2, &minor) < 0 ||
80104bc2:	83 ec 08             	sub    $0x8,%esp
80104bc5:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104bc8:	50                   	push   %eax
80104bc9:	6a 02                	push   $0x2
80104bcb:	e8 a7 f5 ff ff       	call   80104177 <argint>
     argint(1, &major) < 0 ||
80104bd0:	83 c4 10             	add    $0x10,%esp
80104bd3:	85 c0                	test   %eax,%eax
80104bd5:	78 38                	js     80104c0f <sys_mknod+0x82>
     (ip = create(path, T_DEV, major, minor)) == 0){
80104bd7:	0f bf 45 ec          	movswl -0x14(%ebp),%eax
80104bdb:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
     argint(2, &minor) < 0 ||
80104bdf:	83 ec 0c             	sub    $0xc,%esp
80104be2:	50                   	push   %eax
80104be3:	ba 03 00 00 00       	mov    $0x3,%edx
80104be8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104beb:	e8 94 f7 ff ff       	call   80104384 <create>
80104bf0:	83 c4 10             	add    $0x10,%esp
80104bf3:	85 c0                	test   %eax,%eax
80104bf5:	74 18                	je     80104c0f <sys_mknod+0x82>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80104bfb:	e8 28 cb ff ff       	call   80101728 <iunlockput>
  end_op();
80104c00:	e8 23 dc ff ff       	call   80102828 <end_op>
  return 0;
...
80104c0e:	c3                   	ret    
    end_op();
80104c0f:	e8 14 dc ff ff       	call   80102828 <end_op>
    return -1;
80104c14:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c19:	eb f2                	jmp    80104c0d <sys_mknod+0x80>
...
80104c5c:	e8 20 c9 ff ff       	call   80101581 <ilock>
  if(ip->type != T_DIR){
80104c61:	83 c4 10             	add    $0x10,%esp
80104c64:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104c69:	75 37                	jne    80104ca2 <sys_chdir+0x87>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
80104c6f:	e8 cf c9 ff ff       	call   80101643 <iunlock>
  iput(curproc->cwd);
80104c74:	83 c4 04             	add    $0x4,%esp
80104c77:	ff 76 68             	pushl  0x68(%esi)
80104c7a:	e8 09 ca ff ff       	call   80101688 <iput>
  end_op();
80104c7f:	e8 a4 db ff ff       	call   80102828 <end_op>
  curproc->cwd = ip;
80104c84:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
80104c87:	83 c4 10             	add    $0x10,%esp
80104c8a:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
80104c95:	c3                   	ret    
    end_op();
80104c96:	e8 8d db ff ff       	call   80102828 <end_op>
    return -1;
80104c9b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104ca0:	eb ed                	jmp    80104c8f <sys_chdir+0x74>
    iunlockput(ip);
80104ca2:	83 ec 0c             	sub    $0xc,%esp
80104ca5:	53                   	push   %ebx
80104ca6:	e8 7d ca ff ff       	call   80101728 <iunlockput>
    end_op();
80104cab:	e8 78 db ff ff       	call   80102828 <end_op>
    return -1;
80104cb0:	83 c4 10             	add    $0x10,%esp
80104cb3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104cb8:	eb d5                	jmp    80104c8f <sys_chdir+0x74>
...
80104cbe:	81 ec 9c 00 00 00    	sub    $0x9c,%esp
...
80104cca:	e8 38 f5 ff ff       	call   80104207 <argstr>
80104ccf:	83 c4 10             	add    $0x10,%esp
80104cd2:	85 c0                	test   %eax,%eax
80104cd4:	0f 88 a8 00 00 00    	js     80104d82 <sys_exec+0xc8>
80104cda:	83 ec 08             	sub    $0x8,%esp
80104cdd:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80104ce3:	50                   	push   %eax
80104ce4:	6a 01                	push   $0x1
80104ce6:	e8 8c f4 ff ff       	call   80104177 <argint>
80104ceb:	83 c4 10             	add    $0x10,%esp
80104cee:	85 c0                	test   %eax,%eax
80104cf0:	0f 88 93 00 00 00    	js     80104d89 <sys_exec+0xcf>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80104cf6:	83 ec 04             	sub    $0x4,%esp
80104cf9:	68 80 00 00 00       	push   $0x80
80104cfe:	6a 00                	push   $0x0
80104d00:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104d06:	50                   	push   %eax
80104d07:	e8 20 f2 ff ff       	call   80103f2c <memset>
80104d0c:	83 c4 10             	add    $0x10,%esp
  for(i=0;; i++){
80104d0f:	bb 00 00 00 00       	mov    $0x0,%ebx
    if(i >= NELEM(argv))
80104d14:	83 fb 1f             	cmp    $0x1f,%ebx
80104d17:	77 77                	ja     80104d90 <sys_exec+0xd6>
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80104d19:	83 ec 08             	sub    $0x8,%esp
80104d1c:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80104d22:	50                   	push   %eax
80104d23:	8b 85 70 ff ff ff    	mov    -0x90(%ebp),%eax
80104d29:	8d 04 98             	lea    (%eax,%ebx,4),%eax
80104d2c:	50                   	push   %eax
80104d2d:	e8 c9 f3 ff ff       	call   801040fb <fetchint>
80104d32:	83 c4 10             	add    $0x10,%esp
80104d35:	85 c0                	test   %eax,%eax
80104d37:	78 5e                	js     80104d97 <sys_exec+0xdd>
      return -1;
    if(uarg == 0){
80104d39:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80104d3f:	85 c0                	test   %eax,%eax
80104d41:	74 1d                	je     80104d60 <sys_exec+0xa6>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80104d43:	83 ec 08             	sub    $0x8,%esp
80104d46:	8d 94 9d 74 ff ff ff 	lea    -0x8c(%ebp,%ebx,4),%edx
80104d4d:	52                   	push   %edx
80104d4e:	50                   	push   %eax
80104d4f:	e8 e3 f3 ff ff       	call   80104137 <fetchstr>
80104d54:	83 c4 10             	add    $0x10,%esp
80104d57:	85 c0                	test   %eax,%eax
80104d59:	78 46                	js     80104da1 <sys_exec+0xe7>
  for(i=0;; i++){
80104d5b:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80104d5e:	eb b4                	jmp    80104d14 <sys_exec+0x5a>
      argv[i] = 0;
80104d60:	c7 84 9d 74 ff ff ff 	movl   $0x0,-0x8c(%ebp,%ebx,4)
80104d67:	00 00 00 00 
      return -1;
  }
  return exec(path, argv);
80104d6b:	83 ec 08             	sub    $0x8,%esp
80104d6e:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104d74:	50                   	push   %eax
80104d75:	ff 75 f4             	pushl  -0xc(%ebp)
80104d78:	e8 55 bb ff ff       	call   801008d2 <exec>
80104d7d:	83 c4 10             	add    $0x10,%esp
80104d80:	eb 1a                	jmp    80104d9c <sys_exec+0xe2>
    return -1;
80104d82:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d87:	eb 13                	jmp    80104d9c <sys_exec+0xe2>
80104d89:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d8e:	eb 0c                	jmp    80104d9c <sys_exec+0xe2>
      return -1;
80104d90:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d95:	eb 05                	jmp    80104d9c <sys_exec+0xe2>
      return -1;
...
80104da6:	eb f4                	jmp    80104d9c <sys_exec+0xe2>
...
80104daf:	6a 08                	push   $0x8
80104db1:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104db4:	50                   	push   %eax
80104db5:	6a 00                	push   $0x0
80104db7:	e8 e3 f3 ff ff       	call   8010419f <argptr>
80104dbc:	83 c4 10             	add    $0x10,%esp
80104dbf:	85 c0                	test   %eax,%eax
80104dc1:	78 77                	js     80104e3a <sys_pipe+0x92>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
80104dc3:	83 ec 08             	sub    $0x8,%esp
80104dc6:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104dc9:	50                   	push   %eax
80104dca:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104dcd:	50                   	push   %eax
80104dce:	e8 62 df ff ff       	call   80102d35 <pipealloc>
80104dd3:	83 c4 10             	add    $0x10,%esp
80104dd6:	85 c0                	test   %eax,%eax
80104dd8:	78 67                	js     80104e41 <sys_pipe+0x99>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80104dda:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ddd:	e8 14 f5 ff ff       	call   801042f6 <fdalloc>
80104de2:	89 c3                	mov    %eax,%ebx
80104de4:	85 c0                	test   %eax,%eax
80104de6:	78 21                	js     80104e09 <sys_pipe+0x61>
80104de8:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104deb:	e8 06 f5 ff ff       	call   801042f6 <fdalloc>
80104df0:	85 c0                	test   %eax,%eax
80104df2:	78 15                	js     80104e09 <sys_pipe+0x61>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
80104df7:	89 1a                	mov    %ebx,(%edx)
  fd[1] = fd1;
80104df9:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104dfc:	89 42 04             	mov    %eax,0x4(%edx)
  return 0;
80104dff:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104e04:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104e07:	c9                   	leave  
80104e08:	c3                   	ret    
    if(fd0 >= 0)
80104e09:	85 db                	test   %ebx,%ebx
80104e0b:	78 0d                	js     80104e1a <sys_pipe+0x72>
      myproc()->ofile[fd0] = 0;
80104e0d:	e8 e4 e3 ff ff       	call   801031f6 <myproc>
80104e12:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
80104e19:	00 
    fileclose(rf);
80104e1a:	83 ec 0c             	sub    $0xc,%esp
80104e1d:	ff 75 f0             	pushl  -0x10(%ebp)
80104e20:	e8 ae be ff ff       	call   80100cd3 <fileclose>
    fileclose(wf);
80104e25:	83 c4 04             	add    $0x4,%esp
80104e28:	ff 75 ec             	pushl  -0x14(%ebp)
80104e2b:	e8 a3 be ff ff       	call   80100cd3 <fileclose>
    return -1;
80104e30:	83 c4 10             	add    $0x10,%esp
80104e33:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104e38:	eb ca                	jmp    80104e04 <sys_pipe+0x5c>
    return -1;
80104e3a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104e3f:	eb c3                	jmp    80104e04 <sys_pipe+0x5c>
    return -1;
80104e41:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104e46:	eb bc                	jmp    80104e04 <sys_pipe+0x5c>
...
80104e4b:	83 ec 08             	sub    $0x8,%esp
  return fork();
80104e4e:	e8 22 e5 ff ff       	call   80103375 <fork>
}
80104e53:	c9                   	leave  
80104e54:	c3                   	ret    
...
80104e58:	83 ec 08             	sub    $0x8,%esp
  exit();
80104e5b:	e8 49 e7 ff ff       	call   801035a9 <exit>
...
80104e6a:	83 ec 08             	sub    $0x8,%esp
  return wait();
80104e6d:	e8 c0 e8 ff ff       	call   80103732 <wait>
}
80104e72:	c9                   	leave  
80104e73:	c3                   	ret    
...
80104e80:	e8 f2 f2 ff ff       	call   80104177 <argint>
80104e85:	83 c4 10             	add    $0x10,%esp
80104e88:	85 c0                	test   %eax,%eax
80104e8a:	78 10                	js     80104e9c <sys_kill+0x28>
    return -1;
  return kill(pid);
80104e8c:	83 ec 0c             	sub    $0xc,%esp
80104e8f:	ff 75 f4             	pushl  -0xc(%ebp)
80104e92:	e8 98 e9 ff ff       	call   8010382f <kill>
...
80104ea1:	eb f7                	jmp    80104e9a <sys_kill+0x26>
...
80104ea6:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80104ea9:	e8 48 e3 ff ff       	call   801031f6 <myproc>
80104eae:	8b 40 10             	mov    0x10(%eax),%eax
}
80104eb1:	c9                   	leave  
80104eb2:	c3                   	ret    
...
80104ec0:	e8 b2 f2 ff ff       	call   80104177 <argint>
80104ec5:	83 c4 10             	add    $0x10,%esp
80104ec8:	85 c0                	test   %eax,%eax
80104eca:	78 27                	js     80104ef3 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80104ecc:	e8 25 e3 ff ff       	call   801031f6 <myproc>
80104ed1:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80104ed3:	83 ec 0c             	sub    $0xc,%esp
80104ed6:	ff 75 f4             	pushl  -0xc(%ebp)
80104ed9:	e8 2a e4 ff ff       	call   80103308 <growproc>
80104ede:	83 c4 10             	add    $0x10,%esp
80104ee1:	85 c0                	test   %eax,%eax
80104ee3:	78 07                	js     80104eec <sys_sbrk+0x39>
    return -1;
  return addr;
}
...
80104eeb:	c3                   	ret    
    return -1;
80104eec:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104ef1:	eb f2                	jmp    80104ee5 <sys_sbrk+0x32>
    return -1;
80104ef3:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104ef8:	eb eb                	jmp    80104ee5 <sys_sbrk+0x32>
...
80104efe:	83 ec 1c             	sub    $0x1c,%esp
  int n;
  uint ticks0;
...
80104f07:	e8 6b f2 ff ff       	call   80104177 <argint>
80104f0c:	83 c4 10             	add    $0x10,%esp
80104f0f:	85 c0                	test   %eax,%eax
80104f11:	78 75                	js     80104f88 <sys_sleep+0x8e>
    return -1;
  acquire(&tickslock);
80104f13:	83 ec 0c             	sub    $0xc,%esp
80104f16:	68 60 5d 11 80       	push   $0x80115d60
80104f1b:	e8 60 ef ff ff       	call   80103e80 <acquire>
  ticks0 = ticks;
80104f20:	8b 1d a0 65 11 80    	mov    0x801165a0,%ebx
  while(ticks - ticks0 < n){
80104f26:	83 c4 10             	add    $0x10,%esp
80104f29:	a1 a0 65 11 80       	mov    0x801165a0,%eax
80104f2e:	29 d8                	sub    %ebx,%eax
80104f30:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80104f33:	73 39                	jae    80104f6e <sys_sleep+0x74>
    if(myproc()->killed){
80104f35:	e8 bc e2 ff ff       	call   801031f6 <myproc>
80104f3a:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104f3e:	75 17                	jne    80104f57 <sys_sleep+0x5d>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
80104f40:	83 ec 08             	sub    $0x8,%esp
80104f43:	68 60 5d 11 80       	push   $0x80115d60
80104f48:	68 a0 65 11 80       	push   $0x801165a0
80104f4d:	e8 4f e7 ff ff       	call   801036a1 <sleep>
80104f52:	83 c4 10             	add    $0x10,%esp
80104f55:	eb d2                	jmp    80104f29 <sys_sleep+0x2f>
      release(&tickslock);
80104f57:	83 ec 0c             	sub    $0xc,%esp
80104f5a:	68 60 5d 11 80       	push   $0x80115d60
80104f5f:	e8 81 ef ff ff       	call   80103ee5 <release>
      return -1;
80104f64:	83 c4 10             	add    $0x10,%esp
80104f67:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f6c:	eb 15                	jmp    80104f83 <sys_sleep+0x89>
  }
  release(&tickslock);
80104f6e:	83 ec 0c             	sub    $0xc,%esp
80104f71:	68 60 5d 11 80       	push   $0x80115d60
80104f76:	e8 6a ef ff ff       	call   80103ee5 <release>
  return 0;
80104f7b:	83 c4 10             	add    $0x10,%esp
80104f7e:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104f83:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104f86:	c9                   	leave  
80104f87:	c3                   	ret    
    return -1;
80104f88:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f8d:	eb f4                	jmp    80104f83 <sys_sleep+0x89>
...
80104f93:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80104f96:	68 60 5d 11 80       	push   $0x80115d60
80104f9b:	e8 e0 ee ff ff       	call   80103e80 <acquire>
  xticks = ticks;
80104fa0:	8b 1d a0 65 11 80    	mov    0x801165a0,%ebx
  release(&tickslock);
80104fa6:	c7 04 24 60 5d 11 80 	movl   $0x80115d60,(%esp)
80104fad:	e8 33 ef ff ff       	call   80103ee5 <release>
  return xticks;
}
...
80104fbc:	83 ec 20             	sub    $0x20,%esp
    int PID;
    int pri;
...
80104fef:	e8 61 e9 ff ff       	call   80103955 <setpri>
    return rc;
...
80104ffe:	eb f7                	jmp    80104ff7 <sys_setpri+0x3e>
80105000:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105005:	eb f0                	jmp    80104ff7 <sys_setpri+0x3e>
...
8010500a:	83 ec 20             	sub    $0x20,%esp
    int PID;

    if(argint(0, &PID) < 0){
8010500d:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105010:	50                   	push   %eax
80105011:	6a 00                	push   $0x0
80105013:	e8 5f f1 ff ff       	call   80104177 <argint>
80105018:	83 c4 10             	add    $0x10,%esp
8010501b:	85 c0                	test   %eax,%eax
8010501d:	78 10                	js     8010502f <sys_getpri+0x28>
        return -1;
    }
...
80105025:	e8 16 ea ff ff       	call   80103a40 <getpri>
    return rc;
...
80105034:	eb f7                	jmp    8010502d <sys_getpri+0x26>
...
80105039:	83 ec 20             	sub    $0x20,%esp
...
80105042:	e8 30 f1 ff ff       	call   80104177 <argint>
80105047:	83 c4 10             	add    $0x10,%esp
8010504a:	85 c0                	test   %eax,%eax
8010504c:	78 10                	js     8010505e <sys_fork2+0x28>
        return -1;
    }

    int rc = fork2(pri);
8010504e:	83 ec 0c             	sub    $0xc,%esp
80105051:	ff 75 f4             	pushl  -0xc(%ebp)
80105054:	e8 47 ea ff ff       	call   80103aa0 <fork2>
    return rc;
...
80105063:	eb f7                	jmp    8010505c <sys_fork2+0x26>

80105065 <sys_getpinfo>:
...
80105070:	06                   	push   %es
  pushl %fs
80105071:	0f a0                	push   %fs
  pushl %gs
80105073:	0f a8                	push   %gs
  pushal
80105075:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105076:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010507a:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010507c:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010507e:	54                   	push   %esp
  call trap
8010507f:	e8 e3 00 00 00       	call   80105167 <trap>
  addl $4, %esp
80105084:	83 c4 04             	add    $0x4,%esp
...
80105087:	61                   	popa   
  popl %gs
80105088:	0f a9                	pop    %gs
  popl %fs
8010508a:	0f a1                	pop    %fs
  popl %es
8010508c:	07                   	pop    %es
  popl %ds
8010508d:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
8010508e:	83 c4 08             	add    $0x8,%esp
  iret
80105091:	cf                   	iret   
...
8010509d:	eb 4a                	jmp    801050e9 <tvinit+0x57>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
8010509f:	8b 0c 85 08 a0 10 80 	mov    -0x7fef5ff8(,%eax,4),%ecx
801050a6:	66 89 0c c5 a0 5d 11 	mov    %cx,-0x7feea260(,%eax,8)
801050ad:	80 
801050ae:	66 c7 04 c5 a2 5d 11 	movw   $0x8,-0x7feea25e(,%eax,8)
801050b5:	80 08 00 
801050b8:	c6 04 c5 a4 5d 11 80 	movb   $0x0,-0x7feea25c(,%eax,8)
801050bf:	00 
801050c0:	0f b6 14 c5 a5 5d 11 	movzbl -0x7feea25b(,%eax,8),%edx
801050c7:	80 
801050c8:	83 e2 f0             	and    $0xfffffff0,%edx
801050cb:	83 ca 0e             	or     $0xe,%edx
801050ce:	83 e2 8f             	and    $0xffffff8f,%edx
801050d1:	83 ca 80             	or     $0xffffff80,%edx
801050d4:	88 14 c5 a5 5d 11 80 	mov    %dl,-0x7feea25b(,%eax,8)
801050db:	c1 e9 10             	shr    $0x10,%ecx
801050de:	66 89 0c c5 a6 5d 11 	mov    %cx,-0x7feea25a(,%eax,8)
801050e5:	80 
  for(i = 0; i < 256; i++)
801050e6:	83 c0 01             	add    $0x1,%eax
801050e9:	3d ff 00 00 00       	cmp    $0xff,%eax
801050ee:	7e af                	jle    8010509f <tvinit+0xd>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801050f0:	8b 15 08 a1 10 80    	mov    0x8010a108,%edx
801050f6:	66 89 15 a0 5f 11 80 	mov    %dx,0x80115fa0
801050fd:	66 c7 05 a2 5f 11 80 	movw   $0x8,0x80115fa2
80105104:	08 00 
80105106:	c6 05 a4 5f 11 80 00 	movb   $0x0,0x80115fa4
8010510d:	0f b6 05 a5 5f 11 80 	movzbl 0x80115fa5,%eax
80105114:	83 c8 0f             	or     $0xf,%eax
80105117:	83 e0 ef             	and    $0xffffffef,%eax
8010511a:	83 c8 e0             	or     $0xffffffe0,%eax
8010511d:	a2 a5 5f 11 80       	mov    %al,0x80115fa5
80105122:	c1 ea 10             	shr    $0x10,%edx
80105125:	66 89 15 a6 5f 11 80 	mov    %dx,0x80115fa6

  initlock(&tickslock, "time");
8010512c:	83 ec 08             	sub    $0x8,%esp
8010512f:	68 69 6f 10 80       	push   $0x80106f69
80105134:	68 60 5d 11 80       	push   $0x80115d60
80105139:	e8 06 ec ff ff       	call   80103d44 <initlock>
}
...
80105146:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80105149:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
8010514f:	b8 a0 5d 11 80       	mov    $0x80115da0,%eax
80105154:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80105158:	c1 e8 10             	shr    $0x10,%eax
8010515b:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
8010515f:	8d 45 fa             	lea    -0x6(%ebp),%eax
80105162:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80105165:	c9                   	leave  
80105166:	c3                   	ret    
...
8010516d:	83 ec 1c             	sub    $0x1c,%esp
80105170:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80105173:	8b 43 30             	mov    0x30(%ebx),%eax
80105176:	83 f8 40             	cmp    $0x40,%eax
80105179:	74 13                	je     8010518e <trap+0x27>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
8010517b:	83 e8 20             	sub    $0x20,%eax
8010517e:	83 f8 1f             	cmp    $0x1f,%eax
80105181:	0f 87 3a 01 00 00    	ja     801052c1 <trap+0x15a>
80105187:	ff 24 85 10 70 10 80 	jmp    *-0x7fef8ff0(,%eax,4)
    if(myproc()->killed)
8010518e:	e8 63 e0 ff ff       	call   801031f6 <myproc>
80105193:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80105197:	75 1f                	jne    801051b8 <trap+0x51>
    myproc()->tf = tf;
80105199:	e8 58 e0 ff ff       	call   801031f6 <myproc>
8010519e:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801051a1:	e8 94 f0 ff ff       	call   8010423a <syscall>
    if(myproc()->killed)
801051a6:	e8 4b e0 ff ff       	call   801031f6 <myproc>
801051ab:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
801051af:	74 7e                	je     8010522f <trap+0xc8>
      exit();
801051b1:	e8 f3 e3 ff ff       	call   801035a9 <exit>
801051b6:	eb 77                	jmp    8010522f <trap+0xc8>
      exit();
801051b8:	e8 ec e3 ff ff       	call   801035a9 <exit>
801051bd:	eb da                	jmp    80105199 <trap+0x32>
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
801051bf:	e8 17 e0 ff ff       	call   801031db <cpuid>
801051c4:	85 c0                	test   %eax,%eax
801051c6:	74 6f                	je     80105237 <trap+0xd0>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
801051c8:	e8 cc d1 ff ff       	call   80102399 <lapiceoi>
  }
...
801051cd:	e8 24 e0 ff ff       	call   801031f6 <myproc>
801051d2:	85 c0                	test   %eax,%eax
801051d4:	74 1c                	je     801051f2 <trap+0x8b>
801051d6:	e8 1b e0 ff ff       	call   801031f6 <myproc>
801051db:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
801051df:	74 11                	je     801051f2 <trap+0x8b>
801051e1:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801051e5:	83 e0 03             	and    $0x3,%eax
801051e8:	66 83 f8 03          	cmp    $0x3,%ax
801051ec:	0f 84 62 01 00 00    	je     80105354 <trap+0x1ed>
...
801051f2:	e8 ff df ff ff       	call   801031f6 <myproc>
801051f7:	85 c0                	test   %eax,%eax
801051f9:	74 0f                	je     8010520a <trap+0xa3>
801051fb:	e8 f6 df ff ff       	call   801031f6 <myproc>
80105200:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105204:	0f 84 54 01 00 00    	je     8010535e <trap+0x1f7>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010520a:	e8 e7 df ff ff       	call   801031f6 <myproc>
8010520f:	85 c0                	test   %eax,%eax
80105211:	74 1c                	je     8010522f <trap+0xc8>
80105213:	e8 de df ff ff       	call   801031f6 <myproc>
80105218:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
8010521c:	74 11                	je     8010522f <trap+0xc8>
8010521e:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105222:	83 e0 03             	and    $0x3,%eax
80105225:	66 83 f8 03          	cmp    $0x3,%ax
80105229:	0f 84 43 01 00 00    	je     80105372 <trap+0x20b>
    exit();
}
...
8010523a:	68 60 5d 11 80       	push   $0x80115d60
8010523f:	e8 3c ec ff ff       	call   80103e80 <acquire>
      ticks++;
80105244:	83 05 a0 65 11 80 01 	addl   $0x1,0x801165a0
      wakeup(&ticks);
8010524b:	c7 04 24 a0 65 11 80 	movl   $0x801165a0,(%esp)
80105252:	e8 af e5 ff ff       	call   80103806 <wakeup>
      release(&tickslock);
80105257:	c7 04 24 60 5d 11 80 	movl   $0x80115d60,(%esp)
8010525e:	e8 82 ec ff ff       	call   80103ee5 <release>
80105263:	83 c4 10             	add    $0x10,%esp
80105266:	e9 5d ff ff ff       	jmp    801051c8 <trap+0x61>
    ideintr();
8010526b:	e8 03 cb ff ff       	call   80101d73 <ideintr>
    lapiceoi();
80105270:	e8 24 d1 ff ff       	call   80102399 <lapiceoi>
    break;
80105275:	e9 53 ff ff ff       	jmp    801051cd <trap+0x66>
    kbdintr();
8010527a:	e8 5e cf ff ff       	call   801021dd <kbdintr>
    lapiceoi();
8010527f:	e8 15 d1 ff ff       	call   80102399 <lapiceoi>
    break;
80105284:	e9 44 ff ff ff       	jmp    801051cd <trap+0x66>
    uartintr();
80105289:	e8 05 02 00 00       	call   80105493 <uartintr>
    lapiceoi();
8010528e:	e8 06 d1 ff ff       	call   80102399 <lapiceoi>
    break;
80105293:	e9 35 ff ff ff       	jmp    801051cd <trap+0x66>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105298:	8b 7b 38             	mov    0x38(%ebx),%edi
            cpuid(), tf->cs, tf->eip);
8010529b:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010529f:	e8 37 df ff ff       	call   801031db <cpuid>
801052a4:	57                   	push   %edi
801052a5:	0f b7 f6             	movzwl %si,%esi
801052a8:	56                   	push   %esi
801052a9:	50                   	push   %eax
801052aa:	68 74 6f 10 80       	push   $0x80106f74
801052af:	e8 57 b3 ff ff       	call   8010060b <cprintf>
    lapiceoi();
801052b4:	e8 e0 d0 ff ff       	call   80102399 <lapiceoi>
    break;
801052b9:	83 c4 10             	add    $0x10,%esp
801052bc:	e9 0c ff ff ff       	jmp    801051cd <trap+0x66>
    if(myproc() == 0 || (tf->cs&3) == 0){
801052c1:	e8 30 df ff ff       	call   801031f6 <myproc>
801052c6:	85 c0                	test   %eax,%eax
801052c8:	74 5f                	je     80105329 <trap+0x1c2>
801052ca:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801052ce:	74 59                	je     80105329 <trap+0x1c2>
...
801052d0:	0f 20 d7             	mov    %cr2,%edi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801052d3:	8b 43 38             	mov    0x38(%ebx),%eax
801052d6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801052d9:	e8 fd de ff ff       	call   801031db <cpuid>
801052de:	89 45 e0             	mov    %eax,-0x20(%ebp)
801052e1:	8b 53 34             	mov    0x34(%ebx),%edx
801052e4:	89 55 dc             	mov    %edx,-0x24(%ebp)
801052e7:	8b 73 30             	mov    0x30(%ebx),%esi
            myproc()->pid, myproc()->name, tf->trapno,
801052ea:	e8 07 df ff ff       	call   801031f6 <myproc>
801052ef:	8d 48 6c             	lea    0x6c(%eax),%ecx
801052f2:	89 4d d8             	mov    %ecx,-0x28(%ebp)
801052f5:	e8 fc de ff ff       	call   801031f6 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801052fa:	57                   	push   %edi
801052fb:	ff 75 e4             	pushl  -0x1c(%ebp)
801052fe:	ff 75 e0             	pushl  -0x20(%ebp)
80105301:	ff 75 dc             	pushl  -0x24(%ebp)
80105304:	56                   	push   %esi
80105305:	ff 75 d8             	pushl  -0x28(%ebp)
80105308:	ff 70 10             	pushl  0x10(%eax)
8010530b:	68 cc 6f 10 80       	push   $0x80106fcc
80105310:	e8 f6 b2 ff ff       	call   8010060b <cprintf>
    myproc()->killed = 1;
80105315:	83 c4 20             	add    $0x20,%esp
80105318:	e8 d9 de ff ff       	call   801031f6 <myproc>
8010531d:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80105324:	e9 a4 fe ff ff       	jmp    801051cd <trap+0x66>
80105329:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010532c:	8b 73 38             	mov    0x38(%ebx),%esi
8010532f:	e8 a7 de ff ff       	call   801031db <cpuid>
80105334:	83 ec 0c             	sub    $0xc,%esp
80105337:	57                   	push   %edi
80105338:	56                   	push   %esi
80105339:	50                   	push   %eax
8010533a:	ff 73 30             	pushl  0x30(%ebx)
8010533d:	68 98 6f 10 80       	push   $0x80106f98
80105342:	e8 c4 b2 ff ff       	call   8010060b <cprintf>
      panic("trap");
80105347:	83 c4 14             	add    $0x14,%esp
8010534a:	68 6e 6f 10 80       	push   $0x80106f6e
8010534f:	e8 f4 af ff ff       	call   80100348 <panic>
    exit();
80105354:	e8 50 e2 ff ff       	call   801035a9 <exit>
80105359:	e9 94 fe ff ff       	jmp    801051f2 <trap+0x8b>
  if(myproc() && myproc()->state == RUNNING &&
8010535e:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105362:	0f 85 a2 fe ff ff    	jne    8010520a <trap+0xa3>
    yield();
80105368:	e8 02 e3 ff ff       	call   8010366f <yield>
8010536d:	e9 98 fe ff ff       	jmp    8010520a <trap+0xa3>
    exit();
80105372:	e8 32 e2 ff ff       	call   801035a9 <exit>
80105377:	e9 b3 fe ff ff       	jmp    8010522f <trap+0xc8>
...
80105386:	74 15                	je     8010539d <uartgetc+0x21>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105388:	ba fd 03 00 00       	mov    $0x3fd,%edx
8010538d:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
8010538e:	a8 01                	test   $0x1,%al
80105390:	74 12                	je     801053a4 <uartgetc+0x28>
...
801053a2:	eb f7                	jmp    8010539b <uartgetc+0x1f>
    return -1;
801053a4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801053a9:	eb f0                	jmp    8010539b <uartgetc+0x1f>

801053ab <uartputc>:
  if(!uart)
801053ab:	83 3d bc a5 10 80 00 	cmpl   $0x0,0x8010a5bc
801053b2:	74 3b                	je     801053ef <uartputc+0x44>
{
...
801053bb:	bb 00 00 00 00       	mov    $0x0,%ebx
801053c0:	eb 10                	jmp    801053d2 <uartputc+0x27>
    microdelay(10);
801053c2:	83 ec 0c             	sub    $0xc,%esp
801053c5:	6a 0a                	push   $0xa
801053c7:	e8 ec cf ff ff       	call   801023b8 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801053cc:	83 c3 01             	add    $0x1,%ebx
801053cf:	83 c4 10             	add    $0x10,%esp
801053d2:	83 fb 7f             	cmp    $0x7f,%ebx
801053d5:	7f 0a                	jg     801053e1 <uartputc+0x36>
801053d7:	ba fd 03 00 00       	mov    $0x3fd,%edx
801053dc:	ec                   	in     (%dx),%al
801053dd:	a8 20                	test   $0x20,%al
801053df:	74 e1                	je     801053c2 <uartputc+0x17>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801053e1:	8b 45 08             	mov    0x8(%ebp),%eax
801053e4:	ba f8 03 00 00       	mov    $0x3f8,%edx
801053e9:	ee                   	out    %al,(%dx)
}
801053ea:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801053ed:	c9                   	leave  
801053ee:	c3                   	ret    
801053ef:	f3 c3                	repz ret 
...
801053f6:	b9 00 00 00 00       	mov    $0x0,%ecx
801053fb:	ba fa 03 00 00       	mov    $0x3fa,%edx
80105400:	89 c8                	mov    %ecx,%eax
80105402:	ee                   	out    %al,(%dx)
80105403:	be fb 03 00 00       	mov    $0x3fb,%esi
80105408:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
8010540d:	89 f2                	mov    %esi,%edx
8010540f:	ee                   	out    %al,(%dx)
80105410:	b8 0c 00 00 00       	mov    $0xc,%eax
80105415:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010541a:	ee                   	out    %al,(%dx)
8010541b:	bb f9 03 00 00       	mov    $0x3f9,%ebx
80105420:	89 c8                	mov    %ecx,%eax
80105422:	89 da                	mov    %ebx,%edx
80105424:	ee                   	out    %al,(%dx)
80105425:	b8 03 00 00 00       	mov    $0x3,%eax
8010542a:	89 f2                	mov    %esi,%edx
8010542c:	ee                   	out    %al,(%dx)
8010542d:	ba fc 03 00 00       	mov    $0x3fc,%edx
80105432:	89 c8                	mov    %ecx,%eax
80105434:	ee                   	out    %al,(%dx)
80105435:	b8 01 00 00 00       	mov    $0x1,%eax
8010543a:	89 da                	mov    %ebx,%edx
8010543c:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010543d:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105442:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105443:	3c ff                	cmp    $0xff,%al
80105445:	74 45                	je     8010548c <uartinit+0x9b>
  uart = 1;
80105447:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
8010544e:	00 00 00 
80105451:	ba fa 03 00 00       	mov    $0x3fa,%edx
80105456:	ec                   	in     (%dx),%al
80105457:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010545c:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
8010545d:	83 ec 08             	sub    $0x8,%esp
80105460:	6a 00                	push   $0x0
80105462:	6a 04                	push   $0x4
80105464:	e8 15 cb ff ff       	call   80101f7e <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80105469:	83 c4 10             	add    $0x10,%esp
8010546c:	bb 90 70 10 80       	mov    $0x80107090,%ebx
80105471:	eb 12                	jmp    80105485 <uartinit+0x94>
    uartputc(*p);
80105473:	83 ec 0c             	sub    $0xc,%esp
80105476:	0f be c0             	movsbl %al,%eax
80105479:	50                   	push   %eax
8010547a:	e8 2c ff ff ff       	call   801053ab <uartputc>
  for(p="xv6...\n"; *p; p++)
8010547f:	83 c3 01             	add    $0x1,%ebx
80105482:	83 c4 10             	add    $0x10,%esp
80105485:	0f b6 03             	movzbl (%ebx),%eax
80105488:	84 c0                	test   %al,%al
8010548a:	75 e7                	jne    80105473 <uartinit+0x82>
}
...
80105496:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
80105499:	68 7c 53 10 80       	push   $0x8010537c
8010549e:	e8 9b b2 ff ff       	call   8010073e <consoleintr>
}
...
801054aa:	6a 00                	push   $0x0
  jmp alltraps
801054ac:	e9 be fb ff ff       	jmp    8010506f <alltraps>
...
801054b3:	6a 01                	push   $0x1
  jmp alltraps
801054b5:	e9 b5 fb ff ff       	jmp    8010506f <alltraps>
...
801054bc:	6a 02                	push   $0x2
  jmp alltraps
801054be:	e9 ac fb ff ff       	jmp    8010506f <alltraps>
...
801054c3:	6a 00                	push   $0x0
  pushl $3
801054c5:	6a 03                	push   $0x3
  jmp alltraps
801054c7:	e9 a3 fb ff ff       	jmp    8010506f <alltraps>
...
801054cc:	6a 00                	push   $0x0
  pushl $4
801054ce:	6a 04                	push   $0x4
  jmp alltraps
801054d0:	e9 9a fb ff ff       	jmp    8010506f <alltraps>
...
801054d5:	6a 00                	push   $0x0
  pushl $5
801054d7:	6a 05                	push   $0x5
  jmp alltraps
801054d9:	e9 91 fb ff ff       	jmp    8010506f <alltraps>
...
801054de:	6a 00                	push   $0x0
  pushl $6
801054e0:	6a 06                	push   $0x6
  jmp alltraps
801054e2:	e9 88 fb ff ff       	jmp    8010506f <alltraps>
...
801054e7:	6a 00                	push   $0x0
  pushl $7
801054e9:	6a 07                	push   $0x7
  jmp alltraps
801054eb:	e9 7f fb ff ff       	jmp    8010506f <alltraps>
...
801054f0:	6a 08                	push   $0x8
  jmp alltraps
801054f2:	e9 78 fb ff ff       	jmp    8010506f <alltraps>
...
801054f7:	6a 00                	push   $0x0
  pushl $9
801054f9:	6a 09                	push   $0x9
  jmp alltraps
801054fb:	e9 6f fb ff ff       	jmp    8010506f <alltraps>

80105500 <vector10>:
.globl vector10
vector10:
  pushl $10
80105500:	6a 0a                	push   $0xa
  jmp alltraps
80105502:	e9 68 fb ff ff       	jmp    8010506f <alltraps>

80105507 <vector11>:
.globl vector11
vector11:
  pushl $11
80105507:	6a 0b                	push   $0xb
  jmp alltraps
80105509:	e9 61 fb ff ff       	jmp    8010506f <alltraps>

8010550e <vector12>:
.globl vector12
vector12:
  pushl $12
8010550e:	6a 0c                	push   $0xc
  jmp alltraps
80105510:	e9 5a fb ff ff       	jmp    8010506f <alltraps>

80105515 <vector13>:
.globl vector13
vector13:
  pushl $13
80105515:	6a 0d                	push   $0xd
  jmp alltraps
80105517:	e9 53 fb ff ff       	jmp    8010506f <alltraps>
...
8010551c:	6a 0e                	push   $0xe
  jmp alltraps
8010551e:	e9 4c fb ff ff       	jmp    8010506f <alltraps>
...
80105523:	6a 00                	push   $0x0
  pushl $15
80105525:	6a 0f                	push   $0xf
  jmp alltraps
80105527:	e9 43 fb ff ff       	jmp    8010506f <alltraps>
...
8010552c:	6a 00                	push   $0x0
  pushl $16
8010552e:	6a 10                	push   $0x10
  jmp alltraps
80105530:	e9 3a fb ff ff       	jmp    8010506f <alltraps>

80105535 <vector17>:
.globl vector17
vector17:
  pushl $17
80105535:	6a 11                	push   $0x11
  jmp alltraps
80105537:	e9 33 fb ff ff       	jmp    8010506f <alltraps>
...
8010553c:	6a 00                	push   $0x0
  pushl $18
8010553e:	6a 12                	push   $0x12
  jmp alltraps
80105540:	e9 2a fb ff ff       	jmp    8010506f <alltraps>
...
80105545:	6a 00                	push   $0x0
  pushl $19
80105547:	6a 13                	push   $0x13
  jmp alltraps
80105549:	e9 21 fb ff ff       	jmp    8010506f <alltraps>
...
80105550:	6a 14                	push   $0x14
  jmp alltraps
80105552:	e9 18 fb ff ff       	jmp    8010506f <alltraps>
...
80105557:	6a 00                	push   $0x0
  pushl $21
80105559:	6a 15                	push   $0x15
  jmp alltraps
8010555b:	e9 0f fb ff ff       	jmp    8010506f <alltraps>
...
80105560:	6a 00                	push   $0x0
  pushl $22
80105562:	6a 16                	push   $0x16
  jmp alltraps
80105564:	e9 06 fb ff ff       	jmp    8010506f <alltraps>
...
80105569:	6a 00                	push   $0x0
  pushl $23
8010556b:	6a 17                	push   $0x17
  jmp alltraps
8010556d:	e9 fd fa ff ff       	jmp    8010506f <alltraps>
...
80105572:	6a 00                	push   $0x0
  pushl $24
80105574:	6a 18                	push   $0x18
  jmp alltraps
80105576:	e9 f4 fa ff ff       	jmp    8010506f <alltraps>
...
8010557b:	6a 00                	push   $0x0
  pushl $25
8010557d:	6a 19                	push   $0x19
  jmp alltraps
8010557f:	e9 eb fa ff ff       	jmp    8010506f <alltraps>
...
80105584:	6a 00                	push   $0x0
  pushl $26
80105586:	6a 1a                	push   $0x1a
  jmp alltraps
80105588:	e9 e2 fa ff ff       	jmp    8010506f <alltraps>
...
8010558d:	6a 00                	push   $0x0
  pushl $27
8010558f:	6a 1b                	push   $0x1b
  jmp alltraps
80105591:	e9 d9 fa ff ff       	jmp    8010506f <alltraps>
...
80105596:	6a 00                	push   $0x0
  pushl $28
80105598:	6a 1c                	push   $0x1c
  jmp alltraps
8010559a:	e9 d0 fa ff ff       	jmp    8010506f <alltraps>
...
8010559f:	6a 00                	push   $0x0
  pushl $29
801055a1:	6a 1d                	push   $0x1d
  jmp alltraps
801055a3:	e9 c7 fa ff ff       	jmp    8010506f <alltraps>
...
801055a8:	6a 00                	push   $0x0
  pushl $30
801055aa:	6a 1e                	push   $0x1e
  jmp alltraps
801055ac:	e9 be fa ff ff       	jmp    8010506f <alltraps>
...
801055b1:	6a 00                	push   $0x0
  pushl $31
801055b3:	6a 1f                	push   $0x1f
  jmp alltraps
801055b5:	e9 b5 fa ff ff       	jmp    8010506f <alltraps>
...
801055ba:	6a 00                	push   $0x0
  pushl $32
801055bc:	6a 20                	push   $0x20
  jmp alltraps
801055be:	e9 ac fa ff ff       	jmp    8010506f <alltraps>
...
801055c3:	6a 00                	push   $0x0
  pushl $33
801055c5:	6a 21                	push   $0x21
  jmp alltraps
801055c7:	e9 a3 fa ff ff       	jmp    8010506f <alltraps>
...
801055cc:	6a 00                	push   $0x0
  pushl $34
801055ce:	6a 22                	push   $0x22
  jmp alltraps
801055d0:	e9 9a fa ff ff       	jmp    8010506f <alltraps>
...
801055d5:	6a 00                	push   $0x0
  pushl $35
801055d7:	6a 23                	push   $0x23
  jmp alltraps
801055d9:	e9 91 fa ff ff       	jmp    8010506f <alltraps>
...
801055de:	6a 00                	push   $0x0
  pushl $36
801055e0:	6a 24                	push   $0x24
  jmp alltraps
801055e2:	e9 88 fa ff ff       	jmp    8010506f <alltraps>
...
801055e7:	6a 00                	push   $0x0
  pushl $37
801055e9:	6a 25                	push   $0x25
  jmp alltraps
801055eb:	e9 7f fa ff ff       	jmp    8010506f <alltraps>
...
801055f0:	6a 00                	push   $0x0
  pushl $38
801055f2:	6a 26                	push   $0x26
  jmp alltraps
801055f4:	e9 76 fa ff ff       	jmp    8010506f <alltraps>
...
801055f9:	6a 00                	push   $0x0
  pushl $39
801055fb:	6a 27                	push   $0x27
  jmp alltraps
801055fd:	e9 6d fa ff ff       	jmp    8010506f <alltraps>
...
80105602:	6a 00                	push   $0x0
  pushl $40
80105604:	6a 28                	push   $0x28
  jmp alltraps
80105606:	e9 64 fa ff ff       	jmp    8010506f <alltraps>
...
8010560b:	6a 00                	push   $0x0
  pushl $41
8010560d:	6a 29                	push   $0x29
  jmp alltraps
8010560f:	e9 5b fa ff ff       	jmp    8010506f <alltraps>
...
80105614:	6a 00                	push   $0x0
  pushl $42
80105616:	6a 2a                	push   $0x2a
  jmp alltraps
80105618:	e9 52 fa ff ff       	jmp    8010506f <alltraps>
...
8010561d:	6a 00                	push   $0x0
  pushl $43
8010561f:	6a 2b                	push   $0x2b
  jmp alltraps
80105621:	e9 49 fa ff ff       	jmp    8010506f <alltraps>
...
80105626:	6a 00                	push   $0x0
  pushl $44
80105628:	6a 2c                	push   $0x2c
  jmp alltraps
8010562a:	e9 40 fa ff ff       	jmp    8010506f <alltraps>
...
8010562f:	6a 00                	push   $0x0
  pushl $45
80105631:	6a 2d                	push   $0x2d
  jmp alltraps
80105633:	e9 37 fa ff ff       	jmp    8010506f <alltraps>
...
80105638:	6a 00                	push   $0x0
  pushl $46
8010563a:	6a 2e                	push   $0x2e
  jmp alltraps
8010563c:	e9 2e fa ff ff       	jmp    8010506f <alltraps>
...
80105641:	6a 00                	push   $0x0
  pushl $47
80105643:	6a 2f                	push   $0x2f
  jmp alltraps
80105645:	e9 25 fa ff ff       	jmp    8010506f <alltraps>
...
8010564a:	6a 00                	push   $0x0
  pushl $48
8010564c:	6a 30                	push   $0x30
  jmp alltraps
8010564e:	e9 1c fa ff ff       	jmp    8010506f <alltraps>
...
80105653:	6a 00                	push   $0x0
  pushl $49
80105655:	6a 31                	push   $0x31
  jmp alltraps
80105657:	e9 13 fa ff ff       	jmp    8010506f <alltraps>
...
8010565c:	6a 00                	push   $0x0
  pushl $50
8010565e:	6a 32                	push   $0x32
  jmp alltraps
80105660:	e9 0a fa ff ff       	jmp    8010506f <alltraps>
...
80105665:	6a 00                	push   $0x0
  pushl $51
80105667:	6a 33                	push   $0x33
  jmp alltraps
80105669:	e9 01 fa ff ff       	jmp    8010506f <alltraps>
...
8010566e:	6a 00                	push   $0x0
  pushl $52
80105670:	6a 34                	push   $0x34
  jmp alltraps
80105672:	e9 f8 f9 ff ff       	jmp    8010506f <alltraps>
...
80105677:	6a 00                	push   $0x0
  pushl $53
80105679:	6a 35                	push   $0x35
  jmp alltraps
8010567b:	e9 ef f9 ff ff       	jmp    8010506f <alltraps>
...
80105680:	6a 00                	push   $0x0
  pushl $54
80105682:	6a 36                	push   $0x36
  jmp alltraps
80105684:	e9 e6 f9 ff ff       	jmp    8010506f <alltraps>
...
80105689:	6a 00                	push   $0x0
  pushl $55
8010568b:	6a 37                	push   $0x37
  jmp alltraps
8010568d:	e9 dd f9 ff ff       	jmp    8010506f <alltraps>
...
80105692:	6a 00                	push   $0x0
  pushl $56
80105694:	6a 38                	push   $0x38
  jmp alltraps
80105696:	e9 d4 f9 ff ff       	jmp    8010506f <alltraps>
...
8010569b:	6a 00                	push   $0x0
  pushl $57
8010569d:	6a 39                	push   $0x39
  jmp alltraps
8010569f:	e9 cb f9 ff ff       	jmp    8010506f <alltraps>
...
801056a4:	6a 00                	push   $0x0
  pushl $58
801056a6:	6a 3a                	push   $0x3a
  jmp alltraps
801056a8:	e9 c2 f9 ff ff       	jmp    8010506f <alltraps>
...
801056ad:	6a 00                	push   $0x0
  pushl $59
801056af:	6a 3b                	push   $0x3b
  jmp alltraps
801056b1:	e9 b9 f9 ff ff       	jmp    8010506f <alltraps>
...
801056b6:	6a 00                	push   $0x0
  pushl $60
801056b8:	6a 3c                	push   $0x3c
  jmp alltraps
801056ba:	e9 b0 f9 ff ff       	jmp    8010506f <alltraps>
...
801056bf:	6a 00                	push   $0x0
  pushl $61
801056c1:	6a 3d                	push   $0x3d
  jmp alltraps
801056c3:	e9 a7 f9 ff ff       	jmp    8010506f <alltraps>
...
801056c8:	6a 00                	push   $0x0
  pushl $62
801056ca:	6a 3e                	push   $0x3e
  jmp alltraps
801056cc:	e9 9e f9 ff ff       	jmp    8010506f <alltraps>
...
801056d1:	6a 00                	push   $0x0
  pushl $63
801056d3:	6a 3f                	push   $0x3f
  jmp alltraps
801056d5:	e9 95 f9 ff ff       	jmp    8010506f <alltraps>
...
801056da:	6a 00                	push   $0x0
  pushl $64
801056dc:	6a 40                	push   $0x40
  jmp alltraps
801056de:	e9 8c f9 ff ff       	jmp    8010506f <alltraps>
...
801056e3:	6a 00                	push   $0x0
  pushl $65
801056e5:	6a 41                	push   $0x41
  jmp alltraps
801056e7:	e9 83 f9 ff ff       	jmp    8010506f <alltraps>
...
801056ec:	6a 00                	push   $0x0
  pushl $66
801056ee:	6a 42                	push   $0x42
  jmp alltraps
801056f0:	e9 7a f9 ff ff       	jmp    8010506f <alltraps>
...
801056f5:	6a 00                	push   $0x0
  pushl $67
801056f7:	6a 43                	push   $0x43
  jmp alltraps
801056f9:	e9 71 f9 ff ff       	jmp    8010506f <alltraps>
...
801056fe:	6a 00                	push   $0x0
  pushl $68
80105700:	6a 44                	push   $0x44
  jmp alltraps
80105702:	e9 68 f9 ff ff       	jmp    8010506f <alltraps>
...
80105707:	6a 00                	push   $0x0
  pushl $69
80105709:	6a 45                	push   $0x45
  jmp alltraps
8010570b:	e9 5f f9 ff ff       	jmp    8010506f <alltraps>
...
80105710:	6a 00                	push   $0x0
  pushl $70
80105712:	6a 46                	push   $0x46
  jmp alltraps
80105714:	e9 56 f9 ff ff       	jmp    8010506f <alltraps>
...
80105719:	6a 00                	push   $0x0
  pushl $71
8010571b:	6a 47                	push   $0x47
  jmp alltraps
8010571d:	e9 4d f9 ff ff       	jmp    8010506f <alltraps>
...
80105722:	6a 00                	push   $0x0
  pushl $72
80105724:	6a 48                	push   $0x48
  jmp alltraps
80105726:	e9 44 f9 ff ff       	jmp    8010506f <alltraps>
...
8010572b:	6a 00                	push   $0x0
  pushl $73
8010572d:	6a 49                	push   $0x49
  jmp alltraps
8010572f:	e9 3b f9 ff ff       	jmp    8010506f <alltraps>
...
80105734:	6a 00                	push   $0x0
  pushl $74
80105736:	6a 4a                	push   $0x4a
  jmp alltraps
80105738:	e9 32 f9 ff ff       	jmp    8010506f <alltraps>
...
8010573d:	6a 00                	push   $0x0
  pushl $75
8010573f:	6a 4b                	push   $0x4b
  jmp alltraps
80105741:	e9 29 f9 ff ff       	jmp    8010506f <alltraps>
...
80105746:	6a 00                	push   $0x0
  pushl $76
80105748:	6a 4c                	push   $0x4c
  jmp alltraps
8010574a:	e9 20 f9 ff ff       	jmp    8010506f <alltraps>
...
8010574f:	6a 00                	push   $0x0
  pushl $77
80105751:	6a 4d                	push   $0x4d
  jmp alltraps
80105753:	e9 17 f9 ff ff       	jmp    8010506f <alltraps>
...
80105758:	6a 00                	push   $0x0
  pushl $78
8010575a:	6a 4e                	push   $0x4e
  jmp alltraps
8010575c:	e9 0e f9 ff ff       	jmp    8010506f <alltraps>
...
80105761:	6a 00                	push   $0x0
  pushl $79
80105763:	6a 4f                	push   $0x4f
  jmp alltraps
80105765:	e9 05 f9 ff ff       	jmp    8010506f <alltraps>
...
8010576a:	6a 00                	push   $0x0
  pushl $80
8010576c:	6a 50                	push   $0x50
  jmp alltraps
8010576e:	e9 fc f8 ff ff       	jmp    8010506f <alltraps>
...
80105773:	6a 00                	push   $0x0
  pushl $81
80105775:	6a 51                	push   $0x51
  jmp alltraps
80105777:	e9 f3 f8 ff ff       	jmp    8010506f <alltraps>
...
8010577c:	6a 00                	push   $0x0
  pushl $82
8010577e:	6a 52                	push   $0x52
  jmp alltraps
80105780:	e9 ea f8 ff ff       	jmp    8010506f <alltraps>
...
80105785:	6a 00                	push   $0x0
  pushl $83
80105787:	6a 53                	push   $0x53
  jmp alltraps
80105789:	e9 e1 f8 ff ff       	jmp    8010506f <alltraps>
...
8010578e:	6a 00                	push   $0x0
  pushl $84
80105790:	6a 54                	push   $0x54
  jmp alltraps
80105792:	e9 d8 f8 ff ff       	jmp    8010506f <alltraps>
...
80105797:	6a 00                	push   $0x0
  pushl $85
80105799:	6a 55                	push   $0x55
  jmp alltraps
8010579b:	e9 cf f8 ff ff       	jmp    8010506f <alltraps>
...
801057a0:	6a 00                	push   $0x0
  pushl $86
801057a2:	6a 56                	push   $0x56
  jmp alltraps
801057a4:	e9 c6 f8 ff ff       	jmp    8010506f <alltraps>
...
801057a9:	6a 00                	push   $0x0
  pushl $87
801057ab:	6a 57                	push   $0x57
  jmp alltraps
801057ad:	e9 bd f8 ff ff       	jmp    8010506f <alltraps>
...
801057b2:	6a 00                	push   $0x0
  pushl $88
801057b4:	6a 58                	push   $0x58
  jmp alltraps
801057b6:	e9 b4 f8 ff ff       	jmp    8010506f <alltraps>
...
801057bb:	6a 00                	push   $0x0
  pushl $89
801057bd:	6a 59                	push   $0x59
  jmp alltraps
801057bf:	e9 ab f8 ff ff       	jmp    8010506f <alltraps>
...
801057c4:	6a 00                	push   $0x0
  pushl $90
801057c6:	6a 5a                	push   $0x5a
  jmp alltraps
801057c8:	e9 a2 f8 ff ff       	jmp    8010506f <alltraps>
...
801057cd:	6a 00                	push   $0x0
  pushl $91
801057cf:	6a 5b                	push   $0x5b
  jmp alltraps
801057d1:	e9 99 f8 ff ff       	jmp    8010506f <alltraps>
...
801057d6:	6a 00                	push   $0x0
  pushl $92
801057d8:	6a 5c                	push   $0x5c
  jmp alltraps
801057da:	e9 90 f8 ff ff       	jmp    8010506f <alltraps>
...
801057df:	6a 00                	push   $0x0
  pushl $93
801057e1:	6a 5d                	push   $0x5d
  jmp alltraps
801057e3:	e9 87 f8 ff ff       	jmp    8010506f <alltraps>
...
801057e8:	6a 00                	push   $0x0
  pushl $94
801057ea:	6a 5e                	push   $0x5e
  jmp alltraps
801057ec:	e9 7e f8 ff ff       	jmp    8010506f <alltraps>
...
801057f1:	6a 00                	push   $0x0
  pushl $95
801057f3:	6a 5f                	push   $0x5f
  jmp alltraps
801057f5:	e9 75 f8 ff ff       	jmp    8010506f <alltraps>
...
801057fa:	6a 00                	push   $0x0
  pushl $96
801057fc:	6a 60                	push   $0x60
  jmp alltraps
801057fe:	e9 6c f8 ff ff       	jmp    8010506f <alltraps>
...
80105803:	6a 00                	push   $0x0
  pushl $97
80105805:	6a 61                	push   $0x61
  jmp alltraps
80105807:	e9 63 f8 ff ff       	jmp    8010506f <alltraps>
...
8010580c:	6a 00                	push   $0x0
  pushl $98
8010580e:	6a 62                	push   $0x62
  jmp alltraps
80105810:	e9 5a f8 ff ff       	jmp    8010506f <alltraps>
...
80105815:	6a 00                	push   $0x0
  pushl $99
80105817:	6a 63                	push   $0x63
  jmp alltraps
80105819:	e9 51 f8 ff ff       	jmp    8010506f <alltraps>
...
8010581e:	6a 00                	push   $0x0
  pushl $100
80105820:	6a 64                	push   $0x64
  jmp alltraps
80105822:	e9 48 f8 ff ff       	jmp    8010506f <alltraps>
...
80105827:	6a 00                	push   $0x0
  pushl $101
80105829:	6a 65                	push   $0x65
  jmp alltraps
8010582b:	e9 3f f8 ff ff       	jmp    8010506f <alltraps>
...
80105830:	6a 00                	push   $0x0
  pushl $102
80105832:	6a 66                	push   $0x66
  jmp alltraps
80105834:	e9 36 f8 ff ff       	jmp    8010506f <alltraps>
...
80105839:	6a 00                	push   $0x0
  pushl $103
8010583b:	6a 67                	push   $0x67
  jmp alltraps
8010583d:	e9 2d f8 ff ff       	jmp    8010506f <alltraps>
...
80105842:	6a 00                	push   $0x0
  pushl $104
80105844:	6a 68                	push   $0x68
  jmp alltraps
80105846:	e9 24 f8 ff ff       	jmp    8010506f <alltraps>
...
8010584b:	6a 00                	push   $0x0
  pushl $105
8010584d:	6a 69                	push   $0x69
  jmp alltraps
8010584f:	e9 1b f8 ff ff       	jmp    8010506f <alltraps>
...
80105854:	6a 00                	push   $0x0
  pushl $106
80105856:	6a 6a                	push   $0x6a
  jmp alltraps
80105858:	e9 12 f8 ff ff       	jmp    8010506f <alltraps>
...
8010585d:	6a 00                	push   $0x0
  pushl $107
8010585f:	6a 6b                	push   $0x6b
  jmp alltraps
80105861:	e9 09 f8 ff ff       	jmp    8010506f <alltraps>
...
80105866:	6a 00                	push   $0x0
  pushl $108
80105868:	6a 6c                	push   $0x6c
  jmp alltraps
8010586a:	e9 00 f8 ff ff       	jmp    8010506f <alltraps>
...
8010586f:	6a 00                	push   $0x0
  pushl $109
80105871:	6a 6d                	push   $0x6d
  jmp alltraps
80105873:	e9 f7 f7 ff ff       	jmp    8010506f <alltraps>
...
80105878:	6a 00                	push   $0x0
  pushl $110
8010587a:	6a 6e                	push   $0x6e
  jmp alltraps
8010587c:	e9 ee f7 ff ff       	jmp    8010506f <alltraps>
...
80105881:	6a 00                	push   $0x0
  pushl $111
80105883:	6a 6f                	push   $0x6f
  jmp alltraps
80105885:	e9 e5 f7 ff ff       	jmp    8010506f <alltraps>
...
8010588a:	6a 00                	push   $0x0
  pushl $112
8010588c:	6a 70                	push   $0x70
  jmp alltraps
8010588e:	e9 dc f7 ff ff       	jmp    8010506f <alltraps>
...
80105893:	6a 00                	push   $0x0
  pushl $113
80105895:	6a 71                	push   $0x71
  jmp alltraps
80105897:	e9 d3 f7 ff ff       	jmp    8010506f <alltraps>
...
8010589c:	6a 00                	push   $0x0
  pushl $114
8010589e:	6a 72                	push   $0x72
  jmp alltraps
801058a0:	e9 ca f7 ff ff       	jmp    8010506f <alltraps>
...
801058a5:	6a 00                	push   $0x0
  pushl $115
801058a7:	6a 73                	push   $0x73
  jmp alltraps
801058a9:	e9 c1 f7 ff ff       	jmp    8010506f <alltraps>
...
801058ae:	6a 00                	push   $0x0
  pushl $116
801058b0:	6a 74                	push   $0x74
  jmp alltraps
801058b2:	e9 b8 f7 ff ff       	jmp    8010506f <alltraps>
...
801058b7:	6a 00                	push   $0x0
  pushl $117
801058b9:	6a 75                	push   $0x75
  jmp alltraps
801058bb:	e9 af f7 ff ff       	jmp    8010506f <alltraps>
...
801058c0:	6a 00                	push   $0x0
  pushl $118
801058c2:	6a 76                	push   $0x76
  jmp alltraps
801058c4:	e9 a6 f7 ff ff       	jmp    8010506f <alltraps>
...
801058c9:	6a 00                	push   $0x0
  pushl $119
801058cb:	6a 77                	push   $0x77
  jmp alltraps
801058cd:	e9 9d f7 ff ff       	jmp    8010506f <alltraps>
...
801058d2:	6a 00                	push   $0x0
  pushl $120
801058d4:	6a 78                	push   $0x78
  jmp alltraps
801058d6:	e9 94 f7 ff ff       	jmp    8010506f <alltraps>
...
801058db:	6a 00                	push   $0x0
  pushl $121
801058dd:	6a 79                	push   $0x79
  jmp alltraps
801058df:	e9 8b f7 ff ff       	jmp    8010506f <alltraps>
...
801058e4:	6a 00                	push   $0x0
  pushl $122
801058e6:	6a 7a                	push   $0x7a
  jmp alltraps
801058e8:	e9 82 f7 ff ff       	jmp    8010506f <alltraps>
...
801058ed:	6a 00                	push   $0x0
  pushl $123
801058ef:	6a 7b                	push   $0x7b
  jmp alltraps
801058f1:	e9 79 f7 ff ff       	jmp    8010506f <alltraps>
...
801058f6:	6a 00                	push   $0x0
  pushl $124
801058f8:	6a 7c                	push   $0x7c
  jmp alltraps
801058fa:	e9 70 f7 ff ff       	jmp    8010506f <alltraps>
...
801058ff:	6a 00                	push   $0x0
  pushl $125
80105901:	6a 7d                	push   $0x7d
  jmp alltraps
80105903:	e9 67 f7 ff ff       	jmp    8010506f <alltraps>
...
80105908:	6a 00                	push   $0x0
  pushl $126
8010590a:	6a 7e                	push   $0x7e
  jmp alltraps
8010590c:	e9 5e f7 ff ff       	jmp    8010506f <alltraps>
...
80105911:	6a 00                	push   $0x0
  pushl $127
80105913:	6a 7f                	push   $0x7f
  jmp alltraps
80105915:	e9 55 f7 ff ff       	jmp    8010506f <alltraps>
...
8010591c:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105921:	e9 49 f7 ff ff       	jmp    8010506f <alltraps>
...
80105926:	6a 00                	push   $0x0
  pushl $129
80105928:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010592d:	e9 3d f7 ff ff       	jmp    8010506f <alltraps>
...
80105932:	6a 00                	push   $0x0
  pushl $130
80105934:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105939:	e9 31 f7 ff ff       	jmp    8010506f <alltraps>
...
8010593e:	6a 00                	push   $0x0
  pushl $131
80105940:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105945:	e9 25 f7 ff ff       	jmp    8010506f <alltraps>
...
8010594a:	6a 00                	push   $0x0
  pushl $132
8010594c:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105951:	e9 19 f7 ff ff       	jmp    8010506f <alltraps>
...
80105956:	6a 00                	push   $0x0
  pushl $133
80105958:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010595d:	e9 0d f7 ff ff       	jmp    8010506f <alltraps>
...
80105962:	6a 00                	push   $0x0
  pushl $134
80105964:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105969:	e9 01 f7 ff ff       	jmp    8010506f <alltraps>
...
8010596e:	6a 00                	push   $0x0
  pushl $135
80105970:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105975:	e9 f5 f6 ff ff       	jmp    8010506f <alltraps>
...
8010597a:	6a 00                	push   $0x0
  pushl $136
8010597c:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105981:	e9 e9 f6 ff ff       	jmp    8010506f <alltraps>
...
80105986:	6a 00                	push   $0x0
  pushl $137
80105988:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010598d:	e9 dd f6 ff ff       	jmp    8010506f <alltraps>
...
80105992:	6a 00                	push   $0x0
  pushl $138
80105994:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105999:	e9 d1 f6 ff ff       	jmp    8010506f <alltraps>
...
8010599e:	6a 00                	push   $0x0
  pushl $139
801059a0:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801059a5:	e9 c5 f6 ff ff       	jmp    8010506f <alltraps>
...
801059aa:	6a 00                	push   $0x0
  pushl $140
801059ac:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801059b1:	e9 b9 f6 ff ff       	jmp    8010506f <alltraps>
...
801059b6:	6a 00                	push   $0x0
  pushl $141
801059b8:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801059bd:	e9 ad f6 ff ff       	jmp    8010506f <alltraps>
...
801059c2:	6a 00                	push   $0x0
  pushl $142
801059c4:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801059c9:	e9 a1 f6 ff ff       	jmp    8010506f <alltraps>
...
801059ce:	6a 00                	push   $0x0
  pushl $143
801059d0:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801059d5:	e9 95 f6 ff ff       	jmp    8010506f <alltraps>
...
801059da:	6a 00                	push   $0x0
  pushl $144
801059dc:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801059e1:	e9 89 f6 ff ff       	jmp    8010506f <alltraps>
...
801059e6:	6a 00                	push   $0x0
  pushl $145
801059e8:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801059ed:	e9 7d f6 ff ff       	jmp    8010506f <alltraps>
...
801059f2:	6a 00                	push   $0x0
  pushl $146
801059f4:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801059f9:	e9 71 f6 ff ff       	jmp    8010506f <alltraps>
...
801059fe:	6a 00                	push   $0x0
  pushl $147
80105a00:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105a05:	e9 65 f6 ff ff       	jmp    8010506f <alltraps>
...
80105a0a:	6a 00                	push   $0x0
  pushl $148
80105a0c:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105a11:	e9 59 f6 ff ff       	jmp    8010506f <alltraps>
...
80105a16:	6a 00                	push   $0x0
  pushl $149
80105a18:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105a1d:	e9 4d f6 ff ff       	jmp    8010506f <alltraps>
...
80105a22:	6a 00                	push   $0x0
  pushl $150
80105a24:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105a29:	e9 41 f6 ff ff       	jmp    8010506f <alltraps>
...
80105a2e:	6a 00                	push   $0x0
  pushl $151
80105a30:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105a35:	e9 35 f6 ff ff       	jmp    8010506f <alltraps>
...
80105a3a:	6a 00                	push   $0x0
  pushl $152
80105a3c:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105a41:	e9 29 f6 ff ff       	jmp    8010506f <alltraps>
...
80105a46:	6a 00                	push   $0x0
  pushl $153
80105a48:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105a4d:	e9 1d f6 ff ff       	jmp    8010506f <alltraps>
...
80105a52:	6a 00                	push   $0x0
  pushl $154
80105a54:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105a59:	e9 11 f6 ff ff       	jmp    8010506f <alltraps>
...
80105a5e:	6a 00                	push   $0x0
  pushl $155
80105a60:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105a65:	e9 05 f6 ff ff       	jmp    8010506f <alltraps>
...
80105a6a:	6a 00                	push   $0x0
  pushl $156
80105a6c:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105a71:	e9 f9 f5 ff ff       	jmp    8010506f <alltraps>
...
80105a76:	6a 00                	push   $0x0
  pushl $157
80105a78:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105a7d:	e9 ed f5 ff ff       	jmp    8010506f <alltraps>
...
80105a82:	6a 00                	push   $0x0
  pushl $158
80105a84:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105a89:	e9 e1 f5 ff ff       	jmp    8010506f <alltraps>
...
80105a8e:	6a 00                	push   $0x0
  pushl $159
80105a90:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105a95:	e9 d5 f5 ff ff       	jmp    8010506f <alltraps>
...
80105a9a:	6a 00                	push   $0x0
  pushl $160
80105a9c:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105aa1:	e9 c9 f5 ff ff       	jmp    8010506f <alltraps>
...
80105aa6:	6a 00                	push   $0x0
  pushl $161
80105aa8:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105aad:	e9 bd f5 ff ff       	jmp    8010506f <alltraps>
...
80105ab2:	6a 00                	push   $0x0
  pushl $162
80105ab4:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105ab9:	e9 b1 f5 ff ff       	jmp    8010506f <alltraps>
...
80105abe:	6a 00                	push   $0x0
  pushl $163
80105ac0:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105ac5:	e9 a5 f5 ff ff       	jmp    8010506f <alltraps>
...
80105aca:	6a 00                	push   $0x0
  pushl $164
80105acc:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105ad1:	e9 99 f5 ff ff       	jmp    8010506f <alltraps>
...
80105ad6:	6a 00                	push   $0x0
  pushl $165
80105ad8:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105add:	e9 8d f5 ff ff       	jmp    8010506f <alltraps>
...
80105ae2:	6a 00                	push   $0x0
  pushl $166
80105ae4:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105ae9:	e9 81 f5 ff ff       	jmp    8010506f <alltraps>
...
80105aee:	6a 00                	push   $0x0
  pushl $167
80105af0:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105af5:	e9 75 f5 ff ff       	jmp    8010506f <alltraps>
...
80105afa:	6a 00                	push   $0x0
  pushl $168
80105afc:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105b01:	e9 69 f5 ff ff       	jmp    8010506f <alltraps>
...
80105b06:	6a 00                	push   $0x0
  pushl $169
80105b08:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105b0d:	e9 5d f5 ff ff       	jmp    8010506f <alltraps>
...
80105b12:	6a 00                	push   $0x0
  pushl $170
80105b14:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80105b19:	e9 51 f5 ff ff       	jmp    8010506f <alltraps>
...
80105b1e:	6a 00                	push   $0x0
  pushl $171
80105b20:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105b25:	e9 45 f5 ff ff       	jmp    8010506f <alltraps>
...
80105b2a:	6a 00                	push   $0x0
  pushl $172
80105b2c:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105b31:	e9 39 f5 ff ff       	jmp    8010506f <alltraps>
...
80105b36:	6a 00                	push   $0x0
  pushl $173
80105b38:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80105b3d:	e9 2d f5 ff ff       	jmp    8010506f <alltraps>
...
80105b42:	6a 00                	push   $0x0
  pushl $174
80105b44:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80105b49:	e9 21 f5 ff ff       	jmp    8010506f <alltraps>
...
80105b4e:	6a 00                	push   $0x0
  pushl $175
80105b50:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80105b55:	e9 15 f5 ff ff       	jmp    8010506f <alltraps>
...
80105b5a:	6a 00                	push   $0x0
  pushl $176
80105b5c:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80105b61:	e9 09 f5 ff ff       	jmp    8010506f <alltraps>
...
80105b66:	6a 00                	push   $0x0
  pushl $177
80105b68:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80105b6d:	e9 fd f4 ff ff       	jmp    8010506f <alltraps>
...
80105b72:	6a 00                	push   $0x0
  pushl $178
80105b74:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80105b79:	e9 f1 f4 ff ff       	jmp    8010506f <alltraps>
...
80105b7e:	6a 00                	push   $0x0
  pushl $179
80105b80:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80105b85:	e9 e5 f4 ff ff       	jmp    8010506f <alltraps>
...
80105b8a:	6a 00                	push   $0x0
  pushl $180
80105b8c:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80105b91:	e9 d9 f4 ff ff       	jmp    8010506f <alltraps>
...
80105b96:	6a 00                	push   $0x0
  pushl $181
80105b98:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80105b9d:	e9 cd f4 ff ff       	jmp    8010506f <alltraps>
...
80105ba2:	6a 00                	push   $0x0
  pushl $182
80105ba4:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80105ba9:	e9 c1 f4 ff ff       	jmp    8010506f <alltraps>
...
80105bae:	6a 00                	push   $0x0
  pushl $183
80105bb0:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80105bb5:	e9 b5 f4 ff ff       	jmp    8010506f <alltraps>
...
80105bba:	6a 00                	push   $0x0
  pushl $184
80105bbc:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80105bc1:	e9 a9 f4 ff ff       	jmp    8010506f <alltraps>
...
80105bc6:	6a 00                	push   $0x0
  pushl $185
80105bc8:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80105bcd:	e9 9d f4 ff ff       	jmp    8010506f <alltraps>
...
80105bd2:	6a 00                	push   $0x0
  pushl $186
80105bd4:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80105bd9:	e9 91 f4 ff ff       	jmp    8010506f <alltraps>
...
80105bde:	6a 00                	push   $0x0
  pushl $187
80105be0:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80105be5:	e9 85 f4 ff ff       	jmp    8010506f <alltraps>
...
80105bea:	6a 00                	push   $0x0
  pushl $188
80105bec:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80105bf1:	e9 79 f4 ff ff       	jmp    8010506f <alltraps>
...
80105bf6:	6a 00                	push   $0x0
  pushl $189
80105bf8:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80105bfd:	e9 6d f4 ff ff       	jmp    8010506f <alltraps>
...
80105c02:	6a 00                	push   $0x0
  pushl $190
80105c04:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80105c09:	e9 61 f4 ff ff       	jmp    8010506f <alltraps>
...
80105c0e:	6a 00                	push   $0x0
  pushl $191
80105c10:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80105c15:	e9 55 f4 ff ff       	jmp    8010506f <alltraps>
...
80105c1a:	6a 00                	push   $0x0
  pushl $192
80105c1c:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80105c21:	e9 49 f4 ff ff       	jmp    8010506f <alltraps>
...
80105c26:	6a 00                	push   $0x0
  pushl $193
80105c28:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80105c2d:	e9 3d f4 ff ff       	jmp    8010506f <alltraps>
...
80105c32:	6a 00                	push   $0x0
  pushl $194
80105c34:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80105c39:	e9 31 f4 ff ff       	jmp    8010506f <alltraps>
...
80105c3e:	6a 00                	push   $0x0
  pushl $195
80105c40:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80105c45:	e9 25 f4 ff ff       	jmp    8010506f <alltraps>
...
80105c4a:	6a 00                	push   $0x0
  pushl $196
80105c4c:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80105c51:	e9 19 f4 ff ff       	jmp    8010506f <alltraps>
...
80105c56:	6a 00                	push   $0x0
  pushl $197
80105c58:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80105c5d:	e9 0d f4 ff ff       	jmp    8010506f <alltraps>
...
80105c62:	6a 00                	push   $0x0
  pushl $198
80105c64:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80105c69:	e9 01 f4 ff ff       	jmp    8010506f <alltraps>
...
80105c6e:	6a 00                	push   $0x0
  pushl $199
80105c70:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80105c75:	e9 f5 f3 ff ff       	jmp    8010506f <alltraps>
...
80105c7a:	6a 00                	push   $0x0
  pushl $200
80105c7c:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80105c81:	e9 e9 f3 ff ff       	jmp    8010506f <alltraps>
...
80105c86:	6a 00                	push   $0x0
  pushl $201
80105c88:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80105c8d:	e9 dd f3 ff ff       	jmp    8010506f <alltraps>
...
80105c92:	6a 00                	push   $0x0
  pushl $202
80105c94:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80105c99:	e9 d1 f3 ff ff       	jmp    8010506f <alltraps>
...
80105c9e:	6a 00                	push   $0x0
  pushl $203
80105ca0:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80105ca5:	e9 c5 f3 ff ff       	jmp    8010506f <alltraps>
...
80105caa:	6a 00                	push   $0x0
  pushl $204
80105cac:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80105cb1:	e9 b9 f3 ff ff       	jmp    8010506f <alltraps>
...
80105cb6:	6a 00                	push   $0x0
  pushl $205
80105cb8:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80105cbd:	e9 ad f3 ff ff       	jmp    8010506f <alltraps>
...
80105cc2:	6a 00                	push   $0x0
  pushl $206
80105cc4:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80105cc9:	e9 a1 f3 ff ff       	jmp    8010506f <alltraps>
...
80105cce:	6a 00                	push   $0x0
  pushl $207
80105cd0:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80105cd5:	e9 95 f3 ff ff       	jmp    8010506f <alltraps>
...
80105cda:	6a 00                	push   $0x0
  pushl $208
80105cdc:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80105ce1:	e9 89 f3 ff ff       	jmp    8010506f <alltraps>
...
80105ce6:	6a 00                	push   $0x0
  pushl $209
80105ce8:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80105ced:	e9 7d f3 ff ff       	jmp    8010506f <alltraps>
...
80105cf2:	6a 00                	push   $0x0
  pushl $210
80105cf4:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80105cf9:	e9 71 f3 ff ff       	jmp    8010506f <alltraps>
...
80105cfe:	6a 00                	push   $0x0
  pushl $211
80105d00:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80105d05:	e9 65 f3 ff ff       	jmp    8010506f <alltraps>
...
80105d0a:	6a 00                	push   $0x0
  pushl $212
80105d0c:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80105d11:	e9 59 f3 ff ff       	jmp    8010506f <alltraps>
...
80105d16:	6a 00                	push   $0x0
  pushl $213
80105d18:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80105d1d:	e9 4d f3 ff ff       	jmp    8010506f <alltraps>
...
80105d22:	6a 00                	push   $0x0
  pushl $214
80105d24:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80105d29:	e9 41 f3 ff ff       	jmp    8010506f <alltraps>
...
80105d2e:	6a 00                	push   $0x0
  pushl $215
80105d30:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80105d35:	e9 35 f3 ff ff       	jmp    8010506f <alltraps>
...
80105d3a:	6a 00                	push   $0x0
  pushl $216
80105d3c:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80105d41:	e9 29 f3 ff ff       	jmp    8010506f <alltraps>
...
80105d46:	6a 00                	push   $0x0
  pushl $217
80105d48:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80105d4d:	e9 1d f3 ff ff       	jmp    8010506f <alltraps>
...
80105d52:	6a 00                	push   $0x0
  pushl $218
80105d54:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80105d59:	e9 11 f3 ff ff       	jmp    8010506f <alltraps>
...
80105d5e:	6a 00                	push   $0x0
  pushl $219
80105d60:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80105d65:	e9 05 f3 ff ff       	jmp    8010506f <alltraps>
...
80105d6a:	6a 00                	push   $0x0
  pushl $220
80105d6c:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80105d71:	e9 f9 f2 ff ff       	jmp    8010506f <alltraps>
...
80105d76:	6a 00                	push   $0x0
  pushl $221
80105d78:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80105d7d:	e9 ed f2 ff ff       	jmp    8010506f <alltraps>
...
80105d82:	6a 00                	push   $0x0
  pushl $222
80105d84:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80105d89:	e9 e1 f2 ff ff       	jmp    8010506f <alltraps>
...
80105d8e:	6a 00                	push   $0x0
  pushl $223
80105d90:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80105d95:	e9 d5 f2 ff ff       	jmp    8010506f <alltraps>
...
80105d9a:	6a 00                	push   $0x0
  pushl $224
80105d9c:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80105da1:	e9 c9 f2 ff ff       	jmp    8010506f <alltraps>
...
80105da6:	6a 00                	push   $0x0
  pushl $225
80105da8:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80105dad:	e9 bd f2 ff ff       	jmp    8010506f <alltraps>
...
80105db2:	6a 00                	push   $0x0
  pushl $226
80105db4:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80105db9:	e9 b1 f2 ff ff       	jmp    8010506f <alltraps>
...
80105dbe:	6a 00                	push   $0x0
  pushl $227
80105dc0:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80105dc5:	e9 a5 f2 ff ff       	jmp    8010506f <alltraps>
...
80105dca:	6a 00                	push   $0x0
  pushl $228
80105dcc:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80105dd1:	e9 99 f2 ff ff       	jmp    8010506f <alltraps>
...
80105dd6:	6a 00                	push   $0x0
  pushl $229
80105dd8:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80105ddd:	e9 8d f2 ff ff       	jmp    8010506f <alltraps>
...
80105de2:	6a 00                	push   $0x0
  pushl $230
80105de4:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80105de9:	e9 81 f2 ff ff       	jmp    8010506f <alltraps>
...
80105dee:	6a 00                	push   $0x0
  pushl $231
80105df0:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80105df5:	e9 75 f2 ff ff       	jmp    8010506f <alltraps>
...
80105dfa:	6a 00                	push   $0x0
  pushl $232
80105dfc:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80105e01:	e9 69 f2 ff ff       	jmp    8010506f <alltraps>
...
80105e06:	6a 00                	push   $0x0
  pushl $233
80105e08:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80105e0d:	e9 5d f2 ff ff       	jmp    8010506f <alltraps>
...
80105e12:	6a 00                	push   $0x0
  pushl $234
80105e14:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80105e19:	e9 51 f2 ff ff       	jmp    8010506f <alltraps>
...
80105e1e:	6a 00                	push   $0x0
  pushl $235
80105e20:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80105e25:	e9 45 f2 ff ff       	jmp    8010506f <alltraps>
...
80105e2a:	6a 00                	push   $0x0
  pushl $236
80105e2c:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80105e31:	e9 39 f2 ff ff       	jmp    8010506f <alltraps>
...
80105e36:	6a 00                	push   $0x0
  pushl $237
80105e38:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80105e3d:	e9 2d f2 ff ff       	jmp    8010506f <alltraps>
...
80105e42:	6a 00                	push   $0x0
  pushl $238
80105e44:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80105e49:	e9 21 f2 ff ff       	jmp    8010506f <alltraps>
...
80105e4e:	6a 00                	push   $0x0
  pushl $239
80105e50:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80105e55:	e9 15 f2 ff ff       	jmp    8010506f <alltraps>
...
80105e5a:	6a 00                	push   $0x0
  pushl $240
80105e5c:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80105e61:	e9 09 f2 ff ff       	jmp    8010506f <alltraps>
...
80105e66:	6a 00                	push   $0x0
  pushl $241
80105e68:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80105e6d:	e9 fd f1 ff ff       	jmp    8010506f <alltraps>
...
80105e72:	6a 00                	push   $0x0
  pushl $242
80105e74:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80105e79:	e9 f1 f1 ff ff       	jmp    8010506f <alltraps>
...
80105e7e:	6a 00                	push   $0x0
  pushl $243
80105e80:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80105e85:	e9 e5 f1 ff ff       	jmp    8010506f <alltraps>
...
80105e8a:	6a 00                	push   $0x0
  pushl $244
80105e8c:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80105e91:	e9 d9 f1 ff ff       	jmp    8010506f <alltraps>
...
80105e96:	6a 00                	push   $0x0
  pushl $245
80105e98:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80105e9d:	e9 cd f1 ff ff       	jmp    8010506f <alltraps>
...
80105ea2:	6a 00                	push   $0x0
  pushl $246
80105ea4:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80105ea9:	e9 c1 f1 ff ff       	jmp    8010506f <alltraps>
...
80105eae:	6a 00                	push   $0x0
  pushl $247
80105eb0:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80105eb5:	e9 b5 f1 ff ff       	jmp    8010506f <alltraps>
...
80105eba:	6a 00                	push   $0x0
  pushl $248
80105ebc:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80105ec1:	e9 a9 f1 ff ff       	jmp    8010506f <alltraps>
...
80105ec6:	6a 00                	push   $0x0
  pushl $249
80105ec8:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80105ecd:	e9 9d f1 ff ff       	jmp    8010506f <alltraps>
...
80105ed2:	6a 00                	push   $0x0
  pushl $250
80105ed4:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80105ed9:	e9 91 f1 ff ff       	jmp    8010506f <alltraps>
...
80105ede:	6a 00                	push   $0x0
  pushl $251
80105ee0:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80105ee5:	e9 85 f1 ff ff       	jmp    8010506f <alltraps>
...
80105eea:	6a 00                	push   $0x0
  pushl $252
80105eec:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80105ef1:	e9 79 f1 ff ff       	jmp    8010506f <alltraps>
...
80105ef6:	6a 00                	push   $0x0
  pushl $253
80105ef8:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80105efd:	e9 6d f1 ff ff       	jmp    8010506f <alltraps>
...
80105f02:	6a 00                	push   $0x0
  pushl $254
80105f04:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80105f09:	e9 61 f1 ff ff       	jmp    8010506f <alltraps>
...
80105f0e:	6a 00                	push   $0x0
  pushl $255
80105f10:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80105f15:	e9 55 f1 ff ff       	jmp    8010506f <alltraps>
...
80105f1d:	57                   	push   %edi
80105f1e:	56                   	push   %esi
80105f1f:	53                   	push   %ebx
80105f20:	83 ec 0c             	sub    $0xc,%esp
80105f23:	89 d6                	mov    %edx,%esi
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80105f25:	c1 ea 16             	shr    $0x16,%edx
80105f28:	8d 3c 90             	lea    (%eax,%edx,4),%edi
  if(*pde & PTE_P){
80105f2b:	8b 1f                	mov    (%edi),%ebx
80105f2d:	f6 c3 01             	test   $0x1,%bl
80105f30:	74 22                	je     80105f54 <walkpgdir+0x3a>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80105f32:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80105f38:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
80105f3e:	c1 ee 0c             	shr    $0xc,%esi
80105f41:	81 e6 ff 03 00 00    	and    $0x3ff,%esi
80105f47:	8d 1c b3             	lea    (%ebx,%esi,4),%ebx
}
80105f4a:	89 d8                	mov    %ebx,%eax
...
80105f56:	74 2b                	je     80105f83 <walkpgdir+0x69>
80105f58:	e8 5e c1 ff ff       	call   801020bb <kalloc>
80105f5d:	89 c3                	mov    %eax,%ebx
80105f5f:	85 c0                	test   %eax,%eax
80105f61:	74 e7                	je     80105f4a <walkpgdir+0x30>
    memset(pgtab, 0, PGSIZE);
80105f63:	83 ec 04             	sub    $0x4,%esp
80105f66:	68 00 10 00 00       	push   $0x1000
80105f6b:	6a 00                	push   $0x0
80105f6d:	50                   	push   %eax
80105f6e:	e8 b9 df ff ff       	call   80103f2c <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80105f73:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80105f79:	83 c8 07             	or     $0x7,%eax
80105f7c:	89 07                	mov    %eax,(%edi)
80105f7e:	83 c4 10             	add    $0x10,%esp
80105f81:	eb bb                	jmp    80105f3e <walkpgdir+0x24>
      return 0;
80105f83:	bb 00 00 00 00       	mov    $0x0,%ebx
80105f88:	eb c0                	jmp    80105f4a <walkpgdir+0x30>
...
80105f93:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105f96:	8b 75 08             	mov    0x8(%ebp),%esi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80105f99:	89 d3                	mov    %edx,%ebx
80105f9b:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80105fa1:	8d 7c 0a ff          	lea    -0x1(%edx,%ecx,1),%edi
80105fa5:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105fab:	b9 01 00 00 00       	mov    $0x1,%ecx
80105fb0:	89 da                	mov    %ebx,%edx
80105fb2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105fb5:	e8 60 ff ff ff       	call   80105f1a <walkpgdir>
80105fba:	85 c0                	test   %eax,%eax
80105fbc:	74 2e                	je     80105fec <mappages+0x62>
      return -1;
    if(*pte & PTE_P)
80105fbe:	f6 00 01             	testb  $0x1,(%eax)
80105fc1:	75 1c                	jne    80105fdf <mappages+0x55>
      panic("remap");
    *pte = pa | perm | PTE_P;
80105fc3:	89 f2                	mov    %esi,%edx
80105fc5:	0b 55 0c             	or     0xc(%ebp),%edx
80105fc8:	83 ca 01             	or     $0x1,%edx
80105fcb:	89 10                	mov    %edx,(%eax)
    if(a == last)
80105fcd:	39 fb                	cmp    %edi,%ebx
80105fcf:	74 28                	je     80105ff9 <mappages+0x6f>
      break;
    a += PGSIZE;
80105fd1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
80105fd7:	81 c6 00 10 00 00    	add    $0x1000,%esi
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105fdd:	eb cc                	jmp    80105fab <mappages+0x21>
      panic("remap");
80105fdf:	83 ec 0c             	sub    $0xc,%esp
80105fe2:	68 98 70 10 80       	push   $0x80107098
80105fe7:	e8 5c a3 ff ff       	call   80100348 <panic>
      return -1;
...
80105ffe:	eb f1                	jmp    80105ff1 <mappages+0x67>
...
80106004:	83 ec 14             	sub    $0x14,%esp
  c = &cpus[cpuid()];
80106007:	e8 cf d1 ff ff       	call   801031db <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010600c:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106012:	66 c7 80 f8 27 11 80 	movw   $0xffff,-0x7feed808(%eax)
80106019:	ff ff 
8010601b:	66 c7 80 fa 27 11 80 	movw   $0x0,-0x7feed806(%eax)
80106022:	00 00 
80106024:	c6 80 fc 27 11 80 00 	movb   $0x0,-0x7feed804(%eax)
8010602b:	0f b6 88 fd 27 11 80 	movzbl -0x7feed803(%eax),%ecx
80106032:	83 e1 f0             	and    $0xfffffff0,%ecx
80106035:	83 c9 1a             	or     $0x1a,%ecx
80106038:	83 e1 9f             	and    $0xffffff9f,%ecx
8010603b:	83 c9 80             	or     $0xffffff80,%ecx
8010603e:	88 88 fd 27 11 80    	mov    %cl,-0x7feed803(%eax)
80106044:	0f b6 88 fe 27 11 80 	movzbl -0x7feed802(%eax),%ecx
8010604b:	83 c9 0f             	or     $0xf,%ecx
8010604e:	83 e1 cf             	and    $0xffffffcf,%ecx
80106051:	83 c9 c0             	or     $0xffffffc0,%ecx
80106054:	88 88 fe 27 11 80    	mov    %cl,-0x7feed802(%eax)
8010605a:	c6 80 ff 27 11 80 00 	movb   $0x0,-0x7feed801(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106061:	66 c7 80 00 28 11 80 	movw   $0xffff,-0x7feed800(%eax)
80106068:	ff ff 
8010606a:	66 c7 80 02 28 11 80 	movw   $0x0,-0x7feed7fe(%eax)
80106071:	00 00 
80106073:	c6 80 04 28 11 80 00 	movb   $0x0,-0x7feed7fc(%eax)
8010607a:	0f b6 88 05 28 11 80 	movzbl -0x7feed7fb(%eax),%ecx
80106081:	83 e1 f0             	and    $0xfffffff0,%ecx
80106084:	83 c9 12             	or     $0x12,%ecx
80106087:	83 e1 9f             	and    $0xffffff9f,%ecx
8010608a:	83 c9 80             	or     $0xffffff80,%ecx
8010608d:	88 88 05 28 11 80    	mov    %cl,-0x7feed7fb(%eax)
80106093:	0f b6 88 06 28 11 80 	movzbl -0x7feed7fa(%eax),%ecx
8010609a:	83 c9 0f             	or     $0xf,%ecx
8010609d:	83 e1 cf             	and    $0xffffffcf,%ecx
801060a0:	83 c9 c0             	or     $0xffffffc0,%ecx
801060a3:	88 88 06 28 11 80    	mov    %cl,-0x7feed7fa(%eax)
801060a9:	c6 80 07 28 11 80 00 	movb   $0x0,-0x7feed7f9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801060b0:	66 c7 80 08 28 11 80 	movw   $0xffff,-0x7feed7f8(%eax)
801060b7:	ff ff 
801060b9:	66 c7 80 0a 28 11 80 	movw   $0x0,-0x7feed7f6(%eax)
801060c0:	00 00 
801060c2:	c6 80 0c 28 11 80 00 	movb   $0x0,-0x7feed7f4(%eax)
801060c9:	c6 80 0d 28 11 80 fa 	movb   $0xfa,-0x7feed7f3(%eax)
801060d0:	0f b6 88 0e 28 11 80 	movzbl -0x7feed7f2(%eax),%ecx
801060d7:	83 c9 0f             	or     $0xf,%ecx
801060da:	83 e1 cf             	and    $0xffffffcf,%ecx
801060dd:	83 c9 c0             	or     $0xffffffc0,%ecx
801060e0:	88 88 0e 28 11 80    	mov    %cl,-0x7feed7f2(%eax)
801060e6:	c6 80 0f 28 11 80 00 	movb   $0x0,-0x7feed7f1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801060ed:	66 c7 80 10 28 11 80 	movw   $0xffff,-0x7feed7f0(%eax)
801060f4:	ff ff 
801060f6:	66 c7 80 12 28 11 80 	movw   $0x0,-0x7feed7ee(%eax)
801060fd:	00 00 
801060ff:	c6 80 14 28 11 80 00 	movb   $0x0,-0x7feed7ec(%eax)
80106106:	c6 80 15 28 11 80 f2 	movb   $0xf2,-0x7feed7eb(%eax)
8010610d:	0f b6 88 16 28 11 80 	movzbl -0x7feed7ea(%eax),%ecx
80106114:	83 c9 0f             	or     $0xf,%ecx
80106117:	83 e1 cf             	and    $0xffffffcf,%ecx
8010611a:	83 c9 c0             	or     $0xffffffc0,%ecx
8010611d:	88 88 16 28 11 80    	mov    %cl,-0x7feed7ea(%eax)
80106123:	c6 80 17 28 11 80 00 	movb   $0x0,-0x7feed7e9(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
8010612a:	05 f0 27 11 80       	add    $0x801127f0,%eax
  pd[0] = size-1;
8010612f:	66 c7 45 f2 2f 00    	movw   $0x2f,-0xe(%ebp)
  pd[1] = (uint)p;
80106135:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106139:	c1 e8 10             	shr    $0x10,%eax
8010613c:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80106140:	8d 45 f2             	lea    -0xe(%ebp),%eax
80106143:	0f 01 10             	lgdtl  (%eax)
}
80106146:	83 c4 14             	add    $0x14,%esp
80106149:	5b                   	pop    %ebx
8010614a:	5d                   	pop    %ebp
8010614b:	c3                   	ret    
...
8010614f:	a1 a4 65 11 80       	mov    0x801165a4,%eax
80106154:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80106167:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
8010616a:	85 f6                	test   %esi,%esi
8010616c:	0f 84 dd 00 00 00    	je     8010624f <switchuvm+0xf1>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80106172:	83 7e 08 00          	cmpl   $0x0,0x8(%esi)
80106176:	0f 84 e0 00 00 00    	je     8010625c <switchuvm+0xfe>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
8010617c:	83 7e 04 00          	cmpl   $0x0,0x4(%esi)
80106180:	0f 84 e3 00 00 00    	je     80106269 <switchuvm+0x10b>
    panic("switchuvm: no pgdir");

  pushcli();
80106186:	e8 18 dc ff ff       	call   80103da3 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010618b:	e8 ef cf ff ff       	call   8010317f <mycpu>
80106190:	89 c3                	mov    %eax,%ebx
80106192:	e8 e8 cf ff ff       	call   8010317f <mycpu>
80106197:	8d 78 08             	lea    0x8(%eax),%edi
8010619a:	e8 e0 cf ff ff       	call   8010317f <mycpu>
8010619f:	83 c0 08             	add    $0x8,%eax
801061a2:	c1 e8 10             	shr    $0x10,%eax
801061a5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801061a8:	e8 d2 cf ff ff       	call   8010317f <mycpu>
801061ad:	83 c0 08             	add    $0x8,%eax
801061b0:	c1 e8 18             	shr    $0x18,%eax
801061b3:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
801061ba:	67 00 
801061bc:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
801061c3:	0f b6 4d e4          	movzbl -0x1c(%ebp),%ecx
801061c7:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
801061cd:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
801061d4:	83 e2 f0             	and    $0xfffffff0,%edx
801061d7:	83 ca 19             	or     $0x19,%edx
801061da:	83 e2 9f             	and    $0xffffff9f,%edx
801061dd:	83 ca 80             	or     $0xffffff80,%edx
801061e0:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
801061e6:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
801061ed:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
801061f3:	e8 87 cf ff ff       	call   8010317f <mycpu>
801061f8:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801061ff:	83 e2 ef             	and    $0xffffffef,%edx
80106202:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106208:	e8 72 cf ff ff       	call   8010317f <mycpu>
8010620d:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106213:	8b 5e 08             	mov    0x8(%esi),%ebx
80106216:	e8 64 cf ff ff       	call   8010317f <mycpu>
8010621b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106221:	89 58 0c             	mov    %ebx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106224:	e8 56 cf ff ff       	call   8010317f <mycpu>
80106229:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
8010622f:	b8 28 00 00 00       	mov    $0x28,%eax
80106234:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106237:	8b 46 04             	mov    0x4(%esi),%eax
8010623a:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
8010623f:	0f 22 d8             	mov    %eax,%cr3
  popcli();
80106242:	e8 99 db ff ff       	call   80103de0 <popcli>
}
...
80106252:	68 9e 70 10 80       	push   $0x8010709e
80106257:	e8 ec a0 ff ff       	call   80100348 <panic>
    panic("switchuvm: no kstack");
8010625c:	83 ec 0c             	sub    $0xc,%esp
8010625f:	68 b4 70 10 80       	push   $0x801070b4
80106264:	e8 df a0 ff ff       	call   80100348 <panic>
    panic("switchuvm: no pgdir");
80106269:	83 ec 0c             	sub    $0xc,%esp
8010626c:	68 c9 70 10 80       	push   $0x801070c9
80106271:	e8 d2 a0 ff ff       	call   80100348 <panic>
...
8010627b:	8b 75 10             	mov    0x10(%ebp),%esi
  char *mem;

  if(sz >= PGSIZE)
8010627e:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106284:	77 4c                	ja     801062d2 <inituvm+0x5c>
    panic("inituvm: more than a page");
  mem = kalloc();
80106286:	e8 30 be ff ff       	call   801020bb <kalloc>
8010628b:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
8010628d:	83 ec 04             	sub    $0x4,%esp
80106290:	68 00 10 00 00       	push   $0x1000
80106295:	6a 00                	push   $0x0
80106297:	50                   	push   %eax
80106298:	e8 8f dc ff ff       	call   80103f2c <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
8010629d:	83 c4 08             	add    $0x8,%esp
801062a0:	6a 06                	push   $0x6
801062a2:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801062a8:	50                   	push   %eax
801062a9:	b9 00 10 00 00       	mov    $0x1000,%ecx
801062ae:	ba 00 00 00 00       	mov    $0x0,%edx
801062b3:	8b 45 08             	mov    0x8(%ebp),%eax
801062b6:	e8 cf fc ff ff       	call   80105f8a <mappages>
  memmove(mem, init, sz);
801062bb:	83 c4 0c             	add    $0xc,%esp
801062be:	56                   	push   %esi
801062bf:	ff 75 0c             	pushl  0xc(%ebp)
801062c2:	53                   	push   %ebx
801062c3:	e8 df dc ff ff       	call   80103fa7 <memmove>
}
801062c8:	83 c4 10             	add    $0x10,%esp
801062cb:	8d 65 f8             	lea    -0x8(%ebp),%esp
801062ce:	5b                   	pop    %ebx
801062cf:	5e                   	pop    %esi
801062d0:	5d                   	pop    %ebp
801062d1:	c3                   	ret    
...
801062d5:	68 dd 70 10 80       	push   $0x801070dd
801062da:	e8 69 a0 ff ff       	call   80100348 <panic>
...
801062e2:	57                   	push   %edi
801062e3:	56                   	push   %esi
801062e4:	53                   	push   %ebx
801062e5:	83 ec 0c             	sub    $0xc,%esp
801062e8:	8b 7d 18             	mov    0x18(%ebp),%edi
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
801062eb:	f7 45 0c ff 0f 00 00 	testl  $0xfff,0xc(%ebp)
801062f2:	75 07                	jne    801062fb <loaduvm+0x1c>
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
801062f4:	bb 00 00 00 00       	mov    $0x0,%ebx
801062f9:	eb 3c                	jmp    80106337 <loaduvm+0x58>
    panic("loaduvm: addr must be page aligned");
801062fb:	83 ec 0c             	sub    $0xc,%esp
801062fe:	68 98 71 10 80       	push   $0x80107198
80106303:	e8 40 a0 ff ff       	call   80100348 <panic>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106308:	83 ec 0c             	sub    $0xc,%esp
8010630b:	68 f7 70 10 80       	push   $0x801070f7
...
80106315:	05 00 00 00 80       	add    $0x80000000,%eax
8010631a:	56                   	push   %esi
8010631b:	89 da                	mov    %ebx,%edx
8010631d:	03 55 14             	add    0x14(%ebp),%edx
80106320:	52                   	push   %edx
80106321:	50                   	push   %eax
80106322:	ff 75 10             	pushl  0x10(%ebp)
80106325:	e8 49 b4 ff ff       	call   80101773 <readi>
8010632a:	83 c4 10             	add    $0x10,%esp
8010632d:	39 f0                	cmp    %esi,%eax
8010632f:	75 47                	jne    80106378 <loaduvm+0x99>
  for(i = 0; i < sz; i += PGSIZE){
80106331:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106337:	39 fb                	cmp    %edi,%ebx
80106339:	73 30                	jae    8010636b <loaduvm+0x8c>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
8010633b:	89 da                	mov    %ebx,%edx
8010633d:	03 55 0c             	add    0xc(%ebp),%edx
80106340:	b9 00 00 00 00       	mov    $0x0,%ecx
80106345:	8b 45 08             	mov    0x8(%ebp),%eax
80106348:	e8 cd fb ff ff       	call   80105f1a <walkpgdir>
8010634d:	85 c0                	test   %eax,%eax
8010634f:	74 b7                	je     80106308 <loaduvm+0x29>
    pa = PTE_ADDR(*pte);
80106351:	8b 00                	mov    (%eax),%eax
80106353:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
80106358:	89 fe                	mov    %edi,%esi
8010635a:	29 de                	sub    %ebx,%esi
8010635c:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106362:	76 b1                	jbe    80106315 <loaduvm+0x36>
      n = PGSIZE;
80106364:	be 00 10 00 00       	mov    $0x1000,%esi
80106369:	eb aa                	jmp    80106315 <loaduvm+0x36>
      return -1;
  }
  return 0;
8010636b:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106370:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106373:	5b                   	pop    %ebx
80106374:	5e                   	pop    %esi
80106375:	5f                   	pop    %edi
80106376:	5d                   	pop    %ebp
...
8010637d:	eb f1                	jmp    80106370 <loaduvm+0x91>
...
80106388:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
8010638b:	39 7d 10             	cmp    %edi,0x10(%ebp)
8010638e:	73 11                	jae    801063a1 <deallocuvm+0x22>
    return oldsz;

  a = PGROUNDUP(newsz);
80106390:	8b 45 10             	mov    0x10(%ebp),%eax
80106393:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106399:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
8010639f:	eb 19                	jmp    801063ba <deallocuvm+0x3b>
    return oldsz;
801063a1:	89 f8                	mov    %edi,%eax
801063a3:	eb 64                	jmp    80106409 <deallocuvm+0x8a>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801063a5:	c1 eb 16             	shr    $0x16,%ebx
801063a8:	83 c3 01             	add    $0x1,%ebx
801063ab:	c1 e3 16             	shl    $0x16,%ebx
801063ae:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
  for(; a  < oldsz; a += PGSIZE){
801063b4:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801063ba:	39 fb                	cmp    %edi,%ebx
801063bc:	73 48                	jae    80106406 <deallocuvm+0x87>
    pte = walkpgdir(pgdir, (char*)a, 0);
801063be:	b9 00 00 00 00       	mov    $0x0,%ecx
801063c3:	89 da                	mov    %ebx,%edx
801063c5:	8b 45 08             	mov    0x8(%ebp),%eax
801063c8:	e8 4d fb ff ff       	call   80105f1a <walkpgdir>
801063cd:	89 c6                	mov    %eax,%esi
    if(!pte)
801063cf:	85 c0                	test   %eax,%eax
801063d1:	74 d2                	je     801063a5 <deallocuvm+0x26>
    else if((*pte & PTE_P) != 0){
801063d3:	8b 00                	mov    (%eax),%eax
801063d5:	a8 01                	test   $0x1,%al
801063d7:	74 db                	je     801063b4 <deallocuvm+0x35>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
801063d9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801063de:	74 19                	je     801063f9 <deallocuvm+0x7a>
        panic("kfree");
      char *v = P2V(pa);
...
801063e9:	e8 b6 bb ff ff       	call   80101fa4 <kfree>
      *pte = 0;
801063ee:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
801063f4:	83 c4 10             	add    $0x10,%esp
801063f7:	eb bb                	jmp    801063b4 <deallocuvm+0x35>
        panic("kfree");
801063f9:	83 ec 0c             	sub    $0xc,%esp
801063fc:	68 26 6a 10 80       	push   $0x80106a26
80106401:	e8 42 9f ff ff       	call   80100348 <panic>
    }
  }
  return newsz;
80106406:	8b 45 10             	mov    0x10(%ebp),%eax
}
...
8010641a:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(newsz >= KERNBASE)
8010641d:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106420:	85 ff                	test   %edi,%edi
80106422:	0f 88 c1 00 00 00    	js     801064e9 <allocuvm+0xd8>
  if(newsz < oldsz)
80106428:	3b 7d 0c             	cmp    0xc(%ebp),%edi
8010642b:	72 5c                	jb     80106489 <allocuvm+0x78>
  a = PGROUNDUP(oldsz);
8010642d:	8b 45 0c             	mov    0xc(%ebp),%eax
80106430:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106436:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
8010643c:	39 fb                	cmp    %edi,%ebx
8010643e:	0f 83 ac 00 00 00    	jae    801064f0 <allocuvm+0xdf>
    mem = kalloc();
80106444:	e8 72 bc ff ff       	call   801020bb <kalloc>
80106449:	89 c6                	mov    %eax,%esi
    if(mem == 0){
8010644b:	85 c0                	test   %eax,%eax
8010644d:	74 42                	je     80106491 <allocuvm+0x80>
    memset(mem, 0, PGSIZE);
8010644f:	83 ec 04             	sub    $0x4,%esp
80106452:	68 00 10 00 00       	push   $0x1000
80106457:	6a 00                	push   $0x0
80106459:	50                   	push   %eax
8010645a:	e8 cd da ff ff       	call   80103f2c <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
8010645f:	83 c4 08             	add    $0x8,%esp
80106462:	6a 06                	push   $0x6
80106464:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
8010646a:	50                   	push   %eax
8010646b:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106470:	89 da                	mov    %ebx,%edx
80106472:	8b 45 08             	mov    0x8(%ebp),%eax
80106475:	e8 10 fb ff ff       	call   80105f8a <mappages>
8010647a:	83 c4 10             	add    $0x10,%esp
8010647d:	85 c0                	test   %eax,%eax
8010647f:	78 38                	js     801064b9 <allocuvm+0xa8>
  for(; a < newsz; a += PGSIZE){
80106481:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106487:	eb b3                	jmp    8010643c <allocuvm+0x2b>
    return oldsz;
80106489:	8b 45 0c             	mov    0xc(%ebp),%eax
8010648c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010648f:	eb 5f                	jmp    801064f0 <allocuvm+0xdf>
      cprintf("allocuvm out of memory\n");
80106491:	83 ec 0c             	sub    $0xc,%esp
80106494:	68 15 71 10 80       	push   $0x80107115
80106499:	e8 6d a1 ff ff       	call   8010060b <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
8010649e:	83 c4 0c             	add    $0xc,%esp
801064a1:	ff 75 0c             	pushl  0xc(%ebp)
801064a4:	57                   	push   %edi
801064a5:	ff 75 08             	pushl  0x8(%ebp)
801064a8:	e8 d2 fe ff ff       	call   8010637f <deallocuvm>
      return 0;
801064ad:	83 c4 10             	add    $0x10,%esp
801064b0:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801064b7:	eb 37                	jmp    801064f0 <allocuvm+0xdf>
      cprintf("allocuvm out of memory (2)\n");
801064b9:	83 ec 0c             	sub    $0xc,%esp
801064bc:	68 2d 71 10 80       	push   $0x8010712d
801064c1:	e8 45 a1 ff ff       	call   8010060b <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801064c6:	83 c4 0c             	add    $0xc,%esp
801064c9:	ff 75 0c             	pushl  0xc(%ebp)
801064cc:	57                   	push   %edi
801064cd:	ff 75 08             	pushl  0x8(%ebp)
801064d0:	e8 aa fe ff ff       	call   8010637f <deallocuvm>
      kfree(mem);
801064d5:	89 34 24             	mov    %esi,(%esp)
801064d8:	e8 c7 ba ff ff       	call   80101fa4 <kfree>
      return 0;
801064dd:	83 c4 10             	add    $0x10,%esp
801064e0:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801064e7:	eb 07                	jmp    801064f0 <allocuvm+0xdf>
    return 0;
801064e9:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
...
801064ff:	53                   	push   %ebx
80106500:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
80106503:	85 f6                	test   %esi,%esi
80106505:	74 1a                	je     80106521 <freevm+0x26>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
80106507:	83 ec 04             	sub    $0x4,%esp
8010650a:	6a 00                	push   $0x0
8010650c:	68 00 00 00 80       	push   $0x80000000
80106511:	56                   	push   %esi
80106512:	e8 68 fe ff ff       	call   8010637f <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80106517:	83 c4 10             	add    $0x10,%esp
8010651a:	bb 00 00 00 00       	mov    $0x0,%ebx
8010651f:	eb 10                	jmp    80106531 <freevm+0x36>
    panic("freevm: no pgdir");
80106521:	83 ec 0c             	sub    $0xc,%esp
80106524:	68 49 71 10 80       	push   $0x80107149
80106529:	e8 1a 9e ff ff       	call   80100348 <panic>
  for(i = 0; i < NPDENTRIES; i++){
8010652e:	83 c3 01             	add    $0x1,%ebx
80106531:	81 fb ff 03 00 00    	cmp    $0x3ff,%ebx
80106537:	77 1f                	ja     80106558 <freevm+0x5d>
    if(pgdir[i] & PTE_P){
80106539:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
8010653c:	a8 01                	test   $0x1,%al
8010653e:	74 ee                	je     8010652e <freevm+0x33>
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106540:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106545:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
8010654a:	83 ec 0c             	sub    $0xc,%esp
8010654d:	50                   	push   %eax
8010654e:	e8 51 ba ff ff       	call   80101fa4 <kfree>
80106553:	83 c4 10             	add    $0x10,%esp
80106556:	eb d6                	jmp    8010652e <freevm+0x33>
    }
  }
  kfree((char*)pgdir);
80106558:	83 ec 0c             	sub    $0xc,%esp
8010655b:	56                   	push   %esi
8010655c:	e8 43 ba ff ff       	call   80101fa4 <kfree>
}
...
80106570:	e8 46 bb ff ff       	call   801020bb <kalloc>
80106575:	89 c6                	mov    %eax,%esi
80106577:	85 c0                	test   %eax,%eax
80106579:	74 55                	je     801065d0 <setupkvm+0x65>
  memset(pgdir, 0, PGSIZE);
8010657b:	83 ec 04             	sub    $0x4,%esp
8010657e:	68 00 10 00 00       	push   $0x1000
80106583:	6a 00                	push   $0x0
80106585:	50                   	push   %eax
80106586:	e8 a1 d9 ff ff       	call   80103f2c <memset>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010658b:	83 c4 10             	add    $0x10,%esp
8010658e:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
80106593:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106599:	73 35                	jae    801065d0 <setupkvm+0x65>
                (uint)k->phys_start, k->perm) < 0) {
8010659b:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
8010659e:	8b 4b 08             	mov    0x8(%ebx),%ecx
801065a1:	29 c1                	sub    %eax,%ecx
801065a3:	83 ec 08             	sub    $0x8,%esp
801065a6:	ff 73 0c             	pushl  0xc(%ebx)
801065a9:	50                   	push   %eax
801065aa:	8b 13                	mov    (%ebx),%edx
801065ac:	89 f0                	mov    %esi,%eax
801065ae:	e8 d7 f9 ff ff       	call   80105f8a <mappages>
801065b3:	83 c4 10             	add    $0x10,%esp
801065b6:	85 c0                	test   %eax,%eax
801065b8:	78 05                	js     801065bf <setupkvm+0x54>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801065ba:	83 c3 10             	add    $0x10,%ebx
801065bd:	eb d4                	jmp    80106593 <setupkvm+0x28>
      freevm(pgdir);
801065bf:	83 ec 0c             	sub    $0xc,%esp
801065c2:	56                   	push   %esi
801065c3:	e8 33 ff ff ff       	call   801064fb <freevm>
      return 0;
801065c8:	83 c4 10             	add    $0x10,%esp
801065cb:	be 00 00 00 00       	mov    $0x0,%esi
}
801065d0:	89 f0                	mov    %esi,%eax
...
801065dc:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801065df:	e8 87 ff ff ff       	call   8010656b <setupkvm>
801065e4:	a3 a4 65 11 80       	mov    %eax,0x801165a4
  switchkvm();
801065e9:	e8 5e fb ff ff       	call   8010614c <switchkvm>
}
801065ee:	c9                   	leave  
801065ef:	c3                   	ret    
...
801065f6:	b9 00 00 00 00       	mov    $0x0,%ecx
801065fb:	8b 55 0c             	mov    0xc(%ebp),%edx
801065fe:	8b 45 08             	mov    0x8(%ebp),%eax
80106601:	e8 14 f9 ff ff       	call   80105f1a <walkpgdir>
  if(pte == 0)
80106606:	85 c0                	test   %eax,%eax
80106608:	74 05                	je     8010660f <clearpteu+0x1f>
    panic("clearpteu");
  *pte &= ~PTE_U;
8010660a:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
8010660d:	c9                   	leave  
8010660e:	c3                   	ret    
    panic("clearpteu");
8010660f:	83 ec 0c             	sub    $0xc,%esp
80106612:	68 5a 71 10 80       	push   $0x8010715a
80106617:	e8 2c 9d ff ff       	call   80100348 <panic>
...
80106622:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80106625:	e8 41 ff ff ff       	call   8010656b <setupkvm>
8010662a:	89 45 dc             	mov    %eax,-0x24(%ebp)
8010662d:	85 c0                	test   %eax,%eax
8010662f:	0f 84 c4 00 00 00    	je     801066f9 <copyuvm+0xdd>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106635:	bf 00 00 00 00       	mov    $0x0,%edi
8010663a:	3b 7d 0c             	cmp    0xc(%ebp),%edi
8010663d:	0f 83 b6 00 00 00    	jae    801066f9 <copyuvm+0xdd>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106643:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106646:	b9 00 00 00 00       	mov    $0x0,%ecx
8010664b:	89 fa                	mov    %edi,%edx
8010664d:	8b 45 08             	mov    0x8(%ebp),%eax
80106650:	e8 c5 f8 ff ff       	call   80105f1a <walkpgdir>
80106655:	85 c0                	test   %eax,%eax
80106657:	74 65                	je     801066be <copyuvm+0xa2>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106659:	8b 00                	mov    (%eax),%eax
8010665b:	a8 01                	test   $0x1,%al
8010665d:	74 6c                	je     801066cb <copyuvm+0xaf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
8010665f:	89 c6                	mov    %eax,%esi
80106661:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    flags = PTE_FLAGS(*pte);
80106667:	25 ff 0f 00 00       	and    $0xfff,%eax
8010666c:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if((mem = kalloc()) == 0)
8010666f:	e8 47 ba ff ff       	call   801020bb <kalloc>
80106674:	89 c3                	mov    %eax,%ebx
80106676:	85 c0                	test   %eax,%eax
80106678:	74 6a                	je     801066e4 <copyuvm+0xc8>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
8010667a:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106680:	83 ec 04             	sub    $0x4,%esp
80106683:	68 00 10 00 00       	push   $0x1000
80106688:	56                   	push   %esi
80106689:	50                   	push   %eax
8010668a:	e8 18 d9 ff ff       	call   80103fa7 <memmove>
...
801066a7:	e8 de f8 ff ff       	call   80105f8a <mappages>
801066ac:	83 c4 10             	add    $0x10,%esp
801066af:	85 c0                	test   %eax,%eax
801066b1:	78 25                	js     801066d8 <copyuvm+0xbc>
  for(i = 0; i < sz; i += PGSIZE){
801066b3:	81 c7 00 10 00 00    	add    $0x1000,%edi
801066b9:	e9 7c ff ff ff       	jmp    8010663a <copyuvm+0x1e>
      panic("copyuvm: pte should exist");
801066be:	83 ec 0c             	sub    $0xc,%esp
801066c1:	68 64 71 10 80       	push   $0x80107164
801066c6:	e8 7d 9c ff ff       	call   80100348 <panic>
      panic("copyuvm: page not present");
801066cb:	83 ec 0c             	sub    $0xc,%esp
801066ce:	68 7e 71 10 80       	push   $0x8010717e
801066d3:	e8 70 9c ff ff       	call   80100348 <panic>
      kfree(mem);
801066d8:	83 ec 0c             	sub    $0xc,%esp
801066db:	53                   	push   %ebx
801066dc:	e8 c3 b8 ff ff       	call   80101fa4 <kfree>
      goto bad;
...
801066ea:	e8 0c fe ff ff       	call   801064fb <freevm>
  return 0;
...
80106715:	e8 00 f8 ff ff       	call   80105f1a <walkpgdir>
  if((*pte & PTE_P) == 0)
...
8010675b:	e8 47 d8 ff ff       	call   80103fa7 <memmove>
    len -= n;
